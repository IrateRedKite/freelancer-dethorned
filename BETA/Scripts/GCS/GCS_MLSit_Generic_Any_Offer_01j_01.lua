...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F01jG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_dx_GCS_F01jG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F01jG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F01jG01_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.250, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.768,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_dx_GCS_F01jG01" },
		{
			duration = 2.578
		}
	},
	...
	{
		0.671, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.062, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.437, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.643,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.437, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.768,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.079, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.079, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
