...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A04aG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_A04aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_A04aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRB_GESTR_STOP_000LV_XA_03",
			duration = 3.812,
			trans_time = 0.750,
			time_scale = 1,
			weight = 1,
	...
	{
		0.001, START_SOUND, { "VoiceProfile_GCS_FM_A04aG01" },
		{
			duration = 3.655
		}
	},
	...
	{
		1.483, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.899, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMHEAD_MOTION_WALLA_CASL_000LV_XA_%",
			duration = 0.449,
			start_time = 0.500,
	...
	{
		2.045, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.453, START_MOTION, { "Offer_Character_A" },
		{
