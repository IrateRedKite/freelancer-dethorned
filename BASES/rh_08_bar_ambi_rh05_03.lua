...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_rh0503",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			specular = { 0, 0, 0 },
			ambient = { 0.176471, 0.176471, 0.176471 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.533333, 0.533333, 0.533333 },
			specular = { 0, 0, 0 },
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.937255, 0.478431, 0.172549 },
			specular = { 0, 0, 0 },
			ambient = { 0.643137, 0.34902, 0.207843 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.204540,  0.082342, -0.975389 },
					   { -0.621488,  0.758922,  0.194395 },
					   {  0.756251,  0.645954, -0.104056 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_rh0503" },
		{
			duration = 0.000,
			fogprops =
			{
