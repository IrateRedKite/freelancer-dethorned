...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F04dG01",
		type = SOUND,
...
events =
{
...

	{
		...
		{
			animation = "Sc_MLBODY_STND_GET_MAP_000LV_A_10",
			duration = 10.466,
			trans_time = 1.000,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F04dG01" },
		{
			duration = 5.625
		}
	},
	...
	{
		2.428, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.046, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		4.109, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		5.130, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		5.130, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
