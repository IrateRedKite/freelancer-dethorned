...
entities =
{
	...
	{
		entity_name = "Layer_GCS_V05aV_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_V05aV02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_V05aV02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_V05aV02_RVP01",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_V05aV02" },
		{
			duration = 1.805
		}
	},
	...
	{
		0.506, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.608, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.700,
			end_effector = "Body_Head",
			count_to_root = 1,
