...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -30.93483, 156.6911, 325.7024 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		pathprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -40.59484, 70.84637, 14.02295 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		pathprops  = 
		{
...
events  = 
{
	...
	{
		0.009, START_SOUND, { "PlayerShip_engine_playership_1" },
		{
			duration  =  17.774,
			flags  =  LOOP
		}
...

	{
		3.500, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Marker_MOP" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.197905, 0.073077, -0.977493, -0.017981 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		5.436, ATTACH_ENTITY, { "Playership_engine_land_turbine_snd", "PlayerShip" },
		{
			duration  =  10.362,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		8.918, START_AUDIO_PROP_ANIM, { "Playership_engine_rumble_snd" },
		{
			duration  =  7.269,
			audioprops  = 
			{
...

	{
		12.937, START_SPATIAL_PROP_ANIM, { "PlayerShip", "PlayerShip_Mk_Attached_copy_1" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.409663, 0.012664, -0.912149, -0.003411 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		12.937, START_SPATIAL_PROP_ANIM, { "PlayerShip_Mk_Attached_copy_1", "PlayerShip_Mk_Attached_copy_1_copy_1" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.952674, 0.050632, -0.299749, -0.037463 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		13.000, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Marker_MOP" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.29082, 0.133751, -0.947383, -0.123232 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		15.687, START_SOUND, { "Playership_engine_kill_snd" },
		{
			duration  =  1.544
		}
	},
	...
	{
		15.687, ATTACH_ENTITY, { "Playership_engine_kill_snd", "PlayerShip" },
		{
			duration  =  1.812,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
