...
entities  = 
{
	...
	{
		entity_name  =  "PlayerShipEngines_fx",
		type  =  PSYS,
	...
	{
		entity_name  =  "PlayerShip_engine_playership_snd",
		type  =  SOUND,
	...
	{
		entity_name  =  "rtc_shipdust_10_fx",
		type  =  PSYS,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -131.0242, 0.101999, -26.70945 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		0.000, START_PSYS, { "PlayerShipEngines_fx" },
		{
			duration  =  14.812
		}
	},
	...
	{
		0.000, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		0.000, START_PSYS, { "rtc_shipdust_10_fx" },
		{
			duration  =  11.000
		}
	},
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "rtc_shipdust_10_fx", "X/Shipcentre/01" },
		{
			duration  =  0.100,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		0.000, ATTACH_ENTITY, { "PlayerShipEngines_fx", "PlayerShip" },
		{
			duration  =  15.125,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		4.312, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		5.527, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		5.781, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		6.156, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		6.406, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		6.710, START_PSYS_PROP_ANIM, { "rtc_shipdust_10_fx" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		7.031, START_PSYS_PROP_ANIM, { "PlayerShipEngines_fx" },
		{
			duration  =  3.312,
			psysprops  = 
			{
	...
	{
		7.031, START_SOUND, { "Playership_engine_launch03_snd" },
		{
			duration  =  10.335
		}
	},
	...
	{
		7.031, START_AUDIO_PROP_ANIM, { "Playership_engine_launch03_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.250000, 0.900641, 0.000000, 0.000000 },
					{ 0.522436, 0.846154, -0.105263, 0.653846 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		7.031, ATTACH_ENTITY, { "Playership_engine_launch03_snd", "PlayerShip" },
		{
			duration  =  7.467,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
...

	{
		9.187, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch02", "Camera_ShipLaunch02_a" },
		{
			...
			{
				pos  =  { -772.7285, 565.5565, 1431.206 },
				q_orient  =  { 0.883181, 0, 0.469032, 0.190139 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		10.031, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		10.031, ATTACH_ENTITY, { "PlayerShip_engine_playership_snd", "PlayerShip" },
		{
			duration  =  4.468,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		10.031, START_SOUND, { "PlayerShip_engine_playership_snd" },
		{
			duration  =  4.468,
			flags  =  LOOP
		}
