...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01cG01_sit",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		2.349, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.349, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.500, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.799, START_MOTION, { "Offer_Character_A" },
		{
