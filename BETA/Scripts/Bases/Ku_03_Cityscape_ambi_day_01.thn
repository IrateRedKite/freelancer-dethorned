...
entities =
{
	...
	{
		entity_name = "Layer_ku_03_City_Ambi_Day",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "skydome_sky_clouds_gray_5",
		type = COMPOUND,
		template_name = "skydome_sky_clouds_gray",
	...
	{
		entity_name = "PlayerShip_gf_rtc_shipcushion_3",
		type = PSYS,
...
{
	{
		0.000, START_SPATIAL_PROP_ANIM, { "skydome_sky_clouds_gray_5", "Marker_SpinCloud_120" },
		{
			duration = 150.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Layer_ku_03_City_Ambi_Day" },
		{
			duration = 0.100,
			fogprops =
			{
	...
	{
		0.000, START_PSYS, { "PlayerShip_gf_rtc_shipcushion_3" },
		{
			duration = 300.000
		}
	},
	...
	{
		0.000, ATTACH_ENTITY, { "PlayerShip_gf_rtc_shipcushion_3", "PlayerShip_Shipcushion_Marker_A" },
		{
			duration = 300.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		150.000, START_SPATIAL_PROP_ANIM, { "skydome_sky_clouds_gray_5", "Marker_SpinCloud_240" },
		{
			duration = 150.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 0, 0, 0 },
				q_orient = { -0.545213, 0, -0.838298, 0 }
			}
		}
	},

	{
		300.000, START_SPATIAL_PROP_ANIM, { "skydome_sky_clouds_gray_5", "Marker_SpinCloud_000" },
		{
			duration = 150.000,
			target_part = "",
			target_type = ROOT,
