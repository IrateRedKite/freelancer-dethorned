...
entities =
{
	...
	{
		entity_name = "Layer_Br_04_Deck_Land",
		type = SCENE,
		template_name = "",
...
events =
{
...

	{
		5.062, START_SPATIAL_PROP_ANIM, { "Marker_ship_follow", "PlayerShip_Marker_3" },
		{
			...
			{
				pos = { 0.441345, 2.342605, 1.088021 },
				q_orient = { -0.753671, 0, 0.657252, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		7.686, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			duration = 3.000,
			target_type = ROOT,
			spatialprops =
...

	{
		8.250, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_03", "Camera_ShipLand_04" },
		{
			...
			spatialprops =
			{
				pos = { -7.2679, 4.5016, 31.175 },
				q_orient = { 0.585601, 0.164649, 0.793701, -0.053771 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
