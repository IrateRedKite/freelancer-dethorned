...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D04dT01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D04dT01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D04dT01_RVP01",
			duration = 4.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D04dT01" },
		{
			duration = 3.953
		}
	},
	...
	{
		2.967, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.483,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.468, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.523, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		3.781, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 0.699,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.828, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_NOPE_000LV_A_02",
			duration = 2.165,
			trans_time = 1.000,
