...
events =
{
	...
	{
		1.968, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.768,
	...
	{
		2.092, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.689,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.156, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.778, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.778, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.781, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	}
};
