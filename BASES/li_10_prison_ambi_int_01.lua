...
entities  = 
{
	...
	{
		entity_name  =  "ambi_Layer_Li_10_Deck",
		type  =  SCENE,
		template_name  =  "",
	...
	{
		entity_name  =  "Ambi_Layer_s069x_Spcl_Ambi",
		type  =  SCENE,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
...
events  = 
{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "ambi_Layer_Li_10_Deck" },
		{
			duration  =  0.000,
			fogprops  = 
			{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_s069x_Spcl_Ambi" },
		{
			duration  =  0.000,
			fogprops  = 
			{
