...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_W04cP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_W04cP02_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W04cP02_Trent",
			duration = 1.833,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_W04cP02" },
		{
			duration = 1.125
		}
	},
	...
	{
		0.718, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_000LV_xa_04",
			duration = 7.466,
			trans_time = 0.700,
