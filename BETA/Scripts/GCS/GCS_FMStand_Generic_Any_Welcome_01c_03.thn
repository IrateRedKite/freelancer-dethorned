...
entities =
{
	...
	{
		entity_name = "Layer_GCS_W01cG03_stand",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_W01cG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_W01cG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG03_RVP51",
			duration = 2.165,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_FM_W01cG03" },
		{
			duration = 1.515
		}
	},
	...
	{
		1.406, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.515, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.515, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.140, START_MOTION, { "Offer_Character_A" },
		{
