...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.974032,  0.000000,  0.226411 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.226411,  0.000000,  0.974032 } }
		},
		compoundprops =
		{
			floor_height = 0
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.675722,  0.000000, -0.737156 },
					   { -0.376361,  0.859843,  0.344995 },
					   {  0.633839,  0.510558, -0.581016 } }
		},
		cameraprops =
		{
			fovh = 25,
...
events =
{
	...
	{
		0.406, START_MOTION, { "Char_ozu" },
		{
			animation = "Sc_MLBODY_CHRB_CONV_HNDS_EMPH_000LV_XA_03",
			duration = 3.466,
			start_time = 2.000,
			trans_time = 1.000,
			time_scale = 0.6,
	...
	{
		6.062, START_MOTION, { "Char_ozu" },
		{
			animation = "Sc_MLBODY_CHRB_EMPH_HNDSDN_TRNS_000LV_XA_02",
			duration = 4.406,
			trans_time = 1.500,
			time_scale = 0.6,
			weight = 1,
	...
	{
		6.186, SET_CAMERA, { "Cam_Monitor_s050a_static", "Cam_02_PCO" }
	},

	{
		6.187, SET_CAMERA, { "Cam_Monitor_s050a", "Cam_02_PCO" }
	},
...

	{
		8.312, START_SPATIAL_PROP_ANIM, { "Cam_03_HighWide_A", "Cam_03_HighWide_B" },
		{
			...
			{
				pos = { 3.741461, 2.841481, -3.204485 },
				q_orient = { -0.200102, 0.445524, -0.872621, -0.445524 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		8.562, START_MOTION, { "Char_ozu" },
		{
			animation = "Sc_MLBODY_CHRF_CONV_HNDS_EMPH_000LV_XA_04",
			duration = 5.857,
			trans_time = 1.500,
			time_scale = 0.7,
			weight = 1,
