...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -0.149672, 1.110157, 0.821329 },
			orient = { {  0.876204,  0.000000,  0.481940 },
					   { -0.083190,  0.984989,  0.151247 },
					   { -0.474706, -0.172616,  0.863052 } }
		},
		cameraprops =
		{
			fovh = 20,
...
events =
{
	...
	{
		0.936, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.375, SET_CAMERA, { "Monitor", "Camera/PCO" }
	},

	{
		1.832, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.832, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.440, START_MOTION, { "Player_Character_P" },
		{
