...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.534354, 1.852089, -0.191502 },
			orient = { {  0.076375,  0.000000, -0.997079 },
					   { -0.443968,  0.895397, -0.034007 },
					   {  0.892782,  0.445269,  0.068386 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F05dG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F05dG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F05dG01_RVP01",
			duration = 3.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F05dG01" },
		{
			duration = 2.671
		}
	},
	...
	{
		1.031, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.170, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.170, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.273, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.897,
			end_effector = "Body_Head",
			count_to_root = 1,
