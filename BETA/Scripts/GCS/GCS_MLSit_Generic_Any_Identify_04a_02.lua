...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D04aG02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.543222, 1.664226, 0.977124 },
			orient = { {  0.770921,  0.000000, -0.636930 },
					   { -0.111649,  0.984517, -0.135136 },
					   {  0.627069,  0.175292,  0.758985 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D04aG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D04aG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...

	{
		...
		spatialprops =
		{
			pos = { -0.133336, 1.017259, 0.751985 },
			orient = { {  0.857119,  0.000000,  0.515118 },
					   { -0.146159,  0.958902,  0.243198 },
					   { -0.493947, -0.283739,  0.821893 } }
		},
		cameraprops =
		{
			fovh = 20,
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D04aG02_RVP01",
			duration = 4.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_EMPH_RHNDUP_TRNS_000LV_XA_01",
			duration = 2.332,
			trans_time = 1.000,
			time_scale = 0.5,
			weight = 1,
	...
	{
		0.358, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.483, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D04aG02" },
		{
			duration = 3.743
		}
	},
	...
	{
		2.000, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.234, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.009, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		3.125, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		3.203, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.042,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.240, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.240, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.250, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
