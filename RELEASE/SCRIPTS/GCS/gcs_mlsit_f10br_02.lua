...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR02_13",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F10bR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F10bR02_RVP01",
			duration = 1.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.109, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.202, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR02_13" },
		{
			duration = 1.717
		}
	},
	...
	{
		1.608, START_MOTION, { "Offer_Character_A" },
		{
