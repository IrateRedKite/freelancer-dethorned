...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01bB03_11",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01bB03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01bB03_RVP01",
			duration = 1.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.750, START_SOUND, { "VoiceProfile_GCS_ML_W01bB03_11" },
		{
			duration = 1.093
		}
	},
