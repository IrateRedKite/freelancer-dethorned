...
entities  = 
{
	...
	{
		entity_name  =  "Layer_bw_02_Shipdlr_Ambi",
		type  =  SCENE,
		template_name  =  "",
	...
	{
		entity_name  =  "ambi_ltg00_Ambient_char_off_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg00_inf_char_blue_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg00_inf_char_yellow_rooms_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg00_point_char_arch_1_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg00_point_char_arch_2_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg00_point_char_back_off_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg03_inf_equip_copy_1",
		type  =  LIGHT,
		template_name  =  "",
	...
	{
		entity_name  =  "ambi_ltg03_inf_equip_top_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg03_point_equip_arch_1_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg03_point_equip_arch_2_copy_1",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_ltg09_Ambient_set_copy_1",
		type  =  LIGHT,
		template_name  =  "",
...
events  = 
{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Layer_bw_02_Shipdlr_Ambi" },
		{
			duration  =  0.000,
			fogprops  = 
			{
