...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_li_09_bar_Iw02_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.078431, 0.270588, 0.462745 },
			specular  =  { 0, 0, 0 },
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.501199, -0.742871, -0.443781 },
					   { -0.427013, 0.233730, -0.873516 },
					   { 0.752635, 0.627306, -0.200070 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.396078, 0.552941, 0.788235 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.145098, 0.145098, 0.145098 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.271202, -0.962522 },
					   { 0.000000, 0.962522, -0.271202 } }
		}
	},

	{
		...
		{
			pos  =  { 10000, 5000, 0 },
			orient  =  { { 0.651330, 0.000000, 0.758795 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.758795, 0.000000, 0.651330 } }
		}
	},
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.435294, 0.666667, 0.901961 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.145098, 0.145098, 0.145098 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
	...
	{
		entity_name  =  "ambi_starsphere_Iw02_1",
		type  =  COMPOUND,
		template_name  =  "starsphere_Iw02",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.060171, 0.002094, -0.998186 },
					   { -0.034784, 0.999395, 0.000000 },
					   { 0.997582, 0.034721, 0.060207 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Iw02_stars_2",
		type  =  COMPOUND,
		template_name  =  "starsphere_Iw02_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_li_09_bar_Iw02_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
