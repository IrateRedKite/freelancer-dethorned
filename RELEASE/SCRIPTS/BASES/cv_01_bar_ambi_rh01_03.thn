...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_rh0103",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 5000, 0, 0 },
			orient  =  { { 0.874960, -0.098761, 0.474017 },
					   { 0.134363, 0.990053, -0.041738 },
					   { -0.465180, 0.100209, 0.879526 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.899267, 0.000000, -0.437400 },
					   { -0.352509, 0.592024, 0.724738 },
					   { 0.258951, 0.805920, -0.532388 } }
		},
		lightprops  = 
		{
			on  =  Y,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.561696, 0.000000, -0.827344 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.827344, 0.000000, 0.561696 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0103" },
		{
			duration  =  0.000,
			fogprops  = 
			{
