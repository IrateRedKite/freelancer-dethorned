...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.829607,  0.000000,  0.558347 },
					   {  0.038191,  0.997658, -0.056746 },
					   { -0.557039,  0.068400,  0.827664 } }
		},
		cameraprops =
		{
			fovh = 40,
...

	{
		...
		spatialprops =
		{
			pos = { 35.95291, 47.42627, -4.328397 },
...
events =
{
...

	{
		1.531, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_JustAbove" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.163777, 0, -0.986497, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		3.187, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_ort_01" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.152071, -0.062361, -0.9864, 0.270282 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		4.750, START_SPATIAL_PROP_ANIM, { "Camera_Carts_02", "Camera_Carts_02_goto" },
		{
			...
			{
				pos = { -16.68003, 8.58779, 23.92606 },
				q_orient = { -0.969412, 0.001206, 0.245437, -0.000404 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		4.875, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_ort_02" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.16068, 0.03148, -0.986504, -0.141277 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
