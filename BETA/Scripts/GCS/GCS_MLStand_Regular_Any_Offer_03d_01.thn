...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03dR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03dR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F03dR01_RVP01",
			duration = 4.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03dR01" },
		{
			duration = 4.013
		}
	},
	...
	{
		3.654, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.855,
			end_effector = "Body_Head",
			count_to_root = 1,
