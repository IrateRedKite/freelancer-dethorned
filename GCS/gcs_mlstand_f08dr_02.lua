...
events =
{
	...
	{
		0.264, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.828, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.203, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 2.265,
			trans_time = 0.770,
...

	{
		4.289, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			...
			{
				pos = { 0, 0, 0 },
				q_orient = { 0.266468, 0, 0.963844, 0 }
			}
		}
	},

	{
		4.289, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			...
			{
				pos = { 0.987223, 0, -0.501587 },
				q_orient = { -0.788347, 0, 0.615231, 0 }
			}
		}
	}
};
