...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F08bR01",
		type = SOUND,
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_GIVE_VEND_000LV_A_10",
			duration = 10.133,
			trans_time = 1.000,
			time_scale = 0.5,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F08bR01" },
		{
			duration = 1.812
		}
	},
	...
	{
		1.000, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},

	{
		1.014, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.230, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.080,
			end_effector = "Body_Head",
			count_to_root = 1,
