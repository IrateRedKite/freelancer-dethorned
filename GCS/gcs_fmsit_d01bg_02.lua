...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01bG02_sit",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		2.218, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.940, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.009, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.009, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.309, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.950,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.718, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.940, START_MOTION, { "Offer_Character_A" },
		{
