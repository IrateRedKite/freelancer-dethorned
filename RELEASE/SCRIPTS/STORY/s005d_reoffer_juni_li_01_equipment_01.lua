...
entities =
{
	...
	{
		entity_name = "snd_music_upcoming_action_light_8",
		type = SOUND,
...
{
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_backgroundambient_3" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_music_upcoming_action_light_8" },
		{
			duration = 2.000,
			audioprops =
			{
	...
	{
		0.001, START_SOUND, { "snd_music_upcoming_action_light_8" },
		{
			duration = 14.378,
			start_time = 30000
		}
...

	{
		2.828, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKhead", "Char_Juni_Mk_IKhead_test" },
		{
			...
			spatialprops =
			{
				pos = { 2.042126, 2.097633, -2.713035 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		4.342, START_AUDIO_PROP_ANIM, { "snd_music_upcoming_action_light_8" },
		{
			duration = 3.000,
			audioprops =
			{
...

	{
		7.531, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKhead", "Char_juni" },
		{
			...
			spatialprops =
			{
				pos = { 0.064592, 1.559194, -4.190585 },
				q_orient = { 0.600974, 0.515562, 0.610758, 0.399049 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		7.718, START_SPATIAL_PROP_ANIM, { "Cam_B_OTS_onJuni_01", "Cam_B_OTS_onJuni_02" },
		{
			...
			{
				pos = { 3.613797, 1.943197, -2.522993 },
				q_orient = { 0.819145, -0.323697, 0.473521, 0.449821 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		11.000, START_AUDIO_PROP_ANIM, { "snd_music_upcoming_action_light_8" },
		{
			duration = 3.000,
			audioprops =
			{
	...
	{
		11.000, START_AUDIO_PROP_ANIM, { "rtc_music_friendly_encouragement_1" },
		{
			duration = 3.000,
			audioprops =
			{
	...
	{
		13.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_4" },
		{
			duration = 1.093,
			audioprops =
			{
	...
	{
		13.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_5" },
		{
			duration = 1.093,
			audioprops =
			{
	...
	{
		13.000, START_AUDIO_PROP_ANIM, { "snd_backgroundambient_3" },
		{
			duration = 1.000,
			audioprops =
			{
	...
	{
		13.031, START_AUDIO_PROP_ANIM, { "snd_sfx_ship_levitation_6" },
		{
			duration = 1.059,
			audioprops =
			{
...

	{
		13.875, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKhead", "Char_juni" },
		{
			...
			spatialprops =
			{
				pos = { 1.063993, 1.598045, -3.727183 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
