...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 3.68075, 0.884558, 2.10702 },
			orient = { {  0.655382,  0.000000, -0.755297 },
					   {  0.062321,  0.996590,  0.054076 },
					   {  0.752722, -0.082511,  0.653147 } }
		},
		cameraprops =
		{
			fovh = 25,
	...
	{
		entity_name = "Char_Trent_EndingPt_MK",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Char_Ozu_EndingtPt_MK",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0.843099, 0.545606, 0.231225 },
			orient = { {  0.936187,  0.000000,  0.351502 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.351502,  0.000000,  0.936187 } }
		}
	}
};
...
events =
{
	...
	{
		0.769, START_IK, { "Char_trent", "Char_ozu" },
		{
			duration = 3.000,
	...
	{
		6.420, START_SPATIAL_PROP_ANIM, { "Char_trent", "Char_Trent_EndingPt_MK" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 1.384054, 0.970194, -1.408604 },
				q_orient = { 0.926685, 0, -0.375838, 0 }
			}
		}
	},

	{
		6.420, START_SPATIAL_PROP_ANIM, { "Char_ozu", "Char_Ozu_EndingtPt_MK" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 0.843099, 0.545606, 0.231225 },
				q_orient = { 0.752893, 0, -0.658143, 0 }
			}
		}
	},
	...
	{
		7.187, START_IK, { "Char_ozu", "Char_trent" },
		{
			duration = 2.546,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		8.670, START_SPATIAL_PROP_ANIM, { "Char_ozu", "Char_Ozu_EndingtPt_MK" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		8.670, START_SPATIAL_PROP_ANIM, { "Char_trent", "Char_Trent_EndingPt_MK" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
