...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -0.157623, 1.619443, 0.603825 },
			orient = { {  0.829721,  0.000000,  0.558178 },
					   {  0.056455,  0.994872, -0.083919 },
					   { -0.555316,  0.101141,  0.825466 } }
		},
		cameraprops =
		{
			fovh = 25,
...
events =
{
	...
	{
		1.565, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.572, START_MOTION, { "Offer_Character_A" },
		{
