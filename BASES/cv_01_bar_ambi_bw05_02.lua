...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_bw05_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.883804, 0.403849, 0.236212 },
					   { 0.445912, 0.574291, 0.686551 },
					   { 0.141609, 0.712107, -0.687642 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.141176, 0.25098, 1 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.07451, 0.423529, 0.541176 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.388253, 0.921553 },
					   { 0.000000, -0.921553, 0.388253 } }
		}
	},
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0, 0.058824, 0.466667 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.003922, 0.635294, 0.745098 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.901631, 0.432506 },
					   { 0.000000, -0.432506, 0.901631 } }
		}
	},

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.25098, 0.537255, 0.890196 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.12549, 0.321569, 0.384314 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0.058824, 0.466667 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.129412, 0.670588, 0.996078 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -783.5449, -8037.592, 0 },
			orient  =  { { 0.992624, -0.121235, 0.000000 },
					   { 0.121235, 0.992624, 0.000000 },
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_bw05_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
