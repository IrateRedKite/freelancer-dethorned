...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_li0402",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { -35000, 0, 0 },
			orient  =  { { 0.945698, -0.019239, 0.324476 },
					   { -0.011300, 0.995698, 0.091970 },
					   { -0.324849, -0.090642, 0.941412 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.970704, -0.227220, -0.078143 },
					   { -0.083294, 0.623255, -0.777570 },
					   { 0.225382, -0.748281, -0.623922 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.533333, 0.576471, 0.67451 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.156863, 0.145098, 0.188235 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.203922, 0.811765, 0.478431 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Li04",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.835338, 0.000000, -0.549736 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.549736, 0.000000, 0.835338 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Li04_stars",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_li0402" },
		{
			duration  =  0.000,
			fogprops  = 
			{
