...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A04aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A04aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.000, START_SOUND, { "VoiceProfile_GCS_ML_A04aG01" },
		{
			duration = 3.000
		}
	},
	...
	{
		1.265, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.126,
