...
entities =
{
	...
	{
		entity_name = "snd_music_failure_7",
		type = SOUND,
	...
	{
		entity_name = "snd_backgroundambient_2",
		type = SOUND,
...
{
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_backgroundambient_2" },
		{
			duration = 1.000,
			audioprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_music_failure_7" },
		{
			duration = 3.000,
			audioprops =
			{
	...
	{
		0.001, START_SOUND, { "snd_music_failure_7" },
		{
			duration = 17.000,
			start_time = 3000,
			flags = LOOP
	...
	{
		3.023, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_5" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		3.023, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		9.062, START_AUDIO_PROP_ANIM, { "snd_music_failure_7" },
		{
			duration = 3.000,
			audioprops =
			{
...

	{
		10.437, START_SPATIAL_PROP_ANIM, { "Cam_B_OTS_onJuni", "Cam_C_Mdm_Juni" },
		{
			...
			{
				pos = { 2.129406, 1.516953, -3.171517 },
				q_orient = { -0.393626, 0.716513, 0.575906, -0.100988 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		10.500, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_Juni_Mk_IKeye_Right" },
		{
			...
			spatialprops =
			{
				pos = { 2.665324, 2.262559, 0.016431 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		14.090, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_4" },
		{
			duration = 1.500,
			audioprops =
			{
	...
	{
		14.090, START_AUDIO_PROP_ANIM, { "snd_sfx_ship_levitation_6" },
		{
			duration = 1.500,
			audioprops =
			{
	...
	{
		14.312, START_AUDIO_PROP_ANIM, { "snd_music_failure_7" },
		{
			duration = 1.187,
			audioprops =
			{
	...
	{
		14.437, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 1.152,
			audioprops =
			{
	...
	{
		14.437, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_5" },
		{
			duration = 1.031,
			audioprops =
			{
