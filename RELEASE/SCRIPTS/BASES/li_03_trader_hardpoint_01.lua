...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0.592215, 1.605915, -9.494066 },
			orient  =  { { 0.150887, 0.000000, -0.988551 },
					   { -0.062886, 0.997975, -0.009599 },
					   { 0.986549, 0.063614, 0.150581 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -0.392952, 1.623803, -10.14813 },
			orient  =  { { -0.934272, 0.000000, 0.356561 },
					   { 0.019978, 0.998429, 0.052348 },
					   { -0.356001, 0.056031, -0.932804 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.376080, 0.000000, -0.926587 },
					   { -0.034716, 0.999298, -0.014090 },
					   { 0.925937, 0.037467, 0.375815 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -8.424385, 0, -4.005932 },
			orient  =  { { 0.739331, 0.000000, -0.673342 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.673342, 0.000000, 0.739331 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -9.529549, 1.682559, -3.039562 },
			orient  =  { { 0.873599, 0.000000, 0.486646 },
					   { 0.090491, 0.982560, -0.162444 },
					   { -0.478159, 0.185948, 0.858363 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -8.499157, 1.763286, -3.358252 },
			orient  =  { { 0.975811, 0.000000, -0.218617 },
					   { -0.039610, 0.983450, -0.176799 },
					   { 0.214999, 0.181182, 0.959661 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -8.654298, 1.68258, -3.689277 },
			orient  =  { { 0.963654, 0.000000, -0.267154 },
					   { -0.025749, 0.995344, -0.092881 },
					   { 0.265910, 0.096384, 0.959167 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -9.460893, 1.70081, -4.634474 },
			orient  =  { { -0.415452, 0.000000, 0.909615 },
					   { 0.116706, 0.991735, 0.053304 },
					   { -0.902097, 0.128303, -0.412019 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -8.793781, 1.711661, -4.083458 },
			orient  =  { { 0.920326, 0.000000, -0.391152 },
					   { -0.028237, 0.997391, -0.066438 },
					   { 0.390132, 0.072189, 0.917925 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -9.731407, 1.7789, -4.804656 },
			orient  =  { { -0.326986, 0.000000, 0.945029 },
					   { 0.188296, 0.979949, 0.065152 },
					   { -0.926080, 0.199249, -0.320430 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -7.588289, 8.906154, -1.049893 },
			orient  =  { { 0.940628, -0.313133, -0.131024 },
					   { 0.039342, 0.483971, -0.874199 },
					   { 0.337152, 0.817141, 0.467556 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -9.072132, 1.693426, -4.400798 },
			orient  =  { { -0.418669, 0.000000, 0.908139 },
					   { 0.045252, 0.998758, 0.020862 },
					   { -0.907011, 0.049830, -0.418149 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -10.23698, 1.724887, -4.117628 },
			orient  =  { { 0.221398, 0.000000, 0.975183 },
					   { 0.187186, 0.981405, -0.042497 },
					   { -0.957050, 0.191950, 0.217281 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -6.316447, 4.92579, -20.22253 },
			orient  =  { { -0.999969, 0.000000, -0.007939 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.007939, 0.000000, -0.999969 } }
		},
		userprops  = 
		{
			category  =  "Equipment",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -16.44213, 0.851339, -10.10765 },
			orient  =  { { 0.003831, 0.000000, -0.999993 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.999993, 0.000000, 0.003831 } }
		},
		userprops  = 
		{
			category  =  "Equipment",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -6.256437, 0.841195, -19.78525 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		userprops  = 
		{
	...
	{
		entity_name  =  "Bin_StackGreen_Refgoods_12",
		type  =  COMPOUND,
		template_name  =  "StackGreen_Refgoods",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 16.73621, 4.915019, -9.852346 },
			orient  =  { { 0.014085, 0.000000, 0.999901 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.999901, 0.000000, 0.014085 } }
		},
		userprops  = 
		{
			category  =  "Equipment",
	...
	{
		entity_name  =  "Bin_StackGrey_hivalue_23",
		type  =  COMPOUND,
		template_name  =  "StackGrey_hivalue",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 16.62922, 0.857784, -9.918087 },
			orient  =  { { -0.016806, 0.000000, 0.999859 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.999859, 0.000000, -0.016806 } }
		},
		userprops  = 
		{
			category  =  "Equipment",
	...
	{
		entity_name  =  "Bin_Stackdrab_oremetals_24",
		type  =  COMPOUND,
		template_name  =  "Stackdrab_oremetals",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 16.31038, 0.836412, -6.055196 },
			orient  =  { { 0.000464, 0.000000, 1.000000 },
					   { 0.000000, 1.000000, 0.000000 },
