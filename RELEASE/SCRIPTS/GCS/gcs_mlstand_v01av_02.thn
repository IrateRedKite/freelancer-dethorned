...
entities =
{
	...
	{
		entity_name = "Layer_GCS_V01aV_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_V01aV02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_V01aV02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_V01aV02_RVP01",
			duration = 1.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_V01aV02" },
		{
			duration = 1.281
		}
	},
