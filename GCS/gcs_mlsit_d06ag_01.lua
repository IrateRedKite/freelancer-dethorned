...
events =
{
	...
	{
		1.358, START_SOUND, { "VoiceProfile_$BGCS_My_Faction_ML" },
		{
			duration = 2.028
		}
	},
	...
	{
		2.141, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.246,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.141, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.246,
			target_part = "",
			target_type = ROOT,
