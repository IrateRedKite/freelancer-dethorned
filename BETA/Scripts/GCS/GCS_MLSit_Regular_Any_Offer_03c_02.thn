...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03cR02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.776902,  0.000000,  0.629622 },
					   {  0.107012,  0.985450, -0.132044 },
					   { -0.620461,  0.169963,  0.765598 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.263632, 1.66097, -0.152705 },
			orient = { { -0.075103,  0.000000, -0.997176 },
					   { -0.527107,  0.848871,  0.039700 },
					   {  0.846474,  0.528600, -0.063753 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.480754, 1.90569, -0.204169 },
			orient = { {  0.014776,  0.000000, -0.999891 },
					   { -0.539895,  0.841695, -0.007978 },
					   {  0.841603,  0.539954,  0.012437 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03cR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03cR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03cR02_RVP01",
			duration = 3.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03cR02" },
		{
			duration = 3.197
		}
	},

	{
		1.000, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			...
			{
				pos = { 1.263632, 1.66097, -0.152705 },
				q_orient = { -0.075104, 0, -0.997176, -0.527107 }
			},
			param_curve =
			{
	...
	{
		2.092, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.398, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.302,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.700, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.700, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
