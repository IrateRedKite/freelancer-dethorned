...
events =
{
	...
	{
		0.953, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.768,
	...
	{
		2.312, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.312, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
