...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_li0304",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.533333, 0.411765, 0.235294 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.835294, 0.52549, 0.215686 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.203922, 0.203922, 0.313726 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Li03",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.418894, 0.089127, -0.903650 },
					   { 0.618761, 0.756368, -0.212231 },
					   { 0.664577, -0.648046, -0.371986 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Li03_stars",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_li0304" },
		{
			duration  =  0.000,
			fogprops  = 
			{
