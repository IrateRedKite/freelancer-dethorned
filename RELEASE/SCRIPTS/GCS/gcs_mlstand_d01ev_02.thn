...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01eV_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01eV02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01eV02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01eV02_RVP01",
			duration = 2.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01eV02" },
		{
			duration = 2.107
		}
	},
	...
	{
		0.787, START_MOTION, { "Offer_Character_A" },
		{
