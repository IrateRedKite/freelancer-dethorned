...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F05bG01_Sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.497947, 1.912964, -0.220356 },
			orient = { {  0.100559,  0.000000, -0.994931 },
					   { -0.458508,  0.887481, -0.046342 },
					   {  0.882982,  0.460844,  0.089244 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F05bG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F05bG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F05bG01_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_GRABR_CHIN_RLEASE_000LV_XA_02",
			duration = 2.000,
			trans_time = 0.700,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F05bG01" },
		{
			duration = 2.515
		}
	},

	{
		...
		{
			animation = "Sc_MLBODY_CHRF_CHIN_HOLDR_000LV_XA_03",
			duration = 3.066,
			time_scale = 1,
			weight = 1,
			heading = -1,
	...
	{
		2.019, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.019, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.104, START_MOTION, { "Offer_Character_A" },
		{
