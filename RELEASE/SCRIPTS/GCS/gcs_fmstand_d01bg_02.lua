...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01bG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01bG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01bG02_RVP51",
			duration = 4.164,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.002, ATTACH_ENTITY, { "Offer_Character_A", "Marker_HalfApple" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.340, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01bG02" },
		{
			duration = 3.763
		}
	},
	...
	{
		1.187, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.359, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.390, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.413, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.799, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.460,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.259, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.259, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
