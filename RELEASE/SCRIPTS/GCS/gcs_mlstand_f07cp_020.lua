...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07cP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07cP02_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F07cP02_Trent",
			duration = 3.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07cP02" },
		{
			duration = 1.859
		}
	},
	...
	{
		1.859, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.859, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.059, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.800,
			end_effector = "Body_Head",
			count_to_root = 1,
