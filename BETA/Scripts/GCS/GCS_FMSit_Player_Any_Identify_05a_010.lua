...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D05aP01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D05aP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D05aP01_5",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D05aP02_Trent",
			duration = 1.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.479, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.479, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D05aP01" },
		{
			duration = 0.980
		}
	},
	...
	{
		0.875, START_MOTION, { "Player_Character_P" },
		{
