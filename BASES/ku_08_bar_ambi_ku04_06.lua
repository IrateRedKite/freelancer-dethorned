...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_ku_08_bar_Ku04_06",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.987751, -0.156017, -0.002724 },
					   { -0.139418, -0.890232, 0.433646 },
					   { -0.070081, -0.427954, -0.901079 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.352941, 0.486275, 0.596078 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.392157, 0.533333, 0.47451 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.591288, 0.000000, -0.806461 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.806461, 0.000000, -0.591288 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_ku_08_bar_Ku04_06" },
		{
			duration  =  0.000,
			fogprops  = 
			{
