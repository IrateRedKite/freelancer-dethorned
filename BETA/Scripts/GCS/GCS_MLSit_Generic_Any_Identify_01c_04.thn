...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01cG04",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01cG04",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01cG04_RVP01",
			duration = 4.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.393, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01cG04" },
		{
			duration = 3.506
		}
	},
	...
	{
		0.896, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 3.114,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.960, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_000LV_XA_06",
			duration = 6.400,
			trans_time = 0.750,
