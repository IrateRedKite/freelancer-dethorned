...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_ew0401",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "ambi_starsphere_Ew04",
		type = COMPOUND,
		template_name = "starsphere_Ew04",
		lt_grp = 23, srt_grp = -100, usr_flg = 1,
		flags = LIT_DYNAMIC,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { { -0.809657,  0.032309,  0.586013 },
					   { -0.076025,  0.984297, -0.159307 },
					   { -0.581958, -0.173536, -0.794487 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_starsphere_Ew04_stars",
		type = COMPOUND,
		template_name = "starsphere_Ew04_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_ew0401" },
		{
			duration = 0.000,
			fogprops =
			{
