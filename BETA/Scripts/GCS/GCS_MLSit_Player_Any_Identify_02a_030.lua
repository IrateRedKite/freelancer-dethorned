...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D02aP03_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.054872, 1.545763, -0.345672 },
			orient = { {  0.156777,  0.000000,  0.987634 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.987634,  0.000000,  0.156777 } }
		}
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02aP03",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02aP03_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D02aP03_Trent",
			duration = 1.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.001, START_IK, { "Player_Character_P", "Mrk_RtHeadIK" },
		{
			duration = 0.300,
	...
	{
		0.226, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.304, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.388, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.100,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.490, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.490, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02aP03" },
		{
			duration = 0.991
		}
	}
