...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 0.731681, 1.621297, 1.370891 },
...

	{
		...
		spatialprops =
		{
			pos = { 1.560318, 0, 1.900065 },
			orient = { { -0.029253,  0.000000, -0.999572 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.999572,  0.000000, -0.029253 } }
		}
	},
...

	{
		...
		spatialprops =
		{
			pos = { -0.228491, 2.796262, 2.958021 },
			orient = { { -0.423701,  0.000000, -0.905802 },
					   { -0.187000,  0.978458,  0.087472 },
					   {  0.886289,  0.206447, -0.414574 } }
		},
		cameraprops =
		{
			fovh = 25,
...

	{
		...
		spatialprops =
		{
			pos = { 1.573844, 1.744403, -3.343343 },
			orient = { { -0.904430,  0.000000, -0.426621 },
					   { -0.051861,  0.992584,  0.109943 },
					   {  0.423458,  0.121561, -0.897723 } }
		},
		cameraprops =
		{
			fovh = 25,
...

	{
		...
		spatialprops =
		{
			pos = { 0.123312, 1.715039, -3.677871 },
			orient = { { -0.950869,  0.000000, -0.309592 },
					   { -0.015771,  0.998702,  0.048437 },
					   {  0.309191,  0.050940, -0.949635 } }
		},
		cameraprops =
		{
			fovh = 10,
...

	{
		...
		spatialprops =
		{
			pos = { 0.471298, 4.995727, -3.064066 },
			orient = { { -0.932315,  0.000000, -0.361647 },
					   { -0.253922,  0.712051,  0.654604 },
					   {  0.257511,  0.702127, -0.663856 } }
		},
		cameraprops =
		{
			fovh = 25,
...

	{
		...
		{
			path_type = "CV_CROrientationSplinePath",
			path_data = "OPEN,{-0.000380,-0.019338,-0.052137}, {0.999988,0.004365,-0.002176,-0.000120}, {-0.351266,1.794641,0.843424}, {0.972263,-0.230936,-0.032193,-0.018332}, {-0.536970,3.567938,-0.642465}, {0.915732,-0.398984,-0.046682,0.008203}, "
		}
	},
	...
	{
		entity_name = "sfx_put_down_beercap01_1",
		type = SOUND,
		template_name = "sfx_put_down_beercap01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
	...
	{
		entity_name = "ambi_LtG00_Point_BKeep_Spcl",
		type = LIGHT,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		...
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.286275, 0.27451, 0.392157 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 3.9,
	...
	{
		entity_name = "ambi_LtG00_Point_Trent_Spcl",
		type = LIGHT,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0.300308, 1.894767, 0.864349 },
			orient = { { -0.928396,  0.000000,  0.371593 },
					   { -0.187842,  0.862824, -0.469308 },
					   { -0.320619, -0.505504, -0.801042 } }
		},
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.811765, 0.776471, 0.686275 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2.3,
	...
	{
		entity_name = "Cam_03_OTS_Float_Trent_A_Static",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = HIDDEN,
		spatialprops =
		{
			pos = { -0.438757, 1.645704, -1.52205 },
			orient = { { -0.965191,  0.000000, -0.261547 },
					   { -0.008855,  0.999427,  0.032678 },
					   {  0.261397,  0.033857, -0.964638 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "cam_01_dolly_fx_FadeFromBlack_1_Sec_1",
		type = PSYS,
		template_name = "RTC_FadeFromBlack_1_Sec",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
		spatialprops =
		{
			pos = { 0.264487, 1.097023, -0.770532 },
			orient = { {  0.040466, -0.000467,  0.999181 },
					   {  0.151600,  0.988426, -0.005677 },
					   { -0.987613,  0.151705,  0.040068 } }
		},
		psysprops =
		{
			sparam = 0
	...
	{
		entity_name = "cam_01_dolly_fx_fadefromblack_2",
		type = PSYS,
		template_name = "rtc_fadefromblack",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
		spatialprops =
		{
			pos = { -4.210496, 1.782164, -0.521695 },
			orient = { {  0.055568, -0.000002,  0.998455 },
					   {  0.152404,  0.988282, -0.008480 },
					   { -0.986755,  0.152640,  0.054917 } }
		},
		psysprops =
		{
			sparam = 0
	...
	{
		entity_name = "Ambi_LtG00_Pnt_mFloor3/01",
		type = LIGHT,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = REFERENCE,
...
events =
{
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "Cam_01_Dolly", "Cam_01_Dolly_A" },
		{
			...
			spatialprops =
			{
				pos = { -3.995319, 1.661417, 3.817961 },
	...
	{
		0.000, START_LIGHT_PROP_ANIM, { "Ambi_LtG00_Pnt_mFloor3/01" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_backgroundambient_copy_1" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, ATTACH_ENTITY, { "cam_01_dolly_fx_FadeFromBlack_1_Sec_1", "Cam_01_Dolly" },
		{
			duration = 2.000,
			offset = { 0, 0, -0.5 },
			up = Y_AXIS,
	...
	{
		0.000, START_PSYS, { "cam_01_dolly_fx_fadefromblack_2" },
		{
			duration = 0.500
		}
	},
	...
	{
		0.000, ATTACH_ENTITY, { "cam_01_dolly_fx_fadefromblack_2", "Cam_01_Dolly" },
		{
			duration = 3.000,
			offset = { 0, 0, -0.5 },
			up = Y_AXIS,
	...
	{
		0.500, START_PSYS, { "cam_01_dolly_fx_FadeFromBlack_1_Sec_1" },
		{
			duration = 1.000
		}
	},
	...
	{
		0.553, START_IK, { "Char_bartender", "Char_Bart_Mk_IKeyes" },
		{
			duration = 3.851,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		0.553, START_IK, { "Char_bartender", "Char_Bart_Mk_IKhead_bart_fixt" },
		{
			duration = 3.851,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		9.261, START_MOTION, { "Char_li_diplomat_1" },
		{
	...
	{
		9.327, START_AUDIO_PROP_ANIM, { "sfx_fs_mr_hard02_6" },
		{
			duration = 0.100,
			audioprops =
			{
	...
	{
		13.593, SET_CAMERA, { "Cam_Monitor_s003x_static", "Cam_01_Dolly_F" }
	},
	...
	{
		17.419, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		17.479, START_LIGHT_PROP_ANIM, { "Ambi_LtG00_Pnt_mFloor3/01" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		18.848, START_MOTION, { "Char_trent" },
		{
	...
	{
		23.750, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		23.750, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Trent_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		23.750, SET_CAMERA, { "Cam_Monitor_s003x", "Cam_03_new_a" }
	},

	{
		23.750, SET_CAMERA, { "Cam_Monitor_s003x_static", "Cam_03_OTS_Float_Trent_A_Static" }
	},
	...
	{
		23.937, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		24.679, START_SPATIAL_PROP_ANIM, { "Cam_03_new_a", "Cam_03_new_b" },
		{
			duration = 6.078,
			target_part = "",
			target_type = ROOT,
	...
	{
		25.625, START_SOUND, { "sfx_put_down_beercap01_1" },
		{
			duration = 0.694
		}
	},
	...
	{
		29.875, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		32.875, START_MOTION, { "Char_bartender" },
		{
			animation = "Sc_dx_s003x_0601_manhtn_bar",
			duration = 4.699,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		33.468, START_AUDIO_PROP_ANIM, { "sfx_put_down_glass05_3" },
		{
			duration = 0.100,
			audioprops =
			{
	...
	{
		33.593, START_SOUND, { "sfx_put_down_glass05_3" },
		{
			duration = 0.358
		}
	},
	...
	{
		33.608, SET_CAMERA, { "Cam_Monitor_s003x", "Cam_03_new_c" }
	},

	{
		33.608, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
...

	{
		36.811, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_li_diplomat_1" },
		{
			...
			spatialprops =
			{
				pos = { -4.741019, 1.164969, 6.130361 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		45.500, START_SOUND, { "sfx_gulp01_5" },
		{
			duration = 0.522
		}
	},
	...
	{
		45.500, START_AUDIO_PROP_ANIM, { "sfx_gulp01_5" },
		{
			duration = 1.098,
			audioprops =
			{
	...
	{
		45.937, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
...

	{
		45.937, START_SPATIAL_PROP_ANIM, { "Cam_08_Mk_AUTOPAN_Spatial", "Cam_08_Mk_AUTOPAN" },
		{
			...
			spatialprops =
			{
				pos = { -1.034364, 1.517987, -1.620719 }
			}
		}
	},
	...
	{
		46.062, START_SOUND, { "sfx_gulp01_5" },
		{
			duration = 0.522
		}
	},
	...
	{
		49.405, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		50.812, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Trent_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
				diffuse = { 0.439216, 0.419608, 0.372549 },
			}
		}
	},
	...
	{
		57.937, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Trent_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		58.781, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		65.500, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		67.176, START_MOTION, { "Char_li_diplomat_1" },
		{
			animation = "Sc_dx_s004x_0201_Li_diplomt",
			duration = 3.166,
			trans_time = 0.500,
	...
	{
		67.521, START_AUDIO_PROP_ANIM, { "sfx_fs_ml_hard01_1" },
		{
			duration = 0.100,
			audioprops =
			{
	...
	{
		68.596, START_MOTION, { "Char_bartender" },
		{
	...
	{
		69.053, START_AUDIO_PROP_ANIM, { "sfx_put_down_beercap01_1" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		69.121, START_SOUND, { "sfx_put_down_beercap01_1" },
		{
			duration = 0.694
		}
	},
	...
	{
		70.744, ATTACH_ENTITY, { "Cam_14_Mk_AUTOPAN_Neck", "Char_bartender" },
		{
			duration = 9.406,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		72.179, START_SOUND, { "dx_s003x_1801_manhtn_bar_22" },
		{
			duration = 3.529
		}
	},
	...
	{
		72.387, START_SOUND, { "sfx_put_down_glass05_9" },
		{
			duration = 0.358
		}
	},
	...
	{
		72.402, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		77.509, START_AUDIO_PROP_ANIM, { "sfx_pick_up_bottle03_11" },
		{
			duration = 0.300,
			audioprops =
			{
	...
	{
		77.854, START_MOTION, { "Char_bartender" },
		{
			animation = "Sc_MLHAND_HNEUT_HOLDD_RGHT_000LV_00",
			duration = 3.000,
			start_time = 7.000,
	...
	{
		78.375, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		79.011, CONNECT_HARDPOINTS, { "Prop_glass_green", "Char_trent" },
		{
			duration = 6.686,
			hardpoint = "HpLeftConnect_prop_glass_green",
			parent_hardpoint = "HpLeftConnect"
	...
	{
		79.012, START_AUDIO_PROP_ANIM, { "sfx_pick_up_glass01_12" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		79.057, START_MOTION, { "Char_li_diplomat_1" },
		{
			animation = "Sc_MLBODY_CHRB_IDLE_BIG_000LV_XA_05",
			duration = 5.000,
			time_scale = 1,
	...
	{
		79.057, ATTACH_ENTITY, { "Char_li_diplomat_1", "Char_li_diplo_Mk_loc_01" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		79.324, START_SOUND, { "sfx_pick_up_glass01_12" },
		{
			duration = 0.578
		}
	},
...

	{
		79.657, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes_down", "Char_li_diplomat_1" },
		{
			...
			spatialprops =
			{
				pos = { -4.733773, 1.163981, 6.146468 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		80.096, START_MOTION, { "Char_bartender" },
		{
			animation = "Sc_MLBODY_BASEPOSE_LARG_FRAME_000LV_XA_04",
			duration = 4.987,
			trans_time = 1.000,
	...
	{
		80.244, START_CAMERA_PROP_ANIM, { "Cam_15_PCO_A", "Cam_15_PCO_B" },
		{
			duration = 8.691,
			cameraprops =
			{
	...
	{
		80.331, START_IK, { "Char_trent", "Prop_glass_green" },
		{
			duration = 2.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		80.331, START_MOTION, { "Char_trent" },
		{
			animation = "Sc_MLHEAD_MOTION_DRINK_SWALLOW_TRENT_000LV_XA_%",
			duration = 4.000,
			trans_time = 0.300,
	...
	{
		81.554, START_SOUND, { "sfx_gulp01_13" },
		{
			duration = 0.522
		}
	},
	...
	{
		81.846, START_AUDIO_PROP_ANIM, { "sfx_gulp01_13" },
		{
			duration = 1.000,
			audioprops =
			{
	...
	{
		82.417, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Trent_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		83.968, START_AUDIO_PROP_ANIM, { "snd_backgroundambient_copy_1" },
		{
			duration = 3.000,
			audioprops =
			{
	...
	{
		85.161, START_MOTION, { "Char_li_diplomat_1" },
		{
			animation = "Sc_MLHAND_HNEUT_GESTR_CASL_000LV_00",
			duration = 1.837,
			time_scale = 1,
	...
	{
		86.634, START_MOTION, { "Char_trent" },
		{
	...
	{
		86.744, SET_CAMERA, { "Cam_Monitor_s003x_static", "Cam_15_PCO_B" }
	},
	...
	{
		90.010, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_BKeep_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		90.010, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Trent_Spcl" },
		{
			duration = 0.000,
			lightprops =
			{
