...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F08bR01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F08bR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F08bR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F08bR01_RVP51",
			duration = 2.666,
			time_scale = 1,
			weight = 1,
			heading = -1
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F08bR01" },
		{
			duration = 2.039
		}
	},

	{
		...
		{
			animation = "Sc_FMBODY_CHRF_CONV_LHND_CASL_000LV_xc_01",
			duration = 1.666,
			trans_time = 0.500,
			time_scale = 0.6,
			weight = 1,
	...
	{
		1.187, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},
