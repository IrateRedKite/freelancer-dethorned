...
entities =
{
	...
	{
		entity_name = "Layer_GCS_V05bV_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_V05bV02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_V05bV02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_V05bV02_RVP01",
			duration = 2.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.296, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_V05bV02" },
		{
			duration = 1.350
		}
	},
	...
	{
		0.850, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.062, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.787,
			end_effector = "Body_Head",
			count_to_root = 1,
