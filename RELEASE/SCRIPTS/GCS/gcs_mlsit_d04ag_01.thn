...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D04aG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D04aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D04aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D04aG01_RVP01",
			duration = 3.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.359, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D04aG01" },
		{
			duration = 3.367
		}
	},
	...
	{
		1.296, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.921, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.140, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.699,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.305, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		2.812, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.859, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.042,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.906, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.906, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
	...
	{
		2.906, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.976, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.893,
			end_effector = "Eye IK Left",
			count_to_root = 1,
