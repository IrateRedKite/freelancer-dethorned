...
events =
{
	...
	{
		0.926, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.087, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.282,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.500, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP05" },
		{
			duration = 0.865
		}
	}
