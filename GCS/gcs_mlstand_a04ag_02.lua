...
events =
{
	...
	{
		0.001, START_SOUND, { "VoiceProfile_GCS_ML_A04aG02" },
		{
			duration = 3.561
		}
	},
	...
	{
		0.467, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.126,
	...
	{
		1.577, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.329, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
