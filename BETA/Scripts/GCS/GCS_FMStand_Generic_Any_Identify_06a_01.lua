...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -0.195214, 1.605267, 0.582395 },
			orient = { {  0.812238,  0.000000,  0.583327 },
					   {  0.053933,  0.995717, -0.075097 },
					   { -0.580828,  0.092457,  0.808759 } }
		},
		cameraprops =
		{
			fovh = 25,
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D06aG01_RVP51",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.264, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D06aG00" },
		{
			duration = 1.253
		}
	},
	...
	{
		1.233, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.460, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.875,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.753, START_SOUND, { "VoiceProfile_$BGCS_My_Faction_FM" },
		{
			duration = 2.653
		}
	},
	...
	{
		3.269, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
