...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.600339, 1.201537, 0.963372 },
			orient = { {  0.742597,  0.000000, -0.669738 },
					   { -0.025901,  0.999252, -0.028718 },
					   {  0.669237,  0.038673,  0.742042 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01bG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01bG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01bG03_RVP01",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.328, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01bG03" },
		{
			duration = 3.069
		}
	},
	...
	{
		1.390, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.617, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_000LV_XA_06",
			duration = 6.400,
			trans_time = 0.750,
	...
	{
		1.978, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.210, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.360,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.569, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.569, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
