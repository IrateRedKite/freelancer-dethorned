...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01cG05_1",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01cG05",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG05_RVP01",
			duration = 2.000,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_W01cG05_1" },
		{
			duration = 1.625
		}
	},
	...
	{
		1.129, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.129, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
