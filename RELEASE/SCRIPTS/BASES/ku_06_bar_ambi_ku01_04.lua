...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_ku_06_bar_Ku01_04",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.888180, -0.246496, -0.387783 },
					   { -0.343061, 0.917172, 0.202743 },
					   { 0.305689, 0.313105, -0.899177 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.286275, 0.486275, 0.521569 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.301961, 0.301961, 0.52549 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.142655, 0.000000, 0.989772 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.989772, 0.000000, -0.142655 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_ku_06_bar_Ku01_04" },
		{
			duration  =  0.000,
			fogprops  = 
			{
