...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F10bR01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.026306,  0.000000, -0.999654 },
					   { -0.379000,  0.925343, -0.009973 },
					   {  0.925023,  0.379131,  0.024342 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.787898,  0.000000,  0.615806 },
					   {  0.012184,  0.999804, -0.015589 },
					   { -0.615686,  0.019786,  0.787743 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR04_15",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F10bR04",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F10bR04_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR04_15" },
		{
			duration = 2.467
		}
	},
	...
	{
		0.625, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},

	{
		0.968, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.593, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.970, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.970, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
