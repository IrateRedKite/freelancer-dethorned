...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.284596, 1.286365, 0.664091 },
			orient = { {  0.604293,  0.000000, -0.796762 },
					   { -0.186916,  0.972093, -0.141764 },
					   {  0.774527,  0.234595,  0.587429 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D07aG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D07aG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D07aG02_RVP01",
			duration = 1.832,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D07aG02" },
		{
			duration = 1.171
		}
	},
	...
	{
		0.670, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.670, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
