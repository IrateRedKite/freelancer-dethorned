...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_iw0601",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.606603, 0.208089, 0.767288 },
					   { 0.000000, -0.965137, 0.261745 },
					   { 0.795005, 0.158776, 0.585455 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.160784, 0.196078, 0.219608 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.105882, 0.105882, 0.129412 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.192157, 0.192157, 0.192157 },
			specular  =  { 0, 0, 0 },
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.262745, 0.321569, 0.360784 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.105882, 0.105882, 0.129412 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_iw0601" },
		{
			duration  =  0.000,
			fogprops  = 
			{
