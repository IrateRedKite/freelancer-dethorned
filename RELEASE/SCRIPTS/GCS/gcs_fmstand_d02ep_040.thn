...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -0.174685, 1.633504, 0.588466 },
			orient = { {  0.814681,  0.000000,  0.579909 },
					   {  0.066206,  0.993462, -0.093008 },
					   { -0.576118,  0.114165,  0.809354 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02eP04",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02eP04_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_D02eP04_Trent",
			duration = 2.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.312, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02eP04" },
		{
			duration = 1.327
		}
	},
	...
	{
		0.829, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.829, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.968, SET_CAMERA, { "Monitor_1", "Camera/PC2" }
	},

	{
		1.000, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.171, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.658,
			end_effector = "Body_Head",
			count_to_root = 1,
