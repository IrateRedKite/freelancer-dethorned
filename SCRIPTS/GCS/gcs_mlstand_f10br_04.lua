...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR04",
		type = SOUND,
...
events =
{
	...
	{
		0.428, SET_CAMERA, { "Monitor", "Camera/ACS" }
	},

	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR04" },
		{
			duration = 3.156
		}
	},
	...
	{
		1.496, START_MOTION, { "Offer_Character_A" },
		{
