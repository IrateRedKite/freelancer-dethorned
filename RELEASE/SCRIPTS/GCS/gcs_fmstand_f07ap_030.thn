...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07aP03",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07aP03_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F07aP03_Trent",
			duration = 1.832,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.529, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.529, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
...

	{
		...
		{
			animation = "Sc_MLBODY_STND_SALUT_RHND_000LV_A_05",
			duration = 5.333,
			trans_time = 1.000,
			time_scale = 0.5,
			weight = 1,
	...
	{
		0.750, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.750, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.768,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP03" },
		{
			duration = 0.528
		}
	},
	...
	{
		1.140, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.749,
			end_effector = "Body_Head",
			count_to_root = 1,
