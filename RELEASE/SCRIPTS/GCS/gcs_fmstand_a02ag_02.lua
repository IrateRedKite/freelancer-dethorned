...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_A02aG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_A02aG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.002, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_A02aG02_RVP51",
			duration = 3.332,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.453, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.659,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_A02aG02" },
		{
			duration = 2.784
		}
	},
	...
	{
		2.233, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.703,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.480, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.480, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
