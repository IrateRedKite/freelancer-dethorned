...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_li0204",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.573160, 0.271185, -0.773270 },
					   { 0.766531, 0.511029, -0.388947 },
					   { 0.289687, -0.815664, -0.500773 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.301961, 0.458824, 0.541176 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.329412, 0.290196, 0.435294 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.447059, 0.607843, 0.694118 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.388235, 0.341176, 0.509804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.490196, 0.52549, 0.909804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_li0204" },
		{
			duration  =  0.000,
			fogprops  = 
			{
