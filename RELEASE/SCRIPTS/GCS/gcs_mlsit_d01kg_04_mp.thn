...
events =
{
	...
	{
		0.606, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.968, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.561,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.546, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.546, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
