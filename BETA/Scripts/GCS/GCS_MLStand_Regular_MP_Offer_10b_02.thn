...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR02",
		type = SOUND,
...
events =
{
...

	{
		...
		{
			animation = "Sc_MLBODY_STND_WAVE_RHND_SMALL_000LV_A_31",
			duration = 31.166,
			start_time = 2.000,
			trans_time = 0.500,
			time_scale = 1,
	...
	{
		0.484, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.484, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.484, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR02" },
		{
			duration = 0.430
		}
	},
