...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D04aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D04aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D04aG01_RVP51",
			duration = 4.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D04aG01" },
		{
			duration = 3.371
		}
	},
	...
	{
		2.619, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
	...
	{
		2.625, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_STND_IDLE_000LV_xa_05",
			duration = 5.000,
			trans_time = 1.000,
	...
	{
		2.803, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		2.869, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
