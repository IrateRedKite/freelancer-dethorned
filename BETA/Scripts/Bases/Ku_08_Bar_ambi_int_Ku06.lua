...
entities =
{
	...
	{
		entity_name = "Layer_Ku_08_Bar_Ambi",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "Set_starsphere_Ku06_8",
		type = COMPOUND,
		template_name = "starsphere_Ku06",
		lt_grp = 0, srt_grp = -10, usr_flg = 1,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { {  0.980075,  0.128256,  0.151669 },
					   {  0.013099,  0.720189, -0.693654 },
					   { -0.198195,  0.681820,  0.704159 } }
		},
		userprops =
		{
			category = "Prop",
