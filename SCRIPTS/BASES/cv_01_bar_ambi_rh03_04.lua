...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_rh0304",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  N,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.8, 0.713726, 0.509804 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.180392, 0.184314, 0.321569 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.310241, -0.950219, 0.028888 },
					   { 0.835646, 0.258093, -0.484854 },
					   { 0.453262, 0.174561, 0.874118 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.796079, 0.607843, 0.219608 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.203922, 0.192157, 0.309804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.328700, 0.000000, -0.944434 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.944434, 0.000000, -0.328700 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0304" },
		{
			duration  =  0.000,
			fogprops  = 
			{
