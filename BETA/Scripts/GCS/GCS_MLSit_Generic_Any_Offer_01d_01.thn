...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F01dG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F01dG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F01dG01_RVP01",
			duration = 3.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.474, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F01dG01" },
		{
			duration = 2.890
		}
	},
	...
	{
		1.518, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.390, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.390, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
