...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_rh0405",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.653009,  0.620337,  0.434466 },
					   { -0.453796,  0.779772, -0.431306 },
					   { -0.606340,  0.084488,  0.790705 } }
		},
		lightprops =
		{
			on = Y,
...

	{
		...
		{
			pos = { -40000, 0, 0 },
			orient = { {  0.978657,  0.000000,  0.205503 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.205503,  0.000000,  0.978657 } }
		}
	},
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { {  0.653009,  0.620337,  0.434467 },
					   { -0.453796,  0.779772, -0.431306 },
					   { -0.606340,  0.084488,  0.790705 } }
		},
		lightprops =
	...
	{
		entity_name = "ambi_starsphere_Rh04",
		type = COMPOUND,
		template_name = "starsphere_Rh04",
		lt_grp = 23, srt_grp = -100, usr_flg = 1,
		flags = LIT_DYNAMIC,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { { -0.459707,  0.000000, -0.888071 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.888071,  0.000000, -0.459707 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_starsphere_Rh04_stars",
		type = COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_rh0405" },
		{
			duration = 0.000,
			fogprops =
			{
