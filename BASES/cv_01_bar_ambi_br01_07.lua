...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_Br01_07",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.501961, 0.352941, 0.223529 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 27567.39, 0, 0 },
			orient  =  { { -0.912957, 0.000000, 0.408055 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.408055, 0.000000, -0.912957 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.904435, -0.425200, -0.034676 },
					   { -0.425008, 0.905095, -0.013081 },
					   { 0.036947, 0.002907, -0.999313 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.937255, 0.819608, 0.580392 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.329412, 0.188235, 0.180392 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 89.30957, 36.92837, 0 },
			orient  =  { { 0.087416, 0.000000, -0.996172 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.996172, 0.000000, 0.087416 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "starsphere_Br01_stars_2",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_Br01_07" },
		{
			duration  =  0.000,
			fogprops  = 
			{
