...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D03aN01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D03aN01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D03aN01_RVP01",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D03aN01" },
		{
			duration = 3.279
		}
	},
	...
	{
		0.769, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.109, SET_CAMERA, { "Monitor_1", "Camera/AC2" }
	},
	...
	{
		2.828, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.952,
			end_effector = "Body_Head",
			count_to_root = 1,
