...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br_08_bar_Br02_05",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { -10000, 3000, 0 },
			orient  =  { { -0.956184, 0.000000, 0.292767 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.292767, 0.000000, -0.956184 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.983142, 0.052588, -0.175116 },
					   { -0.094817, 0.672268, 0.734211 },
					   { 0.156336, 0.738438, -0.655949 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.392157, 0.352941, 0.494118 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.223529, 0.223529, 0.290196 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Br02_1",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.592276, 0.063870, -0.803200 },
					   { -0.107216, 0.994236, 0.000000 },
					   { 0.798570, 0.086116, 0.595710 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Br02_stars_2",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br_08_bar_Br02_05" },
		{
			duration  =  0.000,
			fogprops  = 
			{
