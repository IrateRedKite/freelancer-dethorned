...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F08dR_03",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F08dR03",
		type = SOUND,
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F08dR03" },
		{
			duration = 4.011
		}
	},
	...
	{
		0.609, SET_CAMERA, { "Monitor", "Camera/ACS" }
	},

	{
		1.523, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.859, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.375, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.509, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.509, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
