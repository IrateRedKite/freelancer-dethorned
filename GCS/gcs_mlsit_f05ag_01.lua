...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.544785, 1.838311, -0.189648 },
			orient = { {  0.090873,  0.000000, -0.995863 },
					   { -0.400162,  0.915717, -0.036515 },
					   {  0.911928,  0.401824,  0.083214 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F05aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F05aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F05aG01_RVP01",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.419, SET_CAMERA, { "Monitor_1", "Camera/ACOH" }
	},

	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F05aG01" },
		{
			duration = 2.187
		}
	},
	...
	{
		1.389, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.690, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.690, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.000,
			end_effector = "Body_Head",
			count_to_root = 1,
