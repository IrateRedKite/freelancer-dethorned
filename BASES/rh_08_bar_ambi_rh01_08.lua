...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_Rh0108",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.27451, 0.270588, 0.345098 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.670588, 0.811765, 0.839216 },
			specular = { 0, 0, 0 },
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.934909, -0.354889 },
					   {  0.000000,  0.354889,  0.934909 } }
		}
	},
...

	{
		...
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.951690,  0.307059 },
					   {  0.000000, -0.307059,  0.951690 } }
		}
	},
	...
	{
		entity_name = "ambi_starsphere_Rh01",
		type = COMPOUND,
		template_name = "starsphere_Rh01",
		lt_grp = 23, srt_grp = -100, usr_flg = 1,
		flags = LIT_DYNAMIC,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { { -0.967551,  0.000000,  0.252676 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.252676,  0.000000, -0.967551 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_starsphere_Rh01_stars",
		type = COMPOUND,
		template_name = "starsphere_Rh01_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_Rh0108" },
		{
			duration = 0.000,
			fogprops =
			{
