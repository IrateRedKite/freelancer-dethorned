...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D06aG00" },
		{
			duration = 0.859
		}
	},
	...
	{
		1.046, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		1.108, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.327, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.350, START_SOUND, { "VoiceProfile_$BGCS_My_Faction_ML" },
		{
			duration = 2.336
		}
	},
	...
	{
		1.750, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.911, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.273, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.246,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.273, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.246,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.578, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_000LV_XA_06",
			duration = 6.400,
			trans_time = 1.000,
