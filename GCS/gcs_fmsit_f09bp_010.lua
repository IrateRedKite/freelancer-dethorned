...
events =
{
	...
	{
		0.984, START_SOUND, { "VoiceProfile_GCS_Trent_F09bP01" },
		{
			duration = 1.319
		}
	},
	...
	{
		1.302, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.302, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
