...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 38.71132, 52.05891, 28.97094 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 42.05987, 69.08189, 61.61331 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
...

	{
		1.000, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_05", "Camera_ShipLand_06" },
		{
			...
			{
				pos  =  { 14.77294, 21.82118, 40.55589 },
				q_orient  =  { 0.999419, 0, -0.034074, 0.000562 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		3.217, ATTACH_ENTITY, { "Playership_engine_land_turbine_snd", "PlayerShip_1" },
		{
			duration  =  10.281,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		3.218, START_SOUND, { "Playership_engine_land_turbine_snd" },
		{
			duration  =  10.251
		}
	},
	...
	{
		3.218, START_AUDIO_PROP_ANIM, { "Playership_engine_land_turbine_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.349359, 0.660256, 1.466667, 1.454545 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		3.349, START_AUDIO_PROP_ANIM, { "Playership_engine_land_snd" },
		{
			duration  =  2.082,
			audioprops  = 
			{
...

	{
		12.437, START_AUDIO_PROP_ANIM, { "Playership_engine_rumble_snd" },
		{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.801282, 0.307692, 1.187500, 1.047619 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		12.468, START_SOUND, { "Playership_engine_kill_snd" },
		{
			duration  =  1.799
		}
	},
	...
	{
		12.468, ATTACH_ENTITY, { "Playership_engine_kill_snd", "PlayerShip_1" },
		{
			duration  =  2.131,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		13.468, ATTACH_ENTITY, { "Playership_engine_kill_snd", "PlayerShip_1" },
		{
			duration  =  1.531,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		13.500, START_SOUND, { "Playership_engine_kill_snd" },
		{
			duration  =  1.799
		}
	}
