...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_li0405",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.670398, 0.374039, 0.640829 },
					   { -0.513829, 0.857083, 0.037276 },
					   { -0.535301, -0.354266, 0.766778 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_li0405" },
		{
			duration  =  0.000,
			fogprops  = 
			{
