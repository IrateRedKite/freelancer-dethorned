...
entities  = 
{
	...
	{
		entity_name  =  "Set_Cityscape_Background",
		type  =  COMPOUND,
		...
		spatialprops  = 
		{
			pos  =  { 2746.458, 771.8861, -15327.35 },
			orient  =  { { 0.988607, 0.012529, 0.149999 },
					   { 0.149758, 0.018382, -0.988552 },
					   { -0.015143, 0.999753, 0.016297 } }
		},
		userprops  = 
		{
			category  =  "Prop",
