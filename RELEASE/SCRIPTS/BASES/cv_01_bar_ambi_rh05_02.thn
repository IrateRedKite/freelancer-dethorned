...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_rh0502",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.345197, 0.469899, 0.812425 },
					   { -0.805910, 0.592038, 0.000000 },
					   { -0.480986, -0.654741, 0.583066 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.807843, 0.611765, 0.392157 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.435294, 0.294118, 0.156863 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { -35000, 0, 0 },
			orient  =  { { -0.969450, 0.036968, 0.242485 },
					   { 0.036917, 0.999307, -0.004755 },
					   { -0.242493, 0.004342, -0.970143 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.174918, 0.469899, 0.865216 },
					   { -0.789474, 0.592038, -0.161930 },
					   { -0.588331, -0.654741, 0.474531 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.870588, 0.737255, 0.588235 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.584314, 0.396078, 0.207843 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Rh05",
		type  =  COMPOUND,
		template_name  =  "starsphere_Rh05",
	...
	{
		entity_name  =  "ambi_starsphere_Rh05_stars",
		type  =  COMPOUND,
		template_name  =  "starsphere_Rh05_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0502" },
		{
			duration  =  0.000,
			fogprops  = 
			{
