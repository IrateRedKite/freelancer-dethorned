...
entities =
{
	...
	{
		entity_name = "ambi_Layer_Li_09_Commons_Li05",
		type = SCENE,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "ambi_Set_starsphere_Li05",
		type = COMPOUND,
		template_name = "starsphere_Li05",
		lt_grp = 0, srt_grp = -100, usr_flg = 2,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { { -0.291462,  0.909968, -0.294971 },
					   {  0.639583,  0.414679,  0.647283 },
					   {  0.711325,  0.000000, -0.702863 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_LtG01_Ambi_SpaceBar_Li05",
		type = LIGHT,
		template_name = "",
...
{
	{
		0.000, START_SPATIAL_PROP_ANIM, { "ambi_Set_starsphere_Li05" },
		{
			duration = 9000.000,
			target_type = ROOT,
			spatialprops =
