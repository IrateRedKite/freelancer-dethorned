...
events =
{
	...
	{
		4.000, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 0.100,
			psysprops =
			{
	...
	{
		4.156, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 0.100,
			psysprops =
			{
	...
	{
		4.406, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 0.100,
			psysprops =
			{
	...
	{
		4.656, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 0.100,
			psysprops =
			{
	...
	{
		4.937, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 0.100,
			psysprops =
			{
	...
	{
		5.218, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 0.100,
			psysprops =
			{
...

	{
		9.500, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_Dolly_02", "Camera_ShipLand_01" },
		{
			...
			{
				pos = { -3.809544, 5.802381, 18.26487 },
				q_orient = { 0.997402, -0.007253, -0.071665, 0.007253 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
