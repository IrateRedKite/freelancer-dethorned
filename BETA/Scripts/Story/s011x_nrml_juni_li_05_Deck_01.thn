...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.251846,  0.000000, -0.967767 },
					   { -0.139941,  0.989490,  0.036417 },
					   {  0.957596,  0.144602, -0.249199 } }
		},
		cameraprops =
		{
			fovh = 15,
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.122185,  0.000001, -0.992507 },
					   {  0.001108,  0.999999, -0.000136 },
					   {  0.992507, -0.001116, -0.122185 } }
		},
		cameraprops =
		{
			fovh = 15,
	...
	{
		entity_name = "Char_li_male_guard_1_Mk_IKeyes",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
...
events =
{
	...
	{
		0.000, START_SOUND, { "sfx_ambience_deck_space_smaller_1" },
		{
			duration = 60.017,
			flags = LOOP
		}
	...
	{
		0.001, START_SOUND, { "backgroundambient_4" },
		{
			duration = 58.479,
			flags = LOOP
		}
	...
	{
		0.936, START_SOUND, { "Char_li_male_guard_1_fs_ml_hard04" },
		{
			duration = 0.289
		}
	},
	...
	{
		8.201, START_SOUND, { "dx_s011x_0201_juni_1" },
		{
			duration = 5.000
		}
	},
	...
	{
		13.732, START_IK, { "Char_li_male_guard_1", "Char_li_male_guard_1_Mk_IKhead" },
		{
			duration = 3.237,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		13.732, START_IK, { "Char_li_male_guard_1", "Char_li_male_guard_1_Mk_IKeyes" },
		{
			duration = 3.237,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		13.732, START_MOTION, { "Char_li_male_guard_1" },
		{
			animation = "Sc_MLHEAD_NEUT_BLINK_EYES_000LV_A_00",
			duration = 0.266,
			time_scale = 1,
	...
	{
		14.538, START_SPATIAL_PROP_ANIM, { "Char_J_Mk_IKeyes", "Char_li_male_guard_2" },
		{
			duration = 0.400,
			target_part = "hp_head",
			target_type = HARDPOINT,
	...
	{
		15.264, START_SPATIAL_PROP_ANIM, { "Char_li_male_guard_2_Mk_IKhead", "Char_li_male_guard_2_Mk_IKhead_down" },
		{
			duration = 0.500,
			target_part = "",
			target_type = ROOT,
	...
	{
		15.405, START_MOTION, { "Char_li_male_guard_2" },
		{
	...
	{
		15.600, START_MOTION, { "Char_li_male_guard_2" },
		{
	...
	{
		15.601, START_MOTION, { "Char_li_male_guard_2" },
		{
	...
	{
		15.701, START_SPATIAL_PROP_ANIM, { "Char_li_male_guard_2_Mk_IKhead", "Char_li_male_guard_2_Mk_IKhead_fwd" },
		{
			duration = 0.781,
			target_part = "hp_head",
			target_type = ROOT,
	...
	{
		15.773, START_SPATIAL_PROP_ANIM, { "Char_J_Mk_IKeyes", "Char_Trent" },
		{
			duration = 0.500,
			target_part = "hp_head",
			target_type = HARDPOINT,
			spatialprops =
			{
				pos = { 1.387796, 1.725274, -21.97578 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		15.781, START_MOTION, { "Char_li_male_guard_2" },
		{
			animation = "Sc_MLHEAD_NEUT_BLINK_EYES_000LV_A_00",
			duration = 0.266,
			time_scale = 1,
	...
	{
		15.905, START_MOTION, { "Char_li_male_guard_1" },
		{
			animation = "Sc_MLBODY_STND_WALK_TRNS_000LV_XA_01",
			duration = 1.065,
			trans_time = 0.300,
	...
	{
		16.045, START_SPATIAL_PROP_ANIM, { "Char_li_male_guard_1_Mk_IKeyes", "Char_li_male_guard_2_Mk_IKhead_fwd" },
		{
			duration = 0.400,
			target_part = "hp_head",
			target_type = ROOT,
	...
	{
		16.068, START_MOTION, { "Char_li_male_guard_1" },
		{
			animation = "Sc_MLHEAD_NEUT_BLINK_EYES_000LV_A_00",
			duration = 0.266,
			time_scale = 1,
	...
	{
		16.471, START_MOTION, { "Char_li_male_guard_2" },
		{
			animation = "Sc_MLBODY_WLKG_000LV_XA_01",
			duration = 5.558,
			time_scale = 1,
	...
	{
		16.875, START_CAMERA_PROP_ANIM, { "Cam_02_ACO_Juni_guards", "Cam_02_ACO_Juni_guards_end" },
		{
			duration = 5.000,
			cameraprops =
			{
	...
	{
		16.875, START_SPATIAL_PROP_ANIM, { "Cam_02_ACO_Juni_guards", "Cam_02_ACO_Juni_guards_end" },
		{
			duration = 5.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		16.971, START_MOTION, { "Char_li_male_guard_1" },
		{
			animation = "Sc_MLBODY_WLKG_000LV_XA_01",
			duration = 5.058,
			time_scale = 1,
	...
	{
		26.530, ATTACH_ENTITY, { "Char_li_male_guard_1", "Char_li_male_guard_1_Mk_loc_02_toShip" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		26.530, START_MOTION, { "Char_li_male_guard_1" },
		{
			animation = "Sc_MLBODY_WLKG_000LV_XA_01",
			duration = 5.606,
			time_scale = 1,
	...
	{
		26.530, ATTACH_ENTITY, { "Char_li_male_guard_2", "Char_li_male_guard_2_Mk_loc_02_toShip" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		26.530, START_MOTION, { "Char_li_male_guard_2" },
		{
			animation = "Sc_MLBODY_WLKG_000LV_XA_01",
			duration = 5.625,
			start_time = 0.330,
...

	{
		28.138, START_SPATIAL_PROP_ANIM, { "Cam_05_ACO_Juni_A", "Cam_05_ACO_Juni_B" },
		{
			...
			{
				pos = { 2.816464, 1.680556, -22.14095 },
				q_orient = { -0.961551, 0.017216, -0.274085, -0.017216 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		28.138, SET_CAMERA, { "Cam_Monitor_s011x_static", "Cam_05_ACO_Juni_B" }
	},

	{
		28.138, SET_CAMERA, { "Cam_Monitor_s011x", "Cam_05_ACO_Juni_A" }
	},
	...
	{
		28.780, ATTACH_ENTITY, { "Char_li_male_guard_2", "Char_li_male_guard_2_Mk_loc_03_toShip" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		28.780, ATTACH_ENTITY, { "Char_li_male_guard_1", "Char_li_male_guard_1_Mk_loc_03_toShip" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
...

	{
		30.804, START_SPATIAL_PROP_ANIM, { "Char_J_Mk_IKeyes", "Char_Trent" },
		{
			...
			spatialprops =
			{
				pos = { 1.521929, 1.725249, -21.76031 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		32.153, SET_CAMERA, { "Cam_Monitor_s011x_static", "Cam_06_AC2_Juni_B" }
	},

	{
		32.154, START_MOTION, { "Char_li_male_guard_2" },
		{
			animation = "Sc_MLBODY_WLKG_000LV_XA_01",
			duration = 8.875,
			start_time = 0.043,
	...
	{
		32.154, ATTACH_ENTITY, { "Char_li_male_guard_1", "Char_li_male_guard_1_Mk_loc_04_toShip" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		32.154, ATTACH_ENTITY, { "Char_li_male_guard_2", "Char_li_male_guard_2_Mk_loc_04_toShip" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		32.154, START_MOTION, { "Char_li_male_guard_1" },
		{
			animation = "Sc_MLBODY_WLKG_000LV_XA_01",
			duration = 8.875,
			start_time = 0.700,
	...
	{
		41.029, ATTACH_ENTITY, { "Char_li_male_guard_1", "Mrk_Offscreen" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		41.029, ATTACH_ENTITY, { "Char_li_male_guard_2", "Mrk_Offscreen" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
...

	{
		50.882, START_SPATIAL_PROP_ANIM, { "Cam_09_A_ACO_Juni", "Cam_09_B_ACO_Juni" },
		{
			...
			{
				pos = { 3.163065, 1.497255, -22.33383 },
				q_orient = { -0.950641, -0.012707, -0.310031, 0.012707 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		50.997, START_SPATIAL_PROP_ANIM, { "Char_Juni", "Char_J_Mk_ort_02_leave" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.467612, 0, -0.883934, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		51.589, START_SPATIAL_PROP_ANIM, { "Char_Juni", "Char_J_Mk_ort_03_leave" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.946499, 0, -0.322707, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		53.787, START_SPATIAL_PROP_ANIM, { "Cam_09_A_ACO_Juni", "Cam_09_B_ACO_Juni_2" },
		{
			...
			{
				pos = { 3.163065, 1.497255, -22.33383 },
				q_orient = { -0.916757, -0.028477, -0.398429, 0.028477 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
