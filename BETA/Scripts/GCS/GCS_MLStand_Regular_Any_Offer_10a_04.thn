...
events =
{
	...
	{
		0.456, SET_CAMERA, { "Monitor", "Camera/ACS" }
	},
	...
	{
		1.008, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.059, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.059, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
