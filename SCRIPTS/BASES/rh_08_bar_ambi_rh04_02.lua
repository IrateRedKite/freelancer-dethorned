...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Ku08Bar_rh04_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "ambi_starsphere_Rh04_1",
		type = COMPOUND,
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.091028,  0.000000,  0.995848 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.995848,  0.000000, -0.091028 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Ku08Bar_rh04_02" },
		{
			duration = 0.000,
			fogprops =
			{
