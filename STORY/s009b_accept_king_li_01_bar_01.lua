...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.710333,  0.000000, -0.703865 },
					   {  0.183930,  0.965254,  0.185619 },
					   {  0.679409, -0.261313,  0.685652 } }
		},
		lightprops =
		{
			on = Y,
...

	{
		...
		{
			pos = { -1.234028, 0, 1.377785 },
			orient = { {  0.999213,  0.000000, -0.039665 },
					   {  0.010365,  0.965254,  0.261108 },
					   {  0.038287, -0.261313,  0.964494 } }
		}
	},

	{
		entity_name = "Char_Juni_sfx_fturn_female03",
		type = SOUND,
...
events =
{
	...
	{
		11.383, START_AUDIO_PROP_ANIM, { "Z_dx_s009b_0401_King_10" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		15.406, START_SPATIAL_PROP_ANIM, { "Ambi_LtG02_Direct_Cool_King&Barkeep", "ambi_LtG02_Direct_Cool_MKR_P02" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { -1.234028, 0, 1.377785 },
				q_orient = { 0.999213, 0, -0.039665, 0.010365 }
			}
		}
	},
	...
	{
		19.381, START_SPATIAL_PROP_ANIM, { "Ambi_LtG02_Direct_Cool_King&Barkeep", "ambi_LtG02_Direct_Cool_MKR_P01" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { -1.234028, 0, 1.377785 },
				q_orient = { 0.710333, 0, -0.703865, 0.18393 }
			}
		}
	},
	...
	{
		25.312, START_SPATIAL_PROP_ANIM, { "Ambi_LtG02_Direct_Cool_King&Barkeep", "Ambi_LtG01_Direct_Cool_Juni&Trent" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
...

	{
		25.679, START_SPATIAL_PROP_ANIM, { "Char_Juni_AMrk_Head_MOVEMENT", "Char_Juni_Mrk_LookAtTrent" },
		{
			...
			spatialprops =
			{
				pos = { -2.745691, 1.623085, 1.607124 },
				q_orient = { 0.973925, -0.007358, 0.226752, 0.003495 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		34.492, START_SPATIAL_PROP_ANIM, { "Char_Juni_AMrk_Head_MOVEMENT", "Mrk_King_Head_For_Trent_Nod" },
		{
			...
			{
				pos = { -3.068779, 1.539931, 1.790316 },
				q_orient = { 0.914393, -0.002314, -0.40482, 0.002594 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		37.617, START_SPATIAL_PROP_ANIM, { "Char_Juni_AMrk_Head_MOVEMENT", "Mrk_King_For_Juni_Look" },
		{
			...
			{
				pos = { -1.949698, 1.768635, 0.937733 },
				q_orient = { 0.178771, 0, -0.983891, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		37.742, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mrk_Head_MOVEMENT", "Mrk_Juni_Head_For_Char_Look" },
		{
			...
			{
				pos = { -3.29299, 1.444542, 1.158487 },
				q_orient = { -0.292102, 0, 0.956387, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		41.562, START_SPATIAL_PROP_ANIM, { "Cam_07_Wide_Dolly_juni_Pos", "Cam_07_Wide_Dolly_juni_Orient_1" },
		{
			...
			{
				pos = { -1.49086, 1.72619, 1.839142 },
				q_orient = { -0.706279, -0.059652, 0.705416, 0.059652 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		44.125, START_SPATIAL_PROP_ANIM, { "Ambi_LtG02_Direct_Cool_King&Barkeep", "ambi_LtG02_Direct_Cool_MKR_P01" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
			spatialprops =
			{
				q_orient = { -0.023875, 0.252753, 0.967236, -0.252753 }
			}
		}
	},
...

	{
		45.569, START_SPATIAL_PROP_ANIM, { "Char_Juni_AMrk_Head_MOVEMENT", "Char_Juni_Mrk_LookAtTrent" },
		{
			...
			spatialprops =
			{
				pos = { -2.74767, 1.626353, 1.605716 },
				q_orient = { 0.876936, -0.032028, -0.479539, 0.05291 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		46.631, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mrk_Head_MOVEMENT", "Mrk_Juni_Head_For_Char_Look" },
		{
			...
			spatialprops =
			{
				...
				q_orient = { -0.292142, 0, 0.956375, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		46.937, START_SPATIAL_PROP_ANIM, { "Char_King", "Mrk_KingSnap" },
		{
			...
			{
				pos = { -1.439094, 0, -0.205789 },
				q_orient = { 0.050429, 0, -0.998728, 0 }
			}
		}
	},

	{
		47.375, START_SPATIAL_PROP_ANIM, { "Cam_10_CU_Trent", "Cam_01_OTS_Static_Trent_w_Juni" },
		{
			...
			{
				pos = { -2.616426, 1.5726, 0.411112 },
				q_orient = { 0.59318, 0.024474, -0.804698, -0.024474 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		49.375, START_SOUND, { "Char_Juni_sfx_fturn_female03" },
		{
			duration = 0.266
		}
	},
	...
	{
		49.375, START_AUDIO_PROP_ANIM, { "Char_Juni_fs_fr_hard03" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		50.000, START_SOUND, { "Char_Juni_fs_fr_hard03" },
		{
			duration = 0.243
		}
	},
...

	{
		55.375, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mrk_Head_MOVEMENT", "Char_King" },
		{
			...
			spatialprops =
			{
				pos = { -2.231083, 1.600606, 0.629544 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		55.810, START_AUDIO_PROP_ANIM, { "Char_Juni_sfx_fturn_female02" },
		{
			duration = 0.000,
			audioprops =
			{
...

	{
		58.776, START_SPATIAL_PROP_ANIM, { "Mrk_Juni_Eyes_Absent", "Mrk_Juni_Eyes_Right" },
		{
			...
			spatialprops =
			{
				...
				q_orient = { 0.917157, 0.044831, -0.395997, -0.047985 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		59.242, START_SPATIAL_PROP_ANIM, { "Cam_12_AC2_juni_Trent_Dolly_A_Polish", "Cam_12_AC2_juni_Trent_Dolly_B_Polish" },
		{
			...
			{
				pos = { -2.281415, 1.792476, 2.134002 },
				q_orient = { -0.598427, -0.14937, 0.78713, 0.14937 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		59.242, START_SPATIAL_PROP_ANIM, { "Cam_12_AC2_juni_Trent_Dolly_A", "Cam_12_AC2_juni_Trent_Dolly_B" },
		{
			...
			{
				pos = { -3.488352, 1.643292, 2.72091 },
				q_orient = { 0.992895, 0.015274, -0.11801, -0.015274 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		60.968, START_SOUND, { "Char_Juni_sfx_fturn_female01" },
		{
			duration = 0.787
		}
	},
	...
	{
		68.562, START_SOUND, { "Char_Juni_sfx_fturn_female03_1" },
		{
			duration = 0.266
		}
	},
...

	{
		69.000, START_SPATIAL_PROP_ANIM, { "Cam_13_OTS__juni_w_Trent_ALT_3", "Cam_13_OTS__juni_w_Trent_ALT_3_Pan" },
		{
			...
			{
				pos = { -2.349382, 1.799254, 1.715768 },
				q_orient = { -0.990528, 0.026111, -0.134806, -0.026111 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		72.833, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mrk_Head_MOVEMENT", "Mrk_King_For_Trent_Look_Nod" },
		{
			...
			{
				pos = { -1.949698, 1.473489, 0.937733 },
				q_orient = { -0.936082, 0, 0.351782, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		73.915, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mrk_Head_MOVEMENT", "Mrk_Trent_Head_MOVEMENT_copy_1" },
		{
			...
			{
				pos = { -1.702497, 1.589776, 1.144091 },
				q_orient = { -0.936166, 0, 0.351558, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
