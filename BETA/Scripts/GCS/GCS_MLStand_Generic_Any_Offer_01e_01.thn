...
entities =
{
	...
	{
		entity_name = "VoiceProfile_dx_GCS_F01eG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F01eG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F01eG01_RVP01",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_dx_GCS_F01eG01" },
		{
			duration = 2.898
		}
	},
	...
	{
		1.458, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.150, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
	...
	{
		2.150, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
