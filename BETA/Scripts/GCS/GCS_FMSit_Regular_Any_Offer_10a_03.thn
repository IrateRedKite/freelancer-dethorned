...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F10aR03_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F10aR03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F10aR03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F10aR03_RVP51",
			duration = 2.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_CONV_LHND_CASL_000LV_xb_02",
			duration = 2.166,
			trans_time = 0.700,
			time_scale = 1,
			weight = 1,
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_F10aR03" },
		{
			duration = 1.577
		}
	},
	...
	{
		1.108, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.109, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.179, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.179, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
