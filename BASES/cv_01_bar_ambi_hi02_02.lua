...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_BASE_DSG",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.058824, 0.023529, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.035294, 0.035294, 0.015686 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.717647, 0.47451, 0.235294 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.070588, 0.070588, 0.105882 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.783205, 0.621764 },
					   { 0.000000, -0.621764, -0.783205 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.238523, -0.971137 },
					   { 0.000000, 0.971137, 0.238523 } }
		}
	},

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.080064, 0.32678, -0.947342 },
			orient  =  { { 0.312841, 0.309947, 0.897810 },
					   { -0.898528, -0.209809, 0.385523 },
					   { 0.307861, -0.927315, 0.212859 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.988235, 0.815686, 0.627451 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.066667, 0.109804, 0.082353 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_LtG00_Point_Overhead_D&A",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.614253, 0.000000, -0.789109 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.789109, 0.000000, -0.614253 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Hi02_stars",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_BASE_DSG" },
		{
			duration  =  0.000,
			fogprops  = 
			{
