...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Li02_07.thn",
		type  =  SCENE,
		template_name  =  "",
	...
	{
		entity_name  =  "ambi_starsphere_Li02_1",
		type  =  COMPOUND,
		template_name  =  "starsphere_Li02",
		lt_grp  =  23, srt_grp  =  -99, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
	...
	{
		entity_name  =  "ambi_starsphere_Li02_stars_2",
		type  =  COMPOUND,
		template_name  =  "starsphere_Li02_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Li02_07.thn" },
		{
			duration  =  0.000,
			fogprops  = 
			{
