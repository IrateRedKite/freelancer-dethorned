...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F07aP03_sit",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		1.269, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.269, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.500, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP03" },
		{
			duration = 0.769
		}
	}
