...
events =
{
	...
	{
		1.514, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.565,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.830, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
	...
	{
		1.984, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.015, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.800,
			end_effector = "Eye IK Left",
			count_to_root = 1,
