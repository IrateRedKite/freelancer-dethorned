...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_ku0504",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.891916, -0.291704, -0.345534 },
					   { 0.354793, -0.022341, 0.934678 },
					   { -0.280369, -0.956248, 0.083568 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.654902, 0.415686, 0.305882 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.282353, 0.270588, 0.494118 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.619608, 0.423529, 0.227451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.300519, 0.953776 },
					   { 0.000000, -0.953776, -0.300519 } }
		}
	},
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_ku0504" },
		{
			duration  =  0.000,
			fogprops  = 
			{
