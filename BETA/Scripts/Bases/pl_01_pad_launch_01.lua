...
events =
{
	...
	{
		0.031, START_SOUND, { "PlayerShip_engine_playership" },
		{
			duration = 14.531,
			flags = LOOP
		}
...

	{
		2.029, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_1" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.10035, -0.733244, -0.67252, -0.95586 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		5.560, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_2" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.801002, 0.435475, 0.410801, -0.598063 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		8.031, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_3" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.114791, 0.294016, 0.948882, -0.363061 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		9.843, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_4" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.567664, -0.176622, 0.804091, 0.750416 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
