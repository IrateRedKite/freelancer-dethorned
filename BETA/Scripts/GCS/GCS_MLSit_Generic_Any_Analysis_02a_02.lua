...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 0.959254, 1.313235, 0.157961 },
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A02aG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A02aG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_A02aG02_RVP01",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_A02aG02" },
		{
			duration = 2.242
		}
	},
	...
	{
		1.740, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.741, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
