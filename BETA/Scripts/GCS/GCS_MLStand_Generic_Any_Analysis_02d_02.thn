...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A02dG02_7",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A02dG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_A02dG02_RVP01",
			duration = 2.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_A02dG02_7" },
		{
			duration = 1.592
		}
	},
	...
	{
		0.671, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.090, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.090, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.200, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.889,
			end_effector = "Body_Head",
			count_to_root = 1,
