...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A02cG04_sit",
		type = SCENE,
		template_name = "",
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRB_SHAKHEAD_NO_EMPH_000LV_XA_03",
			duration = 3.400,
			trans_time = 1.000,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_A02cG04" },
		{
			duration = 2.045
		}
	},
	...
	{
		0.882, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.539, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.539, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.733, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.815,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.742, START_MOTION, { "Offer_Character_A" },
		{
