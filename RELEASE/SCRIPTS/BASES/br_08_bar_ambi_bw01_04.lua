...
entities  = 
{
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.32549, 0.329412, 0.52549 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.32549, 0.458824, 0.67451 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.113725, 0.113725, 0.196078 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.54902, 0.607843, 0.666667 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.168627, 0.168627, 0.301961 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.129412, 0.07451, 0.003922 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.900142, 0.000000, -0.435596 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.435596, 0.000000, 0.900142 } }
		},
		userprops  = 
		{
			category  =  "Prop",
