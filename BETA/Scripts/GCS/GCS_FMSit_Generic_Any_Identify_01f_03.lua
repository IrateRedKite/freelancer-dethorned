...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01fG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01fG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01fG03_RVP51",
			duration = 1.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_FM_D01fG03" },
		{
			duration = 1.515
		}
	},
