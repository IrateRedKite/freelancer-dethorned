...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01aN05_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.722413,  0.000000, -0.691462 },
					   { -0.232884,  0.941576, -0.243308 },
					   {  0.651064,  0.336800,  0.680207 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "Mrk_RtHeadIK",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 1.506352, -0.37072 },
			orient = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		}
	},

	{
		entity_name = "VoiceProfile_GCS_ML_D01aN05",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01aN05",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.000, ATTACH_ENTITY, { "Mrk_RtHeadIK", "Offer_Character_A" },
		{
			duration = 2.000,
			offset = { 0, 0.77, 0 },
			up = Y_AXIS,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01aN05_RVP01",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.118, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.180, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.279,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.493, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01aN05" },
		{
			duration = 1.960
		}
	},
	...
	{
		1.078, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLHAND_NEUT_RGHT_000LV_A_00",
			duration = 4.000,
			trans_time = 1.000,
	...
	{
		1.460, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.460, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.833, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_SMALL_000LV_XA_05",
			duration = 4.966,
			trans_time = 0.500,
