...
events =
{
	...
	{
		0.421, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.514, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		1.669, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.750,
			end_effector = "Body_Head",
			count_to_root = 1,
