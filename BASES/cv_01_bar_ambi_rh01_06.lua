...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_rh0106",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { -5000, 0, 0 },
			orient  =  { { 0.929406, -0.063422, 0.363568 },
					   { 0.092088, 0.993816, -0.062046 },
					   { -0.357385, 0.091147, 0.929499 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.325014, 0.922467, 0.208374 },
					   { 0.941796, -0.295692, -0.159955 },
					   { -0.085939, 0.248233, -0.964881 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.690196, 0.607843, 0.415686 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.258824, 0.247059, 0.305882 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0106" },
		{
			duration  =  0.000,
			fogprops  = 
			{
