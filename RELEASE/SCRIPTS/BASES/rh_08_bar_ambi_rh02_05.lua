...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_rh08Bar_rh0205",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.478431, 0.478431, 0.478431 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { -5000, 0, 0 },
			orient = { {  0.955742,  0.000000,  0.294207 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.294207,  0.000000,  0.955742 } }
		}
	},
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { {  0.669777, -0.505224,  0.544194 },
					   { -0.741718, -0.490124,  0.457858 },
					   {  0.035402, -0.710301, -0.703007 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.666667, 0.721569, 0.72549 },
			specular = { 0, 0, 0 },
			ambient = { 0.207843, 0.184314, 0.243137 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { {  0.336936,  0.000000, -0.941528 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.941528,  0.000000,  0.336936 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_rh08Bar_rh0205" },
		{
			duration = 0.000,
			fogprops =
			{
