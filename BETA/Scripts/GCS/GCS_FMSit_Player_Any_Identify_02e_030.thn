...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D02eP03_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.416363, 0.948664, 1.53732 },
			orient = { {  0.960831,  0.000000,  0.277135 },
					   { -0.026170,  0.995531,  0.090733 },
					   { -0.275896, -0.094431,  0.956538 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02eP03",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02eP03_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D02eP03_Trent",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.281, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02eP03" },
		{
			duration = 1.720
		}
	},
	...
	{
		0.531, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.687, SET_CAMERA, { "Monitor_1", "Camera/PC2" }
	},
	...
	{
		1.220, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.220, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.470, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.750,
			end_effector = "Body_Head",
			count_to_root = 1,
