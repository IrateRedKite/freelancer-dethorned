...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01cG02_6",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01cG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01cG02_RVP01",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01cG02_6" },
		{
			duration = 3.078
		}
	},
	...
	{
		1.327, START_MOTION, { "Offer_Character_A" },
		{
