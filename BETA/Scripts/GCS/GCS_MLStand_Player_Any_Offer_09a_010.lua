...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F09aP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F09aP01_5",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_F09aP01_Trent",
			duration = 1.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F09aP01" },
		{
			duration = 0.750
		}
	}
