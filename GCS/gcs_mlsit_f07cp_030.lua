...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F07cP03_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07cP03_sit",
		type = SOUND,
...
events =
{
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07cP03_sit" },
		{
			duration = 2.134
		}
	},
	...
	{
		1.062, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.453, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.930,
			end_effector = "Body_Head",
			count_to_root = 1,
