...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br08Bar_ew0201",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.345098, 0.533333, 0.317647 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.329412, 0.403922, 0.337255 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.772751, -0.634709 },
					   { 0.000000, 0.634709, 0.772751 } }
		}
	},
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.227451, 0.356863, 0.207843 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.427451, 0.619608, 0.435294 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.950230, 0.311549 },
					   { 0.000000, -0.311549, 0.950230 } }
		}
	},

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.392157, 0.54902, 0.282353 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.309804, 0.376471, 0.317647 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.892382, -0.451281 },
					   { 0.000000, 0.451281, 0.892382 } }
		}
	},
...
events  = 
{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br08Bar_ew0201" },
		{
			duration  =  0.000,
			fogprops  = 
			{
