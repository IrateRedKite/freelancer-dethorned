...
entities =
{
	...
	{
		entity_name = "Layer_GCS_W01cG08_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01cG08_9",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01cG08",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG08_RVP01",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_W01cG08_9" },
		{
			duration = 2.052
		}
	},
	...
	{
		0.764, START_MOTION, { "Offer_Character_A" },
		{
