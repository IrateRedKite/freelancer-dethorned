...
entities  = 
{
	...
	{
		entity_name  =  "Character_trent_fs_ml_steel01_1",
		type  =  SOUND,
	...
	{
		entity_name  =  "Character_trent_fs_mr_steel01_2",
		type  =  SOUND,
	...
	{
		entity_name  =  "Character_trent_fs_ml_steel02_3",
		type  =  SOUND,
	...
	{
		entity_name  =  "Character_trent_sfx_fstop_steel_male01_4",
		type  =  SOUND,
...
events  = 
{
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera_Enter", "Cam_Mk_Orient" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.293374, 0.042508, -0.955052, -0.030631 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		0.312, START_SOUND, { "Character_trent_fs_ml_steel01_1" },
		{
			duration  =  0.708
		}
	},
	...
	{
		1.000, START_SOUND, { "Character_trent_fs_mr_steel01_2" },
		{
			duration  =  0.731
		}
	},
	...
	{
		1.687, START_SOUND, { "Character_trent_fs_ml_steel02_3" },
		{
			duration  =  0.742
		}
	},
	...
	{
		2.187, START_SOUND, { "Character_trent_sfx_fstop_steel_male01_4" },
		{
			duration  =  0.173
		}
	},
