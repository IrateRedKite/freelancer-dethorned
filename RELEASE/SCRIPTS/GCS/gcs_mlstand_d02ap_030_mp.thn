...
events =
{
	...
	{
		0.437, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		0.546, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.564,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.592, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 0.500,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.592, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 0.500,
			target_part = "",
			target_type = ROOT,
	...
	{
		4294967.000, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 0.987223, 0, -0.501587 },
				q_orient = { -0.382697, 0, 0.923874, 0 }
			}
		}
	},

	{
		4294967.000, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 0, 0, 0 },
				q_orient = { -0.386436, 0, 0.922316, 0 }
			}
		}
	}
};
