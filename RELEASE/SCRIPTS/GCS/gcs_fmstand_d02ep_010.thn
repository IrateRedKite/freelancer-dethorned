...
entities =
{
...

	{
		...
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02eP01_4",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.468, SET_CAMERA, { "Monitor_1", "Camera/PC2" }
	},
	...
	{
		1.500, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.649,
			end_effector = "Body_Head",
			count_to_root = 1,
