...
entities =
{
	...
	{
		entity_name = "Layer_Rh_08_Bar_ambi_int_Bw03",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "set_starsphere_Bw03",
		type = COMPOUND,
		template_name = "starsphere_Bw03",
		lt_grp = 0, srt_grp = -10, usr_flg = 1,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { {  0.265550,  0.000000,  0.964097 },
					   { -0.738217,  0.643188,  0.203334 },
					   { -0.620096, -0.765708,  0.170799 } }
		},
		userprops =
		{
			category = "Prop",
