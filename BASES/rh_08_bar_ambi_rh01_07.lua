...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Cv01Bar_rh0107",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.129412, 0.137255, 0.180392 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { -30000, 0, 0 },
			orient = { {  0.664253,  0.021554,  0.747197 },
					   { -0.015620,  0.999766, -0.014954 },
					   { -0.747345, -0.001737,  0.664434 } }
		}
	},
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { { -0.381442,  0.254512, -0.888665 },
					   {  0.768984,  0.620872, -0.152254 },
					   {  0.512997, -0.741446, -0.432543 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.447059, 0.521569, 0.427451 },
			specular = { 0, 0, 0 },
			ambient = { 0.25098, 0.211765, 0.305882 },
			direction = { 0, 0, 1 },
			range = 100000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.699721,  0.000000, -0.714417 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.714417,  0.000000, -0.699721 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0107" },
		{
			duration = 0.000,
			fogprops =
			{
