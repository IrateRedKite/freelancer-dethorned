...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D05aP02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D05aP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D05aP02_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.370, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.370, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D05aP02" },
		{
			duration = 0.870
		}
	},
	...
	{
		0.768, START_MOTION, { "Player_Character_P" },
		{
