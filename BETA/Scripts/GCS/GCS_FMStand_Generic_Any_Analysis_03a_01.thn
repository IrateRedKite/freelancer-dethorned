...
entities =
{
	...
	{
		entity_name = "VoiceProfile_$BGCS_Faction_Rebuff_FM",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Faction_Rebuff_FM",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_$BGCS_Faction_Rebuff_FM" },
		{
			duration = 1.373
		}
	},
	...
	{
		0.879, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.879, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
