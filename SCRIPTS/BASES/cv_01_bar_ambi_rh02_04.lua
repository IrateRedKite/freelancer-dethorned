...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_rh0204",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.345098, 0.345098, 0.345098 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { -5000, 0, 0 },
			orient  =  { { 0.024423, -0.001104, 0.999701 },
					   { 0.045147, 0.998980, 0.000000 },
					   { -0.998682, 0.045133, 0.024448 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.778612, 0.423982, -0.462604 },
					   { -0.283566, 0.895377, 0.343350 },
					   { 0.559780, -0.136158, 0.817379 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.435294, 0.560784, 0.635294 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.34902, 0.215686, 0.082353 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.847850, 0.497779, -0.182665 },
					   { 0.506298, 0.862359, 0.000000 },
					   { 0.157523, -0.092483, -0.983175 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0204" },
		{
			duration  =  0.000,
			fogprops  = 
			{
