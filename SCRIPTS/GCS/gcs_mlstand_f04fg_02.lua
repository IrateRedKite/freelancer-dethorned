...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F04fG02_31",
		type = SOUND,
...
events =
{
	...
	{
		0.218, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F04fG02_31" },
		{
			duration = 4.560
		}
	},
	...
	{
		0.500, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			duration = 3.500,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 1.265135, 1.642393, -0.163832 },
				q_orient = { 0.05412, 0, -0.998534, -0.091915 }
			}
		}
	},

	{
		1.562, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.812, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		4.014, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
	...
	{
		4.046, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			trans_time = 0.800,
	...
	{
		4.059, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.059, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
