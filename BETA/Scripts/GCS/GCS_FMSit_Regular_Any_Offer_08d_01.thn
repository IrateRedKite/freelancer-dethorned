...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F08dR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F08dR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F08dR01_RVP51",
			duration = 5.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.093, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F08dR01" },
		{
			duration = 4.734
		}
	},
	...
	{
		3.155, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.073,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		4.218, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		4.230, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.230, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
