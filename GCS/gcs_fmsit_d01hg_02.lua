...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01hG02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.497244, 1.960824, 0.836266 },
			orient = { {  0.683872,  0.000000, -0.729602 },
					   { -0.272811,  0.927462, -0.255712 },
					   {  0.676678,  0.373918,  0.634265 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01hG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01hG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01hG02_RVP51",
			duration = 2.332,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.609, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_FM_D01hG02" },
		{
			duration = 1.717
		}
	},
	...
	{
		1.299, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.470, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.470, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.500, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.220,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.968, START_MOTION, { "Offer_Character_A" },
		{
