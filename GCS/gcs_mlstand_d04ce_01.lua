...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D04cE01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D04cE01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D04cE01_RVP01",
			duration = 5.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D04cE01" },
		{
			duration = 5.184
		}
	},
	...
	{
		1.702, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		4.644, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		4.717, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.962,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		4.764, START_MOTION, { "Player_Character_P" },
		{
