...
entities  = 
{
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.462745, 0.533333, 0.694118 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.770050, 0.101674, -0.629830 },
					   { -0.130899, 0.991396, 0.000000 },
					   { 0.624411, 0.082444, 0.776733 } }
		}
	},
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.994031, 0.069594, 0.084017 },
					   { -0.066822, 0.997138, -0.035363 },
					   { -0.086237, 0.029538, 0.995837 } }
		},
		userprops  = 
		{
			category  =  "Prop",
