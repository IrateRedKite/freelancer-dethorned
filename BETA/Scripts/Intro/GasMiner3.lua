...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 7784.271, 609.7586, -4256.971 },
...

	{
		0.000, START_PSYS_PROP_ANIM, { "FX_gf_li_smallengine02_fire_1" },
		{
			...
			param_curve =
			{
				...
				points =
				{
					{  0.000000,  0.900641,  0.000000,  0.000000 },
					{  1.000000,  0.903846,  0.041667,  0.000000 },
				}
			},
			pcurve_period = -1000
		}
...

	{
		0.000, START_PSYS_PROP_ANIM, { "FX_gf_br_transport2_engine01_fire_1" },
		{
			...
			param_curve =
			{
				...
				{
					{  0.000000,  0.903846,  0.000000,  0.000000 },
					{  1.000000,  0.903846,  0.000000,  0.000000 },
				}
			},
			pcurve_period = -1000
		}
