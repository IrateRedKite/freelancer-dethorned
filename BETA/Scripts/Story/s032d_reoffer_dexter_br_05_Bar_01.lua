...
{
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_sfx_fturn_male04_4", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_T_Mrk_loc_StartWk", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_T_Mrk_ort_01", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_T_Mrk_ort_02", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_T_Mrk_ort_03", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_fs_ml_steel02_7", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_fs_ml_steel03_2", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_fs_ml_steel04_5", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_fs_mr_steel01_1", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_fs_mr_steel03_6", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_sfx_fstop_steel_male01_8", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Trent_sfx_fstop_steel_male02_3", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "dx_s032d_0101_dexter_6", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "dx_s032d_0102_dexter_7", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "dx_s032d_0201_Trent_8", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "dx_s032d_0301_dexter_9", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "sfx_ambience_bar_space_3", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "sfx_backgroundambient_5", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "sfx_backgroundmusic_6", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_d_01a_wide", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_d_01a_wide_static_mon", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_d_01b_PC2", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_d_01c_PCS", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_d_02_ACO", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_IKelbow", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_IKeyes_OrGetOff", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_IKfingers", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_IKhand", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_IKhead", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_IKhead_Fwd", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_loc_Fidget", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_loc_fix", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_D_Mrk_ort_01", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_fs_ml_steel02_11", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_fs_ml_steel03_13", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_fs_ml_steel04_14", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_fs_mr_steel01_10", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_fs_mr_steel04_15", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_sfx_fstop_steel_male02_7", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_sfx_fturn_male03_12", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Char_Dexter_sfx_fturn_male03_9", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
...

	{
		0.515, START_SPATIAL_PROP_ANIM, { "Char_D_Mrk_IKeyes", "Char_Trent" },
		{
			...
			spatialprops =
			{
				pos = { -5.203763, 1.701954, 4.835869 }
			},
			param_curve =
			{
...

	{
		0.842, START_SPATIAL_PROP_ANIM, { "Char_D_Mrk_IKhead", "Char_Trent" },
		{
			...
			spatialprops =
			{
				pos = { -5.391123, 1.696416, 4.724769 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		1.218, START_SPATIAL_PROP_ANIM, { "Cam_d_01a_wide", "Cam_d_01b_PC2" },
		{
			...
			spatialprops =
			{
				pos = { -6.527809, 1.786189, 2.233043 },
				q_orient = { -0.959869, 0, 0.280449, 0.057713 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		4.468, START_SPATIAL_PROP_ANIM, { "Char_D_Mrk_IKhead", "Char_D_Mrk_IKhead_Fwd" },
		{
			...
			spatialprops =
			{
				pos = { -5.965725, 1.672928, 3.957054 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		6.499, START_SPATIAL_PROP_ANIM, { "Char_Dexter", "Char_D_Mrk_ort_01" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.754475, 0, 0.656329, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		7.936, START_SPATIAL_PROP_ANIM, { "Char_Trent", "Char_T_Mrk_ort_01" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.689384, 0, -0.724396, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		8.000, START_SPATIAL_PROP_ANIM, { "Char_Dexter", "Char_D_Mrk_loc_fix" },
		{
			...
			spatialprops =
			{
				pos = { -5.925689, 0.971418, 1.954812 },
				q_orient = { 0.985006, 0, 0.172519, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		8.156, START_SPATIAL_PROP_ANIM, { "Cam_d_01a_wide", "Cam_d_01c_PCS" },
		{
			...
			spatialprops =
			{
				pos = { -6.610587, 1.702883, 2.467936 },
				q_orient = { -0.873284, 0, 0.487211, 0.065227 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		9.093, START_SPATIAL_PROP_ANIM, { "Char_Trent", "Char_T_Mrk_ort_03" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.987255, 0, 0.159147, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		9.810, START_SPATIAL_PROP_ANIM, { "Char_Trent", "Char_T_Mrk_loc_EndPartA" },
		{
			...
			spatialprops =
			{
				pos = { -6.190544, 0.972861, 3.714564 },
				q_orient = { 0.96942, 0, 0.245409, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		10.453, START_SPATIAL_PROP_ANIM, { "Char_D_Mrk_IKeyes", "Char_D_Mrk_IKeyes_Left" },
		{
			...
			spatialprops =
			{
				pos = { -6.383759, 1.671893, 0.966658 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		11.143, START_SPATIAL_PROP_ANIM, { "Char_D_Mrk_IKeyes", "Char_Trent" },
		{
			...
			spatialprops =
			{
				pos = { -6.189197, 1.725708, 3.758261 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		12.328, START_SPATIAL_PROP_ANIM, { "Char_Dexter", "Char_D_Mrk_loc_EndPartA" },
		{
			...
			spatialprops =
			{
				pos = { -5.989896, 0.972918, 2.221197 },
				q_orient = { -0.999989, 0, 0.004612, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		20.031, ATTACH_ENTITY, { "Char_D_Mrk_IKeyes", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		20.031, ATTACH_ENTITY, { "Char_D_Mrk_IKeyes_Left", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		20.093, ATTACH_ENTITY, { "Char_D_Mrk_IKeyes_Fwd", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		20.093, ATTACH_ENTITY, { "Char_Dexter", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		20.125, ATTACH_ENTITY, { "Char_T_Mrk_IKeyes", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		20.125, ATTACH_ENTITY, { "Char_Trent", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
