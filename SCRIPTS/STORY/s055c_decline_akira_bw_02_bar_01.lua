...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.461134, -0.000001, -0.887330 },
					   { -0.361333,  0.913333,  0.187779 },
					   {  0.810428,  0.407213, -0.421170 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.354279, 1.470297, 3.750282 },
			orient = { { -0.999033,  0.000000, -0.043972 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.043972,  0.000000, -0.999033 } }
		}
...

	{
		...
		spatialprops =
		{
			pos = { 1.668758, 1.800432, 3.392192 },
			orient = { { -0.852759,  0.000000, -0.522304 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.522304,  0.000000, -0.852759 } }
		}
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.999653,  0.000000,  0.026332 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.026332,  0.000000, -0.999653 } }
		}
	},
...

	{
		...
		spatialprops =
		{
			pos = { 1.668758, 0.972935, 3.392192 },
			orient = { { -0.852759,  0.000000, -0.522304 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.522304,  0.000000, -0.852759 } }
		}
...
events =
{
	...
	{
		0.000, SET_CAMERA, { "Cam_Monitor_s055c", "Cam_01_PCO" }
	},
	...
	{
		0.000, SET_CAMERA, { "Cam_Monitor_s055c_static", "Cam_01_PCO" }
	},
	...
	{
		1.179, START_IK, { "Char_juni", "Char_juni_Mk_IKhead_Tr" },
		{
			duration = 2.400,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.179, START_IK, { "Char_juni", "Char_trent" },
		{
			duration = 2.400,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.781, START_IK, { "Char_akira", "Char_Akira_Mk_IKeyes" },
		{
			duration = 5.062,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		3.355, SET_CAMERA, { "Cam_Monitor_s055c_static", "Cam_02_ACO_Akira" }
	},

	{
		3.355, SET_CAMERA, { "Cam_Monitor_s055c", "Cam_02_ACO_Akira" }
	},
	...
	{
		4.765, START_SPATIAL_PROP_ANIM, { "Char_Akira_Mk_IKeyes", "Char_juni" },
		{
			duration = 0.312,
			target_part = "hp_head",
			target_type = HARDPOINT,
			spatialprops =
			{
				pos = { 0.792048, 1.163151, 3.079833 }
			},
			param_curve =
			{
	...
	{
		5.125, START_IK, { "Char_juni", "Char_juni_Mk_IKhead_Tr" },
		{
			duration = 2.000,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		5.125, START_IK, { "Char_juni", "Char_trent" },
		{
			duration = 2.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		6.734, START_SPATIAL_PROP_ANIM, { "Char_Akira_Mk_IKeyes", "Char_trent" },
		{
			duration = 0.500,
			target_part = "hp_head",
			target_type = HARDPOINT,
	...
	{
		7.375, SET_CAMERA, { "Cam_Monitor_s055c_static", "Cam_01_PCO" }
	},

	{
		7.375, SET_CAMERA, { "Cam_Monitor_s055c", "Cam_01_PCO" }
	},

	{
		7.435, START_IK, { "Char_juni", "Char_akira" },
		{
			duration = 1.064,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		10.234, START_IK, { "Char_akira", "Char_trent" },
		{
			duration = 2.296,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		10.579, SET_CAMERA, { "Cam_Monitor_s055c", "Cam_03_ACS_Akira" }
	},

	{
		10.579, SET_CAMERA, { "Cam_Monitor_s055c_static", "Cam_03_ACS_Akira" }
	},
