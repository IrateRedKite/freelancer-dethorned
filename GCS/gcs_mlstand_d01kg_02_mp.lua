...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01kG02_12",
		type = SOUND,
...
events =
{
...

	{
		...
		{
			animation = "Sc_MLBODY_STND_POINT_RHND_000LV_A_03",
			duration = 3.266,
			trans_time = 0.500,
			time_scale = 0.5,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01kG02_12" },
		{
			duration = 1.389
		}
	},
	...
	{
		1.330, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.330, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
