...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 140.6418, -190.9059, 1365.295 },
...
events  = 
{
	...
	{
		0.001, START_SOUND, { "Ship_b_e_engine_br_small_1" },
		{
			duration  =  14.000,
			flags  =  LOOP
		}
	...
	{
		0.001, START_SOUND, { "Ship_civ_fr_engine_nd_small_1" },
		{
			duration  =  10.781,
			flags  =  LOOP
		}
	...
	{
		0.001, START_SOUND, { "Ship_civ_fi_engine_nd_small_1" },
		{
			duration  =  11.093,
			flags  =  LOOP
		}
...

	{
		12.031, START_SPATIAL_PROP_ANIM, { "Ship_b_elite_2", "Mk_Dyn_3" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.69316, -0.339343, 0.635906, -0.340748 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		15.156, START_SPATIAL_PROP_ANIM, { "Ship_b_elite_2", "Mk_Dyn_4" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.996975, -0.041146, 0.065942, -0.0484 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		16.718, START_SPATIAL_PROP_ANIM, { "Ship_b_fighter_2", "Mk_Dyn_5" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.708877, -0.423717, -0.563877, -0.310553 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		26.242, START_SPATIAL_PROP_ANIM, { "Ship_b_fighter_2", "Mk_Dyn_1_reverse" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.923491, -0.282088, 0.259982, 0.372683 }
			}
		}
	},
...

	{
		28.749, START_SPATIAL_PROP_ANIM, { "Ship_b_elite_1", "Mk_Dyn_2_reverse" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.062506, -0.245532, -0.967371, -0.921052 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		30.805, START_SPATIAL_PROP_ANIM, { "Ship_b_fighter_2", "Mk_Dyn_3_reverse" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.493038, 0.447528, -0.746078, -0.728953 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		32.403, START_SPATIAL_PROP_ANIM, { "Ship_b_fighter_2", "Mk_Dyn_4_reverse" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.769637, -0.375417, -0.51645, -0.516375 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		34.597, START_SPATIAL_PROP_ANIM, { "Ship_b_fighter_2", "Mk_Dyn_5_reverse" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.839823, -0.155781, -0.520028, 0.107949 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		41.299, START_SPATIAL_PROP_ANIM, { "Mk_b_elite_2_BANK", "Mk_b_elite_2_BANK_2" },
		{
			...
			{
				pos  =  { -26.11552, 61.37345, 156.0184 },
				q_orient  =  { 0.541481, -0.434827, -0.71953, -0.759149 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		46.396, START_SPATIAL_PROP_ANIM, { "Mk_Pr_Smooth_straight_to_LEFT", "Mk_Pr_Smooth_straight_to_LEFT_end" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.927972, 0, -0.372651, 0 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
