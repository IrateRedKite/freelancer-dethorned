...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D05bP02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D05bP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D05bP02_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D05bP02_Trent",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.453, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D05bP02" },
		{
			duration = 2.328
		}
	},
	...
	{
		1.830, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.830, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.000, START_MOTION, { "Player_Character_P" },
		{
