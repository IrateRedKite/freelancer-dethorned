...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.999998, 0.000000, 0.001983 },
					   { -0.000856, 0.902131, 0.431460 },
					   { -0.001789, -0.431461, 0.902130 } }
		},
		cameraprops  = 
		{
			fovh  =  24,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -0.428947, 0.106186, -18.31691 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		0.000, ATTACH_ENTITY, { "engine_playership_start_snd", "PlayerShip_3" },
		{
			duration  =  1.200,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "engine_playership_rumble_snd", "PlayerShip_3" },
		{
			duration  =  13.154,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "engine_playership_launch_turbine_snd", "PlayerShip_3" },
		{
			duration  =  10.000,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.280, ATTACH_ENTITY, { "engine_playership_launch_rumble_snd", "PlayerShip_3" },
		{
			duration  =  8.918,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
...

	{
		0.906, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_01", "Camera_ShipLaunch_02" },
		{
			...
			{
				pos  =  { 13.14801, 15.97181, 60.72657 },
				q_orient  =  { 0.913243, 0.101785, 0.394496, -0.101785 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		1.343, START_SPATIAL_PROP_ANIM, { "PlayerShip_3", "Marker_Orient_1" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.384618, 0.126034, -0.914431, -0.028646 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		4.125, START_SPATIAL_PROP_ANIM, { "PlayerShip_3", "Marker_Orient_2" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.004983, 0.167727, -0.985821, -0.119555 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		4.144, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			...
			spatialprops  = 
			{
				...
				q_orient  =  { 0.551346, 0, -0.834277, 0 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		4.967, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_01", "Camera_ShipLaunch_03" },
		{
			...
			{
				pos  =  { -33.63758, 42.45762, 227.4406 },
				q_orient  =  { 0.999991, -0.001712, -0.003966, 0.001712 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		6.281, START_SOUND, { "engine_playership_launch04_snd" },
		{
			duration  =  8.210
		}
	},
	...
	{
		6.281, ATTACH_ENTITY, { "engine_playership_launch04_snd", "PlayerShip_3" },
		{
			duration  =  6.401,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		6.281, START_AUDIO_PROP_ANIM, { "engine_playership_launch04_snd" },
		{
			duration  =  0.400,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.596154, 0.804487, 1.076923, 1.230769 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
...

	{
		6.593, START_SPATIAL_PROP_ANIM, { "PlayerShip_3", "Marker_Orient_3" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.262743, 0.202783, -0.943316, 0.197799 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		8.343, START_AUDIO_PROP_ANIM, { "engine_playership_launch_turbine_snd" },
		{
			duration  =  1.656,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.801282, 0.413462, 1.272727, 0.941176 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		10.000, START_SOUND, { "engine_playership_3" },
		{
			duration  =  3.154,
			flags  =  LOOP
		}
	...
	{
		10.000, START_AUDIO_PROP_ANIM, { "engine_playership_3" },
		{
			duration  =  1.000,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.698718, 0.519231, 1.307692, 1.384615 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		10.000, ATTACH_ENTITY, { "engine_playership_3", "PlayerShip_3" },
		{
			duration  =  3.154,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		11.218, START_AUDIO_PROP_ANIM, { "engine_playership_launch04_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
	...
	{
		12.093, START_AUDIO_PROP_ANIM, { "engine_playership_3" },
		{
			duration  =  1.060,
			audioprops  = 
			{
	...
	{
		12.093, START_AUDIO_PROP_ANIM, { "engine_playership_rumble_snd" },
		{
			duration  =  1.059,
			audioprops  = 
			{
