...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br_05_bar_Br02_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.518007, 0.011728, -0.855296 },
					   { 0.460396, 0.846537, -0.267229 },
					   { 0.720906, -0.532201, -0.443911 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.960784, 0.956863, 0.945098 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.329412, 0.309804, 0.501961 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br_05_bar_Br02_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
