...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03cR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03cR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F03cR01_RVP01",
			duration = 4.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03cR01" },
		{
			duration = 3.717
		}
	},
...

	{
		...
		{
			animation = "Sc_MLHAND_HNEUT_BATON_RGHT_000LV_00",
			duration = 5.666,
			trans_time = 0.500,
			time_scale = 0.5,
			weight = 1,
	...
	{
		3.171, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.049,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.220, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.220, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
