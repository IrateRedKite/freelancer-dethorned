...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_A02cG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_A02cG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_A02cG03_RVP51",
			duration = 3.664,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.000, START_FLR_HEIGHT_ANIM, { "Offer_Character_A", "Marker_HalfApple" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.000, ATTACH_ENTITY, { "Marker_HalfApple", "Special/A" },
		{
			duration = 0.000,
			offset = { 0, 0.08, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Offer_Character_A", "Marker_HalfApple" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_A02cG03" },
		{
			duration = 2.867
		}
	},
	...
	{
		0.828, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.890, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 2.679,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.828, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.069, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.401,
	...
	{
		2.312, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.158,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.470, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.470, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.588, START_MOTION, { "Offer_Character_A" },
		{
