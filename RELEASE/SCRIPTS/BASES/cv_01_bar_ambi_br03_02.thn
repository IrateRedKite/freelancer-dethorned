...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Br03_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.301961, 0.392157, 0.533333 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.964262, -0.237095, 0.118258 },
					   { 0.264802, 0.847428, -0.460158 },
					   { 0.008885, 0.475027, 0.879926 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.623529, 0.615686, 0.67451 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.341176, 0.305882, 0.447059 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.234415, 0.000000, -0.972137 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.972137, 0.000000, 0.234415 } }
		}
	},
	...
	{
		entity_name  =  "ambi_starsphere_Br03_1",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br03",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.305119, 0.010298, -0.952258 },
					   { -0.033730, 0.999431, 0.000000 },
					   { 0.951717, 0.032120, 0.305293 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Br03_stars_2",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br03_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Br03_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
