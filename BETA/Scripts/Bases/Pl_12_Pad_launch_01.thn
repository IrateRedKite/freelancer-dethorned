...
events =
{
...

	{
		0.187, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Mk_Chase_Marker" },
		{
			...
			spatialprops =
			{
				pos = { -316.5984, 165.7645, -436.3403 },
				q_orient = { -0.602227, -0.05366, -0.79652, -0.07259 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		0.187, START_SPATIAL_PROP_ANIM, { "Mk_Chase_Marker", "Mk_Second_Landing_Pad_Ascent_Mk" },
		{
			...
			{
				pos = { -76.62335, 134.6553, -41.14341 },
				q_orient = { -0.928639, -0.004153, 0.370961, 0.021972 }
			}
		}
	},
	...
	{
		2.218, START_SPATIAL_PROP_ANIM, { "Prop_PlayerShip_Shipcushion_Marker_A" },
		{
			duration = 3.000,
			target_type = ROOT,
			spatialprops =
			{
				pos = { -73.3651, -4, -39.1164 }
			}
		}
	},
