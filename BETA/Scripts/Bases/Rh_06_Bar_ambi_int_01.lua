...
entities =
{
	...
	{
		entity_name = "Layer_Rh_06_Commons_Ambi",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -1.945006, 1.465601, 3.299608 },
...

	{
		...
		spatialprops =
		{
			pos = { 0.101754, 1.210388, 3.846868 },
...

	{
		...
		spatialprops =
		{
			pos = { 0.140427, 1.660563, 7.430647 },
			orient = { {  0.666212,  0.000000, -0.745762 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.745762,  0.000000,  0.666212 } }
		},
...

	{
		...
		spatialprops =
		{
			pos = { -4.055615, 2.523631, 8.845632 },
			orient = { {  0.666212,  0.000000, -0.745762 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.745762,  0.000000,  0.666212 } }
		},
		lightprops =
		{
			on = Y,
			color = { 119, 226, 249 },
			diffuse = { 0.466667, 0.886275, 0.976471 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 16,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 111, 181, 215 },
			diffuse = { 0.435294, 0.709804, 0.843137 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 221, 174, 200 },
			diffuse = { 0.866667, 0.682353, 0.784314 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.686275, 0.247059, 0.501961 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 4,
...

	{
		...
		spatialprops =
		{
			pos = { -4.689286, 1.605455, 2.328094 },
			orient = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		lightprops =
		{
...

	{
		...
		spatialprops =
		{
			pos = { -13.87673, 0.995623, -15.48027 },
			orient = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.592157, 0.839216, 0.858824 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.592157, 0.729412, 0.858824 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.721569, 0.721569, 0.721569 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.403922, 0.47451, 0.701961 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 4,
...

	{
		...
		spatialprops =
		{
			pos = { -1.852827, 1.191704, 7.907092 },
			orient = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		lightprops =
		{
