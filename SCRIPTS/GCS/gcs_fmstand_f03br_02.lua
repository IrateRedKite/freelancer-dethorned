...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03bR_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F03bR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F03bR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03bR02_RVP51",
			duration = 4.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F03bR02" },
		{
			duration = 3.763
		}
	},
	...
	{
		1.253, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.717, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
			end_effector = "Eye IK Left",
			count_to_root = 1,
