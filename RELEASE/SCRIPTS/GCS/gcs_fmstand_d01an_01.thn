...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01aN01_4",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01aN01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_FMBODY_STND_GESTR_COME_000LV_XA_03",
			duration = 3.266,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01aN01_RVP51",
			duration = 2.165,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01aN01_4" },
		{
			duration = 1.549
		}
	},
