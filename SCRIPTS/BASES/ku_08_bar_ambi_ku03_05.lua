...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.435825, 0.000828, -0.900031 },
					   { -0.010129, 0.999932, 0.005825 },
					   { 0.899974, 0.011655, -0.435787 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.141176, 0.419608, 0.443137 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.360784, 0.247059, 0.505882 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.751559, -0.659665 },
					   { 0.000000, 0.659665, -0.751559 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.885450, 0.464735 },
					   { 0.000000, -0.464735, 0.885450 } }
		}
	},

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.392157, 0.67451, 0.709804 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.360784, 0.247059, 0.505882 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
	...
	{
		entity_name  =  "ambi_starsphere_Ku03_7",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ku03",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.956025, 0.254906, -0.145052 },
					   { -0.261670, 0.964712, -0.029319 },
					   { 0.132459, 0.065985, 0.988990 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Ku03_stars_8",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ku03_stars",
