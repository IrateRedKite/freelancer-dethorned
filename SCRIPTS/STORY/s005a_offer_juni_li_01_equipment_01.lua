...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 0.641594, 1.573095, -2.744086 },
	...
	{
		entity_name = "ambi_LtG09_Inf_Fill",
		type = LIGHT,
		template_name = "",
	...
	{
		entity_name = "ambi_LtG09_Inf_Key",
		type = LIGHT,
		template_name = "",
		lt_grp = 1, srt_grp = 0, usr_flg = 0,
		flags = REFERENCE,
	...
	{
		entity_name = "snd_sfx_ship_levitation_4",
		type = SOUND,
		template_name = "ship_levitation",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = SPATIAL,
	...
	{
		entity_name = "ambi_LtG00_Spcl_Edger",
		type = LIGHT,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { -17.98355, 0, 2.501 },
			orient = { { -0.980419,  0.000000, -0.196924 },
					   { -0.086586,  0.898148,  0.431084 },
					   {  0.176867,  0.439693, -0.880561 } }
		},
		lightprops =
		{
			on = Y,
	...
	{
		entity_name = "snd_music_anticipation_light_2",
		type = SOUND,
...
{
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_3" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, START_LIGHT_PROP_ANIM, { "ambi_LtG09_Inf_Key" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		0.000, START_LIGHT_PROP_ANIM, { "ambi_LtG09_Inf_Fill" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_sfx_ship_levitation_6" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_SFX_ship_levitation_4" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_music_anticipation_light_2" },
		{
			duration = 0.500,
			audioprops =
			{
	...
	{
		0.000, START_SOUND, { "snd_sfx_ship_levitation_4" },
		{
			duration = 600.000,
			flags = LOOP
		}
	...
	{
		0.000, ATTACH_ENTITY, { "snd_sfx_ship_levitation_4", "X/Shipcentre/01" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_5" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_4" },
		{
			duration = 0.000,
			audioprops =
			{
	...
	{
		0.001, START_SOUND, { "snd_music_anticipation_light_2" },
		{
			duration = 45.000,
			start_time = 2000
		}
...

	{
		0.312, START_SPATIAL_PROP_ANIM, { "Cam_A_Wide_Path_UpAndDown", "Cam_A_Wide_Crane_Trent_2" },
		{
			...
			{
				pos = { -0.739504, 6.279871, -22.36119 },
				q_orient = { 0.084628, 0.037772, -0.995696, -0.037772 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		0.500, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 9.140,
			audioprops =
			{
	...
	{
		0.500, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_4" },
		{
			duration = 9.140,
			audioprops =
			{
	...
	{
		0.518, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_3" },
		{
			duration = 9.140,
			audioprops =
			{
	...
	{
		9.640, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_4" },
		{
			duration = 1.500,
			audioprops =
			{
	...
	{
		9.656, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 1.500,
			audioprops =
			{
	...
	{
		9.656, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_3" },
		{
			duration = 1.500,
			audioprops =
			{
	...
	{
		9.657, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_5" },
		{
			duration = 1.500,
			audioprops =
			{
...

	{
		11.046, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Right" },
		{
			...
			spatialprops =
			{
				pos = { -13.90897, 1.463837, -2.626177 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		11.093, START_AUDIO_PROP_ANIM, { "snd_music_anticipation_light_2" },
		{
			duration = 3.000,
			audioprops =
			{
...

	{
		11.298, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Inf_Fill" },
		{
			...
			lightprops =
			{
				diffuse = { 0.529412, 0.490196, 0.411765 },
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		11.298, START_LIGHT_PROP_ANIM, { "ambi_LtG09_Inf_Fill" },
		{
			duration = 0.250,
			lightprops =
			{
...

	{
		11.671, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Up" },
		{
			...
			spatialprops =
			{
				pos = { -13.90399, 2.315869, -1.652036 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		11.798, START_LIGHT_PROP_ANIM, { "ambi_LtG09_Inf_Key" },
		{
			duration = 0.250,
			lightprops =
			{
	...
	{
		12.399, START_LIGHT_PROP_ANIM, { "ambi_LtG09_Inf_Key" },
		{
			duration = 0.100,
			lightprops =
			{
	...
	{
		13.281, START_AUDIO_PROP_ANIM, { "rtc_music_friendly_encouragement_1" },
		{
			duration = 3.000,
			audioprops =
			{
	...
	{
		14.493, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 5.000,
			audioprops =
			{
	...
	{
		14.493, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_3" },
		{
			duration = 5.000,
			audioprops =
			{
	...
	{
		15.156, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Spcl_Edger" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		15.468, SET_CAMERA, { "Cam_Monitor_s005a_static", "Cam_D_LowWide_static_mon_01" }
	},

	{
		15.468, SET_CAMERA, { "Cam_Monitor_s005a", "Cam_D_LowWide_Move" }
	},

	{
		15.493, START_AUDIO_PROP_ANIM, { "snd_sfx_ship_levitation_4" },
		{
			duration = 0.405,
			audioprops =
			{
	...
	{
		20.156, START_AUDIO_PROP_ANIM, { "rtc_music_friendly_encouragement_1" },
		{
			duration = 6.717,
			audioprops =
			{
...

	{
		30.836, START_SPATIAL_PROP_ANIM, { "Char_trent", "Char_Trent_Mk_ort_Shot_D" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.990892, 0, 0.134656, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		37.275, START_AUDIO_PROP_ANIM, { "snd_sfx_ship_levitation_4" },
		{
			duration = 1.000,
			audioprops =
			{
...

	{
		37.462, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Right" },
		{
			...
			spatialprops =
			{
				pos = { 4.866992, 3.464826, 0.565032 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		37.677, START_SPATIAL_PROP_ANIM, { "Cam_E_Mdm2_1", "Cam_E_Mdm2_2" },
		{
			...
			{
				pos = { 3.994329, 1.936401, -2.375645 },
				q_orient = { -0.864575, -0.119446, 0.488101, 0.119446 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		38.428, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_trent" },
		{
			...
			spatialprops =
			{
				pos = { 2.175495, 1.717638, -2.569717 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		39.241, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Up" },
		{
			...
			spatialprops =
			{
				pos = { 4.127355, 2.830239, 0.755349 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		41.452, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKhead" },
		{
			duration = 1.000,
			target_type = ROOT,
			spatialprops =
			...
			param_curve =
			{
				...
				{
					{  0.000000,  0.000000,  0.000000,  0.000000 },
					{  1.000000,  0.772436,  0.409091,  0.000000 },
				}
			},
			pcurve_period = -1000
		}
...

	{
		48.481, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_Juni_Mk_IKeyes_Down" },
		{
			...
			spatialprops =
			{
				pos = { 4.065879, 1.590797, -0.950598 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		49.614, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKhead_Follow", "Char_Juni_Mk_IKhead_Trent" },
		{
			...
			spatialprops =
			{
				pos = { 2.150227, 1.725651, -2.710677 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		50.000, START_AUDIO_PROP_ANIM, { "rtc_music_friendly_encouragement_1" },
		{
			duration = 2.000,
			audioprops =
			{
	...
	{
		50.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_4" },
		{
			duration = 2.000,
			audioprops =
			{
	...
	{
		50.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_5" },
		{
			duration = 2.000,
			audioprops =
			{
	...
	{
		51.000, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_2" },
		{
			duration = 1.000,
			audioprops =
			{
	...
	{
		51.000, START_AUDIO_PROP_ANIM, { "snd_SFX_ship_levitation_4" },
		{
			duration = 1.000,
			audioprops =
			{
	...
	{
		51.000, START_AUDIO_PROP_ANIM, { "snd_backgroundambient_1" },
		{
			duration = 1.000,
			audioprops =
			{
	...
	{
		51.027, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_3" },
		{
			duration = 0.999,
			audioprops =
			{
	...
	{
		51.027, START_AUDIO_PROP_ANIM, { "snd_sfx_ship_levitation_4" },
		{
			duration = 0.999,
			audioprops =
			{
