...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Ku01_05",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.388235, 0.380392, 0.545098 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.317647, 0.411765, 0.517647 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.394701, 0.000000, -0.918810 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.918810, 0.000000, 0.394701 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Ku01_05" },
		{
			duration  =  0.000,
			fogprops  = 
			{
