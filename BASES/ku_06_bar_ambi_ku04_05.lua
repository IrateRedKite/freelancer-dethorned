...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_ku06Bar_ku0405",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.196078, 0.011765, 0.305882 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0, 0.372549, 0.592157 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.882712, -0.469541, -0.018724 },
					   { -0.444687, 0.821782, 0.356270 },
					   { -0.151896, 0.322810, -0.934195 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.494118, 0.6, 0.752941 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.188235, 0.419608, 0.439216 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.900377, 0.435110 },
					   { 0.000000, -0.435110, 0.900377 } }
		}
	},
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_ku06Bar_ku0405" },
		{
			duration  =  0.000,
			fogprops  = 
			{
