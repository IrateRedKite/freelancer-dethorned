...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Br04_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.784314, 0.607843, 0.376471 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.207843, 0.141176, 0.141176 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.145098, 0.439216, 0.129412 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.171727, 0.000000, 0.985145 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.985145, 0.000000, 0.171727 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.635458, 0.515473, 1.632055 },
			orient  =  { { 0.139305, 0.012764, -0.990167 },
					   { -0.989536, 0.039751, -0.138703 },
					   { 0.037590, 0.999128, 0.018167 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.4, 0.243137, 0.168627 },
			specular  =  { 0, 0, 0 },
	...
	{
		entity_name  =  "ambi_starsphere_Bw04_stars",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Br04_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
