...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 20.02831, 3.052123, -43.67142 },
			orient  =  { { -0.941131, 0.000000, -0.338042 },
					   { 0.075761, 0.974562, -0.210924 },
					   { 0.329443, -0.224117, -0.917191 } }
		},
		cameraprops  = 
		{
			fovh  =  35,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -45.04103, 19.87232, 24.23033 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0.012363, -0.376869, 0.010678 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		3.092, START_AUDIO_PROP_ANIM, { "Playership_engine_land_snd" },
		{
			duration  =  2.063,
			audioprops  = 
			{
	...
	{
		3.093, START_AUDIO_PROP_ANIM, { "Playership_engine_land_snd_copy_1" },
		{
			duration  =  0.500,
			audioprops  = 
			{
	...
	{
		3.093, START_SOUND, { "Playership_engine_land_snd_copy_1" },
		{
			duration  =  5.164
		}
	},
	...
	{
		3.093, ATTACH_ENTITY, { "Playership_engine_land_snd_copy_1", "PlayerShip" },
		{
			duration  =  5.198,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		9.625, START_AUDIO_PROP_ANIM, { "Playership_engine_land_turbine_snd" },
		{
			duration  =  0.500,
			audioprops  = 
			{
	...
	{
		9.687, START_SOUND, { "Playership_engine_land_turbine_snd" },
		{
			duration  =  10.251
		}
	},
	...
	{
		9.687, ATTACH_ENTITY, { "Playership_engine_land_turbine_snd", "PlayerShip" },
		{
			duration  =  10.312,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		15.062, START_AUDIO_PROP_ANIM, { "Playership_engine_rumble_snd" },
		{
			duration  =  6.125,
			audioprops  = 
			{
	...
	{
		20.568, START_SOUND, { "Playership_engine_kill_snd" },
		{
			duration  =  1.544
		}
	},
	...
	{
		20.569, ATTACH_ENTITY, { "Playership_engine_kill_snd", "PlayerShip" },
		{
			duration  =  1.555,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
