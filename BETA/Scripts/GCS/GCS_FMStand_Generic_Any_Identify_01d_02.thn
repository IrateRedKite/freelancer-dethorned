...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01dG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01dG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01dG02_RVP51",
			duration = 3.000,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01dG02" },
		{
			duration = 3.000
		}
	},
	...
	{
		3.500, START_FLR_HEIGHT_ANIM, { "Offer_Character_A" },
		{
			duration = 0.000,
			target_type = ROOT,
			floor_height = 0
