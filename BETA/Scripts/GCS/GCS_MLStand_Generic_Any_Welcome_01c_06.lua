...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01cG06_1",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01cG06",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG06_RVP01",
			duration = 2.165,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_W01cG06_1" },
		{
			duration = 1.592
		}
	},
