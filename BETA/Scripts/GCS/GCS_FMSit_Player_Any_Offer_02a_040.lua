...
events =
{
	...
	{
		0.632, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		0.944, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.949, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.304, START_MOTION, { "Player_Character_P" },
		{
