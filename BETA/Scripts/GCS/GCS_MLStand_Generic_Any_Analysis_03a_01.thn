...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.247248, 1.648015, -0.111398 },
			orient = { {  0.000112,  0.000000, -1.000000 },
					   { -0.074613,  0.997213, -0.000008 },
					   {  0.997213,  0.074613,  0.000112 } }
		},
		cameraprops =
		{
			fovh = 25,
	...
	{
		entity_name = "VoiceProfile_$BGCS_Faction_Rebuff_ML",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Faction_Rebuff_ML",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.061, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.109, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.699,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_$BGCS_Faction_Rebuff_ML" },
		{
			duration = 1.389
		}
	},
	...
	{
		0.720, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.720, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.800, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.090,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.893, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.827,
			end_effector = "Eye IK Left",
			count_to_root = 1,
