...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Ew03_01",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.683018, -0.137321, 0.717377 },
					   { -0.430937, 0.717242, 0.547593 },
					   { -0.589728, -0.683160, 0.430712 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.843137, 0.607843, 0.258824 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.192157, 0.188235, 0.247059 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.765692, 0.643207 },
					   { 0.000000, -0.643207, 0.765692 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.870863, 0.491526 },
					   { 0.000000, -0.491526, -0.870863 } }
		}
	},

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.683018, -0.137321, 0.717377 },
					   { -0.430937, 0.717242, 0.547592 },
					   { -0.589728, -0.683160, 0.430713 } }
		},
		lightprops  = 
		{
			on  =  Y,
	...
	{
		entity_name  =  "ambi_starsphere_Ew03_1",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ew03",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.894741, 0.000000, -0.446586 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.446586, 0.000000, 0.894741 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Ew03_stars_2",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ew03_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Ew03_01" },
		{
			duration  =  0.000,
			fogprops  = 
			{
