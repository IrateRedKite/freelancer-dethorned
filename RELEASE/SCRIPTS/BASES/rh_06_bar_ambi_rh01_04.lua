...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Cv01Bar_rh0104",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.305882, 0.305882, 0.380392 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { -5000, 0, 0 },
			orient = { {  0.667105,  0.042668,  0.743741 },
					   { -0.055467,  0.998432, -0.007528 },
					   { -0.742896, -0.036231,  0.668426 } }
		}
	},
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { {  0.807341,  0.082390, -0.584305 },
					   { -0.240976,  0.949907, -0.199017 },
					   {  0.538638,  0.301478,  0.786753 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.768628, 0.772549, 0.807843 },
			specular = { 0, 0, 0 },
			ambient = { 0.160784, 0.145098, 0.211765 },
			direction = { 0, 0, 1 },
			range = 100000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.368879,  0.000000, -0.929477 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.929477,  0.000000, -0.368879 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_rh0104" },
		{
			duration = 0.000,
			fogprops =
			{
