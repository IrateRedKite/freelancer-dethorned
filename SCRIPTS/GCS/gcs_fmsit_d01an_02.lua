...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01aN02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01aN02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01aN02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01aN02_RVP51",
			duration = 1.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.400, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_IDLE_SMALL_000LV_XA_05",
			duration = 5.000,
			trans_time = 0.500,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01aN02" },
		{
			duration = 1.350
		}
	},
	...
	{
		0.850, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.851, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.906, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.100, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.750,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.117, START_MOTION, { "Offer_Character_A" },
		{
