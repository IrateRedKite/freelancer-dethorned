...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A02cG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A02cG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_A02cG01_RVP01",
			duration = 3.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_A02cG01" },
		{
			duration = 2.687
		}
	},
	...
	{
		1.578, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_CONV_RHND_EMPH_000LV_XA_03",
			duration = 3.365,
			trans_time = 0.650,
			time_scale = 0.6,
			weight = 1,
	...
	{
		2.190, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.190, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
