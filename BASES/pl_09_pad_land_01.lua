...
entities  = 
{
	...
	{
		entity_name  =  "Layer_Pl_09_Pad_Land",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		pathprops  = 
		{
			...
			path_data  =  "OPEN,{ -909.332458, 59.346935, -321.704254 }, { 0.755830, 0.064537, -0.641744, -0.112785 }, { -334.781281, 97.852379, -454.275513 }, { 0.303962, -0.155747, 0.915535, 0.212475 }, { -89.362457, 55.299976, -98.190331 }, { 0.202200, -0.394019, 0.891638, 0.094054 }, { -38.539711, 40.976425, -43.510868 }, { 0.120432, -0.169135, 0.978191, -0.005625 }, { -4.191858, 37.595627, 10.963202 }, { -0.027507, -0.072341, 0.990472, -0.113909 }, "
		}
	},

	{
		...
		spatialprops  = 
		{
			pos  =  { 23.25126, 29.16964, 26.24236 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 23.52586, -0.385464, 31.50724 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -632.7665, 18.44619, 507.1723 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -290.2884, 116.2726, 764.0689 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 31.5211, 6.472163, -26.81871 },
			orient  =  { { -0.988367, 0.000000, -0.152086 },
					   { 0.022973, 0.988526, -0.149297 },
					   { 0.150341, -0.151054, -0.977026 } }
		},
		cameraprops  = 
		{
			fovh  =  35,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -635.4074, 29.02527, 585.3101 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -19.72366, 19.83116, 48.25788 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		3.031, START_PATH_ANIMATION, { "PlayerShip", "Path_Mop_1" },
		{
			duration  =  14.561,
			start_percent  =  0,
			stop_percent  =  1,
			...
			param_curve  = 
			{
				...
				points  = 
				{
					...
					{ 0.141026, 0.233974, 0.000000, 0.000000 },
					{ 0.307692, 0.660256, 0.000000, 0.000000 },
					{ 0.506410, 0.583333, 0.000000, 0.000000 },
					{ 0.666667, 0.647436, 0.000000, 0.000000 },
					{ 0.846154, 0.548077, 0.000000, 0.000000 },
	...
	{
		3.062, START_AUDIO_PROP_ANIM, { "Playership_engine_land_rumble_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
	...
	{
		3.062, START_SOUND, { "Playership_engine_land_rumble_snd" },
		{
			duration  =  9.112
		}
	},
	...
	{
		3.062, ATTACH_ENTITY, { "Playership_engine_land_rumble_snd", "PlayerShip" },
		{
			duration  =  9.269,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		9.531, START_PSYS, { "rtc_shipdust_9" },
		{
			duration  =  12.968
		}
	},
	...
	{
		14.687, START_PSYS_PROP_ANIM, { "rtc_shipdust_9" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		15.437, START_SPATIAL_PROP_ANIM, { "Prop_PlayerShip_Shipcushion_Marker_A" },
		{
			duration  =  3.000,
			target_type  =  ROOT,
			spatialprops  = 
			{
				pos  =  { 23.661, 0, 31.2143 }
			}
		}
	},

	{
		15.781, START_PSYS_PROP_ANIM, { "rtc_shipdust_9" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		17.031, START_PSYS_PROP_ANIM, { "rtc_shipdust_9" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		18.750, START_PSYS_PROP_ANIM, { "rtc_shipdust_9" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		20.312, START_PSYS_PROP_ANIM, { "rtc_shipdust_9" },
		{
			duration  =  0.100,
			psysprops  = 
			{
	...
	{
		20.600, START_SOUND, { "Playership_engine_kill_snd" },
		{
			duration  =  1.544
		}
	},
	...
	{
		20.600, ATTACH_ENTITY, { "Playership_engine_kill_snd", "PlayerShip" },
		{
			duration  =  1.586,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
