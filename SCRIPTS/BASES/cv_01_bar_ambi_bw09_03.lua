...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Bw09_03",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.843027, 0.344050, -0.413444 },
					   { -0.476384, 0.834481, -0.276945 },
					   { 0.249728, 0.430431, 0.867390 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.839216, 0.607843, 0.294118 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.117647, 0.109804, 0.133333 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.957474, -0.288519 },
					   { 0.000000, 0.288519, 0.957474 } }
		}
	},

	{
		...
		{
			pos  =  { -15000, -3000, 0 },
			orient  =  { { 0.410967, 0.000000, 0.911650 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.911650, 0.000000, 0.410967 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.519920, 0.854215 },
					   { 0.000000, -0.854215, 0.519920 } }
		}
	},

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.655168, 0.344050, -0.672596 },
					   { -0.541731, 0.834481, -0.100836 },
					   { 0.526576, 0.430431, 0.733108 } }
		},
		lightprops  = 
		{
			on  =  Y,
			...
			diffuse  =  { 0.839216, 0.607843, 0.294118 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.137255, 0.129412, 0.160784 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Bw09_1",
		type  =  COMPOUND,
		template_name  =  "starsphere_Bw09",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.891688, 0.054468, 0.449362 },
					   { 0.060970, 0.998140, 0.000000 },
					   { -0.448526, 0.027398, -0.893350 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Bw09_stars_2",
		type  =  COMPOUND,
		template_name  =  "starsphere_Bw09_stars",
		lt_grp  =  23, srt_grp  =  -101, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.082629, 0.000000, 0.996580 },
					   { 0.025515, 0.999672, 0.002116 },
					   { -0.996254, 0.025602, -0.082602 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Bw09_03" },
		{
			duration  =  0.000,
			fogprops  = 
			{
	...
	{
		0.000, ATTACH_ENTITY, { "ambi_starsphere_Bw09_stars_2", "ambi_starsphere_Bw09_1" },
		{
			duration  =  0.000,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
