...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_ku_08_bar_Ku03_05",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.411765, 0.411765, 0.603922 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.844701, 0.000000, -0.535239 },
					   { -0.173467, 0.946025, 0.273762 },
					   { 0.506349, 0.324094, -0.799108 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.243137, 0.34902, 0.52549 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.235294, 0.203922, 0.305882 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.843088, 0.537775 },
					   { 0.000000, -0.537775, -0.843088 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.790585, -0.612352 },
					   { 0.000000, 0.612352, 0.790585 } }
		}
	},

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.443137, 0.552941, 0.741176 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.235294, 0.203922, 0.305882 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
	...
	{
		entity_name  =  "ambi_starsphere_Ku01_5",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ku01",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.916138, 0.000000, 0.400863 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.400863, 0.000000, -0.916138 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Ku01_stars_6",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ku01_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_ku_08_bar_Ku03_05" },
		{
			duration  =  0.000,
			fogprops  = 
			{
