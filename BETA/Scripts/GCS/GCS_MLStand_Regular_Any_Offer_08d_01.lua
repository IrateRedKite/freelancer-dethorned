...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F08dR01",
		type = SOUND,
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F08dR01" },
		{
			duration = 5.250
		}
	},
	...
	{
		0.703, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},
	...
	{
		4.440, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 5.000,
			trans_time = 0.600,
