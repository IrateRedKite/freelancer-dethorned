...
entities =
{
	...
	{
		entity_name = "Set_bw_01_Cityscape_BG_01",
		type = COMPOUND,
		...
		spatialprops =
		{
			pos = { 144.9273, -20.62568, -206.9217 },
			orient = { {  0.935376,  0.000000,  0.353656 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.353656,  0.000000,  0.935376 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "Set_bw_01_Cityscape_BG_02",
		type = COMPOUND,
		template_name = "bw_01_background",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC,
		spatialprops =
		{
			pos = { 395.0552, 0, 41.03573 },
			orient = { { -0.148815,  0.000000,  0.988865 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.988865,  0.000000, -0.148815 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Layer_Bw_01_cityscape_hardpoint" },
		{
			duration = 0.100,
			fogprops =
			{
