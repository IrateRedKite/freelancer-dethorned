...
events =
{
	...
	{
		0.330, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.330, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.717, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.864,
			end_effector = "Body_Head",
			count_to_root = 1,
