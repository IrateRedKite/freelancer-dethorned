...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_STND_GRABR_CHIN_RLEASE_000LV_XA_01",
			duration = 1.500,
			start_time = 0.300,
			trans_time = 1.000,
			time_scale = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F03cR01" },
		{
			duration = 3.367
		}
	},
	...
	{
		0.781, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
...

	{
		...
		{
			animation = "Sc_FMBODY_STND_HOLD_CHIN_RLEASE_000LV_XA_01",
			duration = 1.833,
			trans_time = 1.000,
			time_scale = 1,
			weight = 1,
