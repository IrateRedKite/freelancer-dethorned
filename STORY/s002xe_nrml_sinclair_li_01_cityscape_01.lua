...
entities =
{
...

	{
		...
		type = DEFORMABLE,
		template_name = "ore_runner_male_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
	...
	{
		entity_name = "Cam_03_ACOH_Trent_Medics_A_old",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Cam_03_ACOH_Trent_Medics_B_old",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Cam_12_Wide_to_ACU_A_Tr_Walk_old",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Cam_12_Wide_to_ACU_C_Syd_Smoke_old",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
...

	{
		...
		spatialprops =
		{
			pos = { 39.96771, 3.832246, 28.90201 },
...

	{
		...
		spatialprops =
		{
			pos = { 41.14293, 1.59086, -13.96082 },
			orient = { {  0.641281,  0.000000, -0.767306 },
					   { -0.072162,  0.995568, -0.060310 },
					   {  0.763905,  0.094045,  0.638439 } }
		},
		cameraprops =
		{
			fovh = 25,
...

	{
		...
		spatialprops =
		{
			pos = { 39.96773, 3.832192, 28.90219 },
			orient = { {  0.996432,  0.000000, -0.084404 },
					   {  0.024466,  0.957065,  0.288839 },
					   {  0.080780, -0.289873,  0.953650 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 44.11054, 1.585726, -14.53613 },
			orient = { {  0.318789,  0.000000, -0.947826 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.947826,  0.000000,  0.318789 } }
		}
	...
	{
		entity_name = "ambi_LtG04_Direct_City_Sky_6ocTransport",
		type = LIGHT,
		template_name = "",
		lt_grp = 4, srt_grp = 0, usr_flg = 0,
		spatialprops =
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.243137, 0.207843, 0.282353 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 100000,
	...
	{
		entity_name = "ambi_LtG04_Direct_City_Sun_1oc_Transport",
		type = LIGHT,
		template_name = "",
		lt_grp = 4, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			...
			orient = { {  0.281327,  0.000000,  0.959612 },
					   { -0.331024,  0.938619,  0.097045 },
					   { -0.900710, -0.344956,  0.264058 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 1, 0.882353, 0.607843 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 100000,
	...
	{
		entity_name = "ambi_LtG04_Direct_City_Sun_11oc_Transport",
		type = LIGHT,
		template_name = "",
		lt_grp = 4, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			...
			orient = { {  0.989030,  0.001731, -0.147706 },
					   {  0.060325,  0.908014,  0.414574 },
					   {  0.134837, -0.418937,  0.897948 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.427451, 0.384314, 0.305882 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 100000,
...

	{
		...
		spatialprops =
		{
			pos = { 34.1933, 0.924866, -15.66676 },
			orient = { {  0.429888,  0.000000, -0.902882 },
					   {  0.597913,  0.749304,  0.284684 },
					   {  0.676533, -0.662227,  0.322117 } }
		},
		cameraprops =
		{
			fovh = 15,
	...
	{
		entity_name = "ambi_LtG00_Direct_City_Sun_03",
		type = LIGHT,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			...
			orient = { { -0.457904, -0.115971,  0.881405 },
					   { -0.069014,  0.993100,  0.094813 },
					   { -0.886319, -0.017414, -0.462748 } }
		},
		lightprops =
		{
			on = N,
	...
	{
		entity_name = "ambi_LtG00_point_shipengine",
		type = LIGHT,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 32.96381, 2.149203, -10.49793 },
			orient = { { -0.696778, -0.019046,  0.717034 },
					   { -0.047097,  0.998705, -0.019239 },
					   { -0.715739, -0.047175, -0.696773 } }
		},
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.113725, 0.14902, 0.278431 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 8,
	...
	{
		entity_name = "Path_ltg00_point_shipengine_bruce",
		type = MOTION_PATH,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 37.42948, 0, -14.05697 },
			orient = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		pathprops =
		{
			path_type = "CV_CROrientationSplinePath",
			path_data = "OPEN,{4.251934,2.148891,4.662536}, {1.000000,0.000000,0.000000,0.000000}, {1.631161,2.194404,-5.405020}, {1.000000,0.000000,0.000000,0.000000}, "
		}
	},

	{
		entity_name = "rtcprop_l_fighter_EXTRA_Mrk_to_01",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 74.33041, 26.48116, -73.52384 },
			orient = { {  0.672771,  0.000000,  0.739851 },
					   { -0.248683,  0.941817,  0.226135 },
					   { -0.696804, -0.336125,  0.633627 } }
		}
	},

	{
		entity_name = "rtcprop_l_fighter_EXTRA_Mrk_to_02",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 46.37989, 75.436, -233.2454 },
			orient = { {  0.894134,  0.441039,  0.077515 },
					   { -0.426436,  0.891452, -0.153184 },
					   { -0.136661,  0.103912,  0.985153 } }
		}
	},

	{
		entity_name = "gf_ci_smallengine_EXTRA_SHIP",
		type = PSYS,
		template_name = "gf_ci_smallengine01_fire",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
...

	{
		...
		spatialprops =
		{
			pos = { 41.82513, 1.520105, -12.80054 },
...

	{
		...
		spatialprops =
		{
			pos = { 42.16297, 0.988488, -12.80433 },
...

	{
		...
		spatialprops =
		{
			pos = { 41.84232, 0.953064, -12.88988 },
	...
	{
		entity_name = "Cam_12_Wide_to_ACU_A_Tr_static_cam_c",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 33.94186, 1.691486, -15.59851 },
			orient = { {  0.653646,  0.000000, -0.756800 },
					   { -0.054065,  0.997445, -0.046696 },
					   {  0.754867,  0.071439,  0.651976 } }
		},
		cameraprops =
		{
			fovh = 20,
...
events =
{
	...
	{
		0.001, START_SOUND, { "mix_s002xe_2" },
		{
			duration = 92.791
		}
	},
	...
	{
		0.312, START_PSYS, { "gf_ci_smallengine_EXTRA_SHIP" },
		{
			duration = 5.000
		}
	},
	...
	{
		3.281, SET_CAMERA, { "Cam_Monitor_s002xe_min_spec", "Cam_01_VideoCam_A_static_mon_b" }
	},
	...
	{
		7.685, START_MOTION, { "Char_Extra_01" },
		{
	...
	{
		9.061, START_PSYS_PROP_ANIM, { "vfx_rtc_shipdust_2x" },
		{
			duration = 0.000,
			psysprops =
			{
	...
	{
		9.841, START_PSYS_PROP_ANIM, { "vfx_rtc_shipdust_1x" },
		{
			duration = 0.000,
			psysprops =
			{
	...
	{
		10.625, START_SPATIAL_PROP_ANIM, { "Char_Extra_01", "Char_Extra_01_Mk_loc_Arrive" },
		{
			duration = 0.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		11.000, START_IK, { "Char_Extra_01", "Char_Extra_04_guard" },
		{
			duration = 8.836,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		15.812, START_MOTION, { "Char_trent" },
		{
	...
	{
		16.312, START_MOTION, { "Char_trent" },
		{
	...
	{
		16.875, START_MOTION, { "Char_trent" },
		{
			animation = "Sc_MLHAND_NEUT_ATEASE_LEFT_000LV_XB_%",
			duration = 2.533,
			trans_time = 0.500,
	...
	{
		21.343, START_MOTION, { "Char_trent" },
		{
...

	{
		21.609, START_SPATIAL_PROP_ANIM, { "Char_Syd_Mk_IKeyes", "Char_Syd_Mk_IKeyes_Left" },
		{
			...
			spatialprops =
			{
				pos = { 56.36857, 1.670062, -17.20756 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		25.656, START_SPATIAL_PROP_ANIM, { "Cam_03_ACOH_Trent_Medics_A", "Cam_03_ACOH_Trent_Medics_B_old" },
		{
			duration = 1.500,
			target_part = "",
			target_type = ROOT,
	...
	{
		25.656, START_SPATIAL_PROP_ANIM, { "Cam_03_ACOH_Trent_Medics_A_old", "Cam_03_ACOH_Trent_Medics_B_old" },
		{
			duration = 2.029,
			target_part = "",
			target_type = ROOT,
	...
	{
		25.750, SET_CAMERA, { "Cam_Monitor_s002xe_min_spec", "Cam_03_ACOH_Trent_Medics_B_old" }
	},
	...
	{
		26.297, START_MOTION, { "Char_medic_1" },
		{
	...
	{
		32.027, START_LIGHT_PROP_ANIM, { "ambi_LtG04_Direct_City_Sun_11oc_Transport" },
		{
			duration = 0.000,
			lightprops =
			{
				diffuse = { 1, 0.807843, 0.490196 },
			}
		}
	},
...

	{
		33.277, START_SPATIAL_PROP_ANIM, { "Cam_06_ACOH_Tr_Observing_A", "Cam_06_ACOH_Tr_Observing_B" },
		{
			...
			spatialprops =
			{
				pos = { 41.84424, 0.953276, -12.88936 },
	...
	{
		33.277, START_CAMERA_PROP_ANIM, { "Cam_06_ACOH_Tr_Observing_A" },
		{
			duration = 1.662,
			cameraprops =
			{
	...
	{
		41.250, START_PATH_ANIMATION, { "ambi_LtG00_point_shipengine", "Path_ltg00_point_shipengine_bruce" },
		{
			duration = 8.280,
			start_percent = 0,
			stop_percent = 1,
	...
	{
		41.406, START_LIGHT_PROP_ANIM, { "ambi_LtG00_point_shipengine" },
		{
			duration = 0.468,
			lightprops =
			{
	...
	{
		46.093, START_MOTION, { "Char_trent" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 3.377,
			trans_time = 0.500,
	...
	{
		46.290, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Direct_City_Sun_03" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		48.281, START_LIGHT_PROP_ANIM, { "ambi_LtG00_point_shipengine" },
		{
			duration = 0.000,
			lightprops =
			{
	...
	{
		48.944, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Direct_City_Sun_03" },
		{
			duration = 0.000,
			lightprops =
			{
...

	{
		51.485, START_SPATIAL_PROP_ANIM, { "Char_Tr_Mk_IKeyes_Lonn", "Prop_Char_Lonnigan" },
		{
			...
			spatialprops =
			{
				pos = { 38.83749, 0.994241, -15.04078 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		52.000, START_SPATIAL_PROP_ANIM, { "Cam_09_PC2_Tr_See_Lonn_A", "Cam_09_PC2_Tr_See_Lonn_C" },
		{
			...
			{
				pos = { 34.36568, 1.408042, -13.20022 },
				q_orient = { -0.105256, 0.127049, -0.986296, -0.127049 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		54.437, START_LIGHT_PROP_ANIM, { "ambi_LtG04_Direct_City_Sun_11oc_Transport" },
		{
			duration = 0.000,
			lightprops =
			{
...

	{
		55.791, START_SPATIAL_PROP_ANIM, { "Prop_Char_Lonnigan", "Prop_Char_Lonn_Mk_loc_03" },
		{
			...
			{
				pos = { 34.1297, 0.779226, -16.49171 },
				q_orient = { -0.960869, -0.136111, 0.241255, -0.110692 }
			}
		}
	},
...

	{
		55.791, START_SPATIAL_PROP_ANIM, { "Char_trent", "Char_Tr_Mk_loc_04_Run_Catch_Up" },
		{
			...
			{
				pos = { 40.03524, 0.950939, -16.71417 },
				q_orient = { -0.991739, 0, -0.128272, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		55.791, START_SPATIAL_PROP_ANIM, { "Char_medic_1", "Char_Medic_1_Mk_loc_03_Catch_Up" },
		{
			...
			{
				pos = { 32.35531, 0.946886, -16.80064 },
				q_orient = { -0.939613, 0, 0.342237, 0 }
			}
		}
	},

	{
		55.791, START_SPATIAL_PROP_ANIM, { "Char_medic_2", "Char_Medic_2_Mk_loc_03_Catch_Up" },
		{
			...
			{
				pos = { 35.926, 0.946886, -16.27961 },
				q_orient = { -0.94845, 0, 0.316927, 0 }
			}
		}
	},

	{
		55.791, START_LIGHT_PROP_ANIM, { "ambi_LtG04_Direct_City_Sun_11oc_Transport" },
		{
			duration = 0.000,
			lightprops =
			{
...

	{
		55.805, START_SPATIAL_PROP_ANIM, { "Prop_Char_Lonnigan", "Prop_Char_Lonn_Mk_loc_04" },
		{
			...
			{
				pos = { 6.243919, 0.594941, -19.70311 },
				q_orient = { -0.963038, -0.030519, 0.26763, -0.021737 }
			}
		}
	},
	...
	{
		56.914, START_MOTION, { "Char_trent" },
		{
...

	{
		61.333, START_SPATIAL_PROP_ANIM, { "Cam_11_AC2_Tr_Catching_up_A", "Cam_11_AC2_Tr_Catching_up_B" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.702578, -0.083266, -0.706719, 0.083266 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		63.593, ATTACH_ENTITY, { "Char_Extra_04_guard", "Mrk_offscreen_Location" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
...

	{
		65.277, START_SPATIAL_PROP_ANIM, { "Char_trent", "Char_Tr_Mk_loc_05_Stack_Correctly" },
		{
			...
			{
				pos = { 27.59809, 0.947682, -18.8095 },
				q_orient = { -0.988256, 0, 0.152805, 0 }
			}
		}
	},

	{
		65.277, START_SPATIAL_PROP_ANIM, { "Char_medic_1", "Char_Medic_1_Mk_loc_04_Stack_Correctly" },
		{
			...
			{
				pos = { 21.5205, 0.925532, -17.67022 },
				q_orient = { -0.881732, 0, 0.471751, 0 }
			}
		}
	},
...

	{
		65.816, START_SPATIAL_PROP_ANIM, { "Char_Tr_Mk_look_down_End", "Char_Tr_Mk_look_down_End_shake" },
		{
			...
			{
				pos = { 24.46289, 0.291093, -19.01872 },
				q_orient = { -0.892935, 0, 0.450186, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		66.555, START_SPATIAL_PROP_ANIM, { "Char_syd", "Char_Syd_Mk_loc_02_Enter" },
		{
			...
			{
				pos = { 34.78688, 0.961983, -16.00666 },
				q_orient = { -0.999767, 0, 0.021591, 0 }
			}
		}
	},

	{
		67.250, START_MOTION, { "Char_syd" },
		{
	...
	{
		69.527, START_SPATIAL_PROP_ANIM, { "Cam_12_Wide_to_ACU_A_Tr_Walk_old", "Cam_12_Wide_to_ACU_B_cig" },
		{
			duration = 3.437,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 33.90283, 0.810518, -15.29478 },
				q_orient = { -0.110404, 0.01466, 0.993779, -0.01466 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		70.529, SET_CAMERA, { "Cam_Monitor_s002xe_min_spec", "Cam_12_Wide_to_ACU_A_Tr_static_cam_c" }
	},
...

	{
		73.274, START_SPATIAL_PROP_ANIM, { "Cam_12_Wide_to_ACU_A_Tr_Walk", "Cam_12_Wide_to_ACU_C_Syd_Smoke" },
		{
			...
			{
				pos = { 34.1933, 0.924866, -15.66676 },
				q_orient = { -0.727729, 0.37869, 0.571843, -0.37869 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		73.274, START_SPATIAL_PROP_ANIM, { "Cam_12_Wide_to_ACU_A_Tr_Walk_old", "Cam_12_Wide_to_ACU_C_Syd_Smoke_old" },
		{
			duration = 1.937,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 34.54064, 1.124205, -15.34701 },
				q_orient = { -0.432847, 0.302118, 0.849334, -0.302118 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		74.593, START_SPATIAL_PROP_ANIM, { "vfx_rtc_shipdust_1", "vfx_rtc_shipdust_1_Mk_Syd_ShipDust" },
		{
			...
			{
				pos = { 38.77174, 0.975724, -17.11354 },
				q_orient = { -0.984035, 0, -0.177975, 0 }
			}
		}
	},
	...
	{
		76.804, START_SPATIAL_PROP_ANIM, { "Prop_armored_transport", "Prop_armored_trans_mk_Launcher" },
		{
			duration = 12.625,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 66.21597, 74.03461, 104.1136 },
				q_orient = { 0.758517, -0.394338, 0.518797, 0.644305 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		77.305, START_SPATIAL_PROP_ANIM, { "Prop_armored_trans_mk_Launcher", "Prop_armored_trans_Mk_Launch_A" },
		{
			...
			{
				pos = { 60.33696, 31.13352, -18.6559 },
				q_orient = { 0.952852, -0.010496, -0.303254, 0.007433 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		79.939, START_SPATIAL_PROP_ANIM, { "vfx_rtc_shipdust_1", "vfx_rtc_shipdust_1_Mk_Syd_ShipDust_Return" },
		{
			...
			{
				pos = { 60.28741, 0.14502, -18.72975 },
				q_orient = { 0.165048, -0.005684, -0.986269, -0.00446 }
			}
		}
	},
...

	{
		80.236, START_SPATIAL_PROP_ANIM, { "Cam_13_Ship_take_off_A", "Cam_13_Ship_take_off_B" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.994175, 1.6e-005, -0.107777, -1.6e-005 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		80.666, SET_CAMERA, { "Cam_Monitor_s002xe", "Cam_13_Ship_take_off_A" }
	},
	...
	{
		84.375, SET_CAMERA, { "Cam_Monitor_s002xe_min_spec", "Cam_13_Ship_take_off_C_static_mon" }
	},
	...
	{
		92.750, START_AUDIO_PROP_ANIM, { "sfx_backgroundmusic_1" },
		{
			duration = 0.000,
			audioprops =
			{
