...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br_08_bar_Bw10_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.788235, 0.792157, 0.819608 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.985803, 0.053988, -0.158989 },
					   { -0.030330, 0.874063, 0.484865 },
					   { 0.165143, 0.482803, -0.860017 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.941177, 0.945098, 0.956863 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.196078, 0.184314, 0.235294 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.746332, -0.665574 },
					   { 0.000000, 0.665574, 0.746332 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.159319, 0.987227 },
					   { 0.000000, -0.987227, 0.159319 } }
		}
	},

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.989630, -0.091568, -0.110671 },
					   { -0.134609, 0.860100, 0.492045 },
					   { 0.050132, 0.501840, -0.863507 } }
		},
		lightprops  = 
		{
			on  =  Y,
			...
			diffuse  =  { 1, 1, 1 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.258824, 0.243137, 0.309804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Bw10_3",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.658193, 0.025192, -0.752428 },
					   { -0.015990, 0.998747, 0.047426 },
					   { 0.752680, 0.043247, -0.656965 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
events  = 
{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br_08_bar_Bw10_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
