...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D02eP02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02eP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02eP02_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_D02eP02_Trent",
			duration = 2.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02eP02" },
		{
			duration = 1.529
		}
	},
	...
	{
		0.515, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.687, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.029, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.029, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.279, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.750,
			end_effector = "Body_Head",
			count_to_root = 1,
