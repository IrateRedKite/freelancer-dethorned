...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_rh08Bar_rh0206",
		type = SCENE,
		template_name = "",
...

	{
		...
		{
			pos = { 15000, 0, 0 },
			orient = { { -0.908282,  0.000000, -0.418358 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.418358,  0.000000, -0.908282 } }
		}
	},
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { { -0.851986, -0.240398, -0.465111 },
					   { -0.511163,  0.574132,  0.639597 },
					   {  0.113277,  0.782675, -0.612036 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.407843, 0.533333, 0.682353 },
			specular = { 0, 0, 0 },
			ambient = { 0.286275, 0.235294, 0.219608 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.857394,  0.000000,  0.514661 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.514661,  0.000000, -0.857394 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_rh08Bar_rh0206" },
		{
			duration = 0.000,
			fogprops =
			{
