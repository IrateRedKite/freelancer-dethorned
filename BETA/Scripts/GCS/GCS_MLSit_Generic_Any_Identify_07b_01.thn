...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 2.021339, 1.267447, 0.330292 },
			orient = { {  0.247324,  0.000000, -0.968933 },
					   { -0.124998,  0.991644, -0.031906 },
					   {  0.960836,  0.129005,  0.245257 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D07bG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D07bG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D07bG01_RVP01",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D07bG01" },
		{
			duration = 3.250
		}
	},
	...
	{
		2.750, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.750, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.890, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLHAND_NEUT_LEFT_000LV_A_00",
			duration = 4.000,
			trans_time = 0.500,
	...
	{
		2.937, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_000LV_XA_06",
			duration = 2.367,
			trans_time = 0.500,
