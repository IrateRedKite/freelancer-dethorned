...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR03_14",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F10bR03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F10bR03_RVP01",
			duration = 1.046,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.421, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},

	{
		0.468, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.468, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR03_14" },
		{
			duration = 0.570
		}
	},
	...
	{
		0.812, START_MOTION, { "Player_Character_P" },
		{
