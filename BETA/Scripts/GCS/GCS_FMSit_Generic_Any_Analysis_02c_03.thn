...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A02cG03_sit",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_A02cG03" },
		{
			duration = 2.875
		}
	},
	...
	{
		2.380, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.380, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.601, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.778,
			end_effector = "Body_Head",
			count_to_root = 1,
