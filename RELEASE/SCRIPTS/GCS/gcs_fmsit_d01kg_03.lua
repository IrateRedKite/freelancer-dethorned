...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01kG03_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01kG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01kG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01kG03_RVP51",
			duration = 3.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01kG03" },
		{
			duration = 2.750
		}
	},
	...
	{
		0.781, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.492, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.593, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.250, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.250, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.343, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.428, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.820,
			end_effector = "Body_Head",
			count_to_root = 1,
