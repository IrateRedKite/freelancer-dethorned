...
entities =
{
	...
	{
		entity_name = "Layer_GCS_V05aV_03",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_V05aV03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_V05aV03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_V05aV03_RVP01",
			duration = 3.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_V05aV03" },
		{
			duration = 3.151
		}
	},
	...
	{
		2.078, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.082,
	...
	{
		2.592, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.055,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.650, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.650, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
