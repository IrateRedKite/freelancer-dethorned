...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0.012327, 0.002319, 0.010559 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -2.938337, 40.07179, 0.971519 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		0.405, START_SOUND, { "Playership_engine_launch_rumble_snd" },
		{
			duration  =  8.156,
			flags  =  LOOP
		}
	...
	{
		0.405, ATTACH_ENTITY, { "Playership_engine_launch_rumble_snd", "PlayerShip" },
		{
			duration  =  14.781,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		7.717, START_AUDIO_PROP_ANIM, { "Playership_engine_launch01_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.237179, 0.903846, 0.866667, 0.736842 },
					{ 0.541667, 0.814103, 0.000000, 0.000000 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		7.717, ATTACH_ENTITY, { "Playership_engine_launch01_snd", "PlayerShip" },
		{
			duration  =  7.467,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		7.718, START_SOUND, { "Playership_engine_launch01_snd" },
		{
			duration  =  4.853
		}
	},
	...
	{
		11.000, START_SOUND, { "PlayerShip_engine_playership" },
		{
			duration  =  4.186,
			flags  =  LOOP
		}
	...
	{
		11.000, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		11.000, ATTACH_ENTITY, { "PlayerShip_engine_playership", "PlayerShip" },
		{
			duration  =  4.185,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		11.593, START_AUDIO_PROP_ANIM, { "Playership_engine_launch01_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
