...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02cP03",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02cP03_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_D02cP03_Trent",
			duration = 2.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.273, SET_CAMERA, { "Monitor", "Camera/PCO" }
	},

	{
		0.390, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02cP03" },
		{
			duration = 1.304
		}
	},
	...
	{
		0.800, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.800, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.984, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.815,
			end_effector = "Body_Head",
			count_to_root = 1,
