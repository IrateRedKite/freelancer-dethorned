...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02cP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02cP02_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...

	{
		...
		spatialprops =
		{
			pos = { 0.328068, 1.797212, 1.123099 },
			orient = { {  0.995183,  0.000000,  0.098034 },
					   {  0.019332,  0.980364, -0.196249 },
					   { -0.096109,  0.197199,  0.975641 } }
		},
		cameraprops =
		{
			fovh = 25,
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D02cP02_Trent",
			duration = 2.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.257, SET_CAMERA, { "Monitor", "Camera/PCO" }
	},

	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02cP02" },
		{
			duration = 1.688
		}
	},
	...
	{
		1.190, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.190, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
