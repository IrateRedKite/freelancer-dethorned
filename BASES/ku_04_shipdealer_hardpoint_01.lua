...
entities  = 
{
	...
	{
		entity_name  =  "Layer_Ku_04_shipdlr_hardpoint",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -5.828236, 0, 14.92929 },
			orient  =  { { -0.525331, 0.008235, 0.850858 },
					   { -0.000606, 0.999949, -0.010052 },
					   { -0.850898, -0.005796, -0.525299 } }
		}
	},

	{
		...
		spatialprops  = 
		{
			pos  =  { -4.762449, 0.003593, 15.22252 },
			orient  =  { { 0.287813, -0.009452, -0.957640 },
					   { -0.000606, 0.999949, -0.010052 },
					   { 0.957686, 0.003473, 0.287793 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 36.78063, 20.9458, 15.83596 },
			orient  =  { { 0.299590, 0.000000, -0.954068 },
					   { -0.263957, 0.960967, -0.082886 },
					   { 0.916827, 0.276665, 0.287896 } }
		},
		cameraprops  = 
		{
			fovh  =  35,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -31.27071, 8.642156, 15.76199 },
			orient  =  { { 0.395753, 0.000000, -0.918357 },
					   { 0.151003, 0.986389, 0.065072 },
					   { 0.905857, -0.164427, 0.390367 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 23.69853, 7.945753, 14.37158 },
			orient  =  { { 0.286634, 0.000000, -0.958040 },
					   { -0.027655, 0.999583, -0.008274 },
					   { 0.957641, 0.028866, 0.286514 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -1.297635, 12.79735, 20.40691 },
	...
	{
		entity_name  =  "Set_ku_04_shipdlr_1",
		type  =  COMPOUND,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -4.260195, -0.000409, 15.33133 },
			orient  =  { { 0.287813, -0.009452, -0.957640 },
					   { -0.000606, 0.999949, -0.010052 },
					   { 0.957686, 0.003473, 0.287793 } }
		}
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -5.212749, 1.699747, 16.59358 },
			orient  =  { { 0.999491, 0.000285, -0.031887 },
					   { -0.006524, 0.980638, -0.195720 },
					   { 0.031214, 0.195829, 0.980141 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -4.492979, 1.772832, 15.7896 },
			orient  =  { { 0.724470, -0.006490, -0.689276 },
					   { -0.125485, 0.982005, -0.141139 },
					   { 0.677788, 0.188745, 0.710619 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -4.796216, 1.689895, 15.58631 },
			orient  =  { { 0.689083, -0.006867, -0.724650 },
					   { -0.070450, 0.994584, -0.076418 },
					   { 0.721250, 0.103710, 0.684867 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -6.373888, 1.735733, 16.03239 },
			orient  =  { { 0.681672, 0.007767, 0.731617 },
					   { 0.139851, 0.980124, -0.140710 },
					   { -0.718168, 0.198235, 0.667036 } }
		},
		cameraprops  = 
		{
			fovh  =  30,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -6.293169, 1.779131, 15.18066 },
			orient  =  { { 0.152978, 0.010026, 0.988179 },
					   { 0.196399, 0.979694, -0.040344 },
					   { -0.968517, 0.200249, 0.147902 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -5.959437, 1.700015, 15.25001 },
			orient  =  { { 0.159410, 0.010020, 0.987162 },
					   { 0.126115, 0.991549, -0.030430 },
					   { -0.979124, 0.129347, 0.156799 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Layer_Ku_04_shipdlr_hardpoint" },
		{
			duration  =  0.100,
			fogprops  = 
			{
