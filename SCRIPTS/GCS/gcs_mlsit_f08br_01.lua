...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F08bR01_24",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F08bR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F08bR01_RVP01",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F08bR01_24" },
		{
			duration = 2.187
		}
	},
	...
	{
		0.640, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.686, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.031, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},

	{
		1.281, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.281, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.690, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.697, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
