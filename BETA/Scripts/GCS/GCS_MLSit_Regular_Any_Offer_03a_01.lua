...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03aR01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.180164, 1.201588, 0.70136 },
			orient = { {  0.846459,  0.000000,  0.532455 },
					   { -0.073592,  0.990403,  0.116992 },
					   { -0.527344, -0.138213,  0.838335 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.475579, 1.961581, -0.185368 },
			orient = { {  0.065226,  0.000000, -0.997871 },
					   { -0.571499,  0.819752, -0.037356 },
					   {  0.818007,  0.572718,  0.053469 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03aR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03aR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03aR01_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03aR01" },
		{
			duration = 2.483
		}
	},
	...
	{
		1.143, START_MOTION, { "Offer_Character_A" },
		{
