...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A04aG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A04aG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.001, START_SOUND, { "VoiceProfile_GCS_ML_A04aG03" },
		{
			duration = 3.077
		}
	},
	...
	{
		1.639, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.953, START_MOTION, { "Offer_Character_A" },
		{
