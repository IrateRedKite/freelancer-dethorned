...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_li_09_bar_Li04_04",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.043137, 0.043137, 0.058824 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.660303, -0.027334, 0.750502 },
					   { -0.118951, 0.990529, -0.068579 },
					   { -0.741520, -0.134556, -0.657300 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.823529, 0.717647, 0.6 },
			specular  =  { 0, 0, 0 },
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.969206, -0.246250 },
					   { 0.000000, 0.246250, 0.969206 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.998264, -0.058901 },
					   { 0.000000, 0.058901, 0.998264 } }
		}
	},

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.500214, -0.636729, 0.586824 },
					   { -0.865555, 0.386858, -0.318048 },
					   { -0.024507, -0.667020, -0.744636 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.65098, 0.639216, 0.788235 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.086275, 0.07451, 0.109804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
	...
	{
		entity_name  =  "ambi_starsphere_Li04_7",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.777186, 0.000000, -0.629271 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.629271, 0.000000, 0.777186 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Li04_stars_8",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.501588, 0.000000, -0.865106 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.865106, 0.000000, 0.501588 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_li_09_bar_Li04_04" },
		{
			duration  =  0.000,
			fogprops  = 
			{
