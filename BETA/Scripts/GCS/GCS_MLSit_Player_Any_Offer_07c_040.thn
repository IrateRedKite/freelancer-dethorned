...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F07cP04_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07cP04",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07cP04_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_F07cP04_Trent",
			duration = 2.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.390, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F07cP04" },
		{
			duration = 1.258
		}
	},
	...
	{
		0.639, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		0.759, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.759, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.814, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.944,
			end_effector = "Body_Head",
			count_to_root = 1,
