...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F01fG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F01fG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F01fG01_RVP01",
			duration = 3.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F01fG01" },
		{
			duration = 3.500
		}
	},
	...
	{
		1.756, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.960, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLHAND_HNEUT_GESTL_CASL_000LV_00",
			duration = 2.500,
			trans_time = 0.500,
	...
	{
		2.358, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.631, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.370,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.000, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.000, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.515, START_MOTION, { "Offer_Character_A" },
		{
