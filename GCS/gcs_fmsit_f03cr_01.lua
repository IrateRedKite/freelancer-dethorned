...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F03cR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F03cR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F03cR01_RVP51",
			duration = 4.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_F03cR01" },
		{
			duration = 3.400
		}
	},
	...
	{
		3.029, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.971,
			end_effector = "Body_Head",
			count_to_root = 1,
