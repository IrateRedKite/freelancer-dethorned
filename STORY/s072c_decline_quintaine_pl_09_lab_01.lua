...
entities =
{
	...
	{
		entity_name = "mix_s072c_2",
		type = SOUND,
		template_name = "mix_s072c",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		2.200, START_MOTION, { "Char_orillion" },
		{
...

	{
		2.296, START_SPATIAL_PROP_ANIM, { "Mk_Orillion_look_Trent", "Char_juni" },
		{
			...
			spatialprops =
			{
				pos = { 1.244407, 1.486967, -1.060469 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		2.312, START_SPATIAL_PROP_ANIM, { "Mk_Trent_Look_copy_1", "Char_juni" },
		{
			...
			spatialprops =
			{
				pos = { 1.244388, 1.486964, -1.060469 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
