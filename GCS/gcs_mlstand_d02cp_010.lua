...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02cP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02cP01_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D02cP01_Trent",
			duration = 2.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02cP01" },
		{
			duration = 1.795
		}
	},
	...
	{
		0.937, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		1.289, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.289, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.554, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.736,
			end_effector = "Body_Head",
			count_to_root = 1,
