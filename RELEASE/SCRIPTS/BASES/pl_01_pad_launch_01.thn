...
entities  = 
{
	...
	{
		entity_name  =  "Layer_Pl_01_Launch",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ -17.731613, 9.413107, 43.381020 }, { 0.977312, -0.041755, -0.207459, -0.008864 }, { 0.390630, 7.898555, 44.829285 }, { 0.988027, 0.131585, 0.079839, -0.010633 }, { 17.390465, 6.034311, 34.792645 }, { 0.863206, 0.340899, 0.346344, -0.136779 }, { 40.980556, 8.416729, 13.435650 }, { 0.477998, 0.081135, 0.862273, -0.146361 }, "
		}
	},
	...
	{
		entity_name  =  "Prop_PlayerShip_ShipCushion_Marker_2",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0.012346, 0.001113, 0.010622 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -5.328111, 41.63509, 2.628387 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		7.000, START_SPATIAL_PROP_ANIM, { "Prop_PlayerShip_Shipcushion_Marker_A" },
		{
			duration  =  2.000,
			target_type  =  ROOT,
			spatialprops  = 
	...
	{
		7.531, START_AUDIO_PROP_ANIM, { "Playership_engine_launch03_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.304487, 0.705128, 1.416667, 1.500000 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
	...
	{
		7.531, START_SOUND, { "Playership_engine_launch03_snd" },
		{
			duration  =  7.655
		}
	},
	...
	{
		7.531, ATTACH_ENTITY, { "Playership_engine_launch03_snd", "PlayerShip" },
		{
			duration  =  7.750,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		9.750, START_SOUND, { "PlayerShip_engine_playership" },
		{
			duration  =  5.436,
			flags  =  LOOP
		}
	...
	{
		9.750, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		9.750, ATTACH_ENTITY, { "PlayerShip_engine_playership", "PlayerShip" },
		{
			duration  =  5.435,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
