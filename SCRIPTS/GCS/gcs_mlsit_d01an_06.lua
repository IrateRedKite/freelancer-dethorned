...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01aN06_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.556881, 1.635099, 0.858274 },
			orient = { {  0.731824,  0.000000, -0.681494 },
					   { -0.232330,  0.940095, -0.249488 },
					   {  0.640669,  0.340913,  0.687984 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01aN06",
		type = SOUND,
...
events =
{
	...
	{
		0.120, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.331, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.488,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01aN06" },
		{
			duration = 1.317
		}
	},
	...
	{
		0.592, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.819, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.819, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
