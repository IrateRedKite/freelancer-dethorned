...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_rh_08_bar_Bw04_02",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.058824, 0.054902, 0.070588 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.725373, -0.516859, -0.454633 },
					   { -0.645394,  0.740335,  0.188071 },
					   {  0.239375,  0.429839, -0.870597 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.972549, 0.619608, 0.360784 },
			specular = { 0, 0, 0 },
			ambient = { 0.070588, 0.066667, 0.109804 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.656718, -0.754136 },
					   {  0.000000,  0.754136,  0.656718 } }
		}
	},

	{
		...
		{
			pos = { -15000, 0, 0 },
			orient = { { -0.976665, -0.009792,  0.214546 },
					   {  0.000000,  0.998960,  0.045593 },
					   { -0.214769,  0.044529, -0.975649 } }
		}
	},
...

	{
		...
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.674817, -0.737985 },
					   {  0.000000,  0.737985,  0.674817 } }
		}
	},

	{
		...
		lightprops =
		{
			...
			diffuse = { 0.972549, 0.619608, 0.360784 },
			specular = { 0, 0, 0 },
			ambient = { 0.121569, 0.113725, 0.172549 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
	...
	{
		entity_name = "ambi_starsphere_Bw04_5",
		type = COMPOUND,
		template_name = "starsphere_Bw04",
		lt_grp = 23, srt_grp = -100, usr_flg = 1,
		flags = LIT_DYNAMIC,
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { { -0.707682,  0.042877,  0.705229 },
					   {  0.060477,  0.998170,  0.000000 },
					   { -0.703938,  0.042650, -0.708979 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_starsphere_Bw04_stars_6",
		type = COMPOUND,
		template_name = "starsphere_Bw04_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_rh_08_bar_Bw04_02" },
		{
			duration = 0.000,
			fogprops =
			{
