...
entities =
{
	...
	{
		entity_name = "Layer_Rh_08_Bar_ambi_int_Bw05",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "set_starsphere_Bw05",
		type = COMPOUND,
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.790966, -0.517132,  0.327029 },
					   { -0.103126,  0.639510,  0.761834 },
					   { -0.603107,  0.568860, -0.559161 } }
		},
		userprops =
		{
			category = "Prop",
