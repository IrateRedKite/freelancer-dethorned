...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A04aG02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.264708, 1.414567, -0.046904 },
			orient = { {  0.026519,  0.000000, -0.999648 },
					   { -0.212605,  0.977122, -0.005640 },
					   {  0.976778,  0.212680,  0.025912 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A04aG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A04aG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_MLBODY_CHRF_SHAKHEAD_NO_EMPH_000LV_XA_02",
			duration = 4.555,
			trans_time = 0.500,
			time_scale = 0.6,
			weight = 1,
	...
	{
		0.000, START_SOUND, { "VoiceProfile_GCS_ML_A04aG02" },
		{
			duration = 3.000
		}
	},
	...
	{
		0.625, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.484, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.546, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.126,
	...
	{
		1.769, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.000, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.000, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
