...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F03cR03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F03cR03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F03cR03_RVP51",
			duration = 3.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_CONV_LHND_CASL_000LV_xa_03",
			duration = 3.433,
			trans_time = 0.700,
			time_scale = 0.6,
			weight = 1,
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_F03cR03" },
		{
			duration = 3.212
		}
	},

	{
		1.000, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			...
			{
				pos = { 1.571723, 1.76305, -0.176165 },
				q_orient = { -0.980707, -0.036457, 0.192056, 0.036457 }
			},
			param_curve =
			{
	...
	{
		1.664, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.809, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.809, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.812, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.998,
			end_effector = "Body_Head",
			count_to_root = 1,
