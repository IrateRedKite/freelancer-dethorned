...
entities =
{
	...
	{
		entity_name = "VoiceProfile_dx_GCS_F04aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F04aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F04aG01_RVP01",
			duration = 5.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.296, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			duration = 4.250,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_dx_GCS_F04aG01" },
		{
			duration = 5.250
		}
	},
	...
	{
		1.327, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
	...
	{
		2.687, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.265, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.250,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		4.500, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			trans_time = 0.800,
	...
	{
		4.500, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
	...
	{
		4.750, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.750, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
