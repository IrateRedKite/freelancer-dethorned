...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F04dG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F04dG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F04dG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F04dG01_RVP51",
			duration = 6.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F04dG01" },
		{
			duration = 6.217
		}
	},
	...
	{
		2.468, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.046, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.687, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},

	{
		3.968, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		4.187, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMHAND_NEUT_RGHT_000LV_A_00",
			duration = 6.598,
			trans_time = 0.500,
	...
	{
		4.328, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMHAND_NEUT_LEFT_000LV_A_00",
			duration = 6.598,
			trans_time = 0.500,
	...
	{
		4.436, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.282,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		5.312, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_IDLE_000LV_XA_05",
			duration = 5.000,
			time_scale = 1,
	...
	{
		5.719, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		5.719, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
