...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.447221, 1.696946, -0.363263 },
			orient = { { -0.026754,  0.000000, -0.999642 },
					   { -0.103136,  0.994663,  0.002760 },
					   {  0.994307,  0.103173, -0.026611 } }
		},
		cameraprops =
		{
			fovh = 25,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A02dG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A02dG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_A02dG01_RVP01",
			duration = 2.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera/ACS", "Camera/ACOH" },
		{
			...
			{
				pos = { 1.447221, 1.696946, -0.363263 },
				q_orient = { -0.026754, 0, -0.999642, -0.103136 }
			},
			param_curve =
			{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_A02dG01" },
		{
			duration = 1.500
		}
	},
	...
	{
		0.796, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		1.000, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.000, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.250, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.750,
			end_effector = "Body_Head",
			count_to_root = 1,
