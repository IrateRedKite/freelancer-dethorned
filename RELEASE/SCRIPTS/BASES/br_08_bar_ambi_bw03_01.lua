...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br08Bar_bw03_01",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.963495, -0.171707, -0.205413 },
					   { -0.254468, 0.825797, 0.503294 },
					   { 0.083210, 0.537193, -0.839345 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.52549, 0.356863, 0.133333 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.341176, 0.207843, 0.117647 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.796079, 0.509804, 0.07451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.976224, -0.069227, -0.205413 },
					   { -0.166036, 0.848013, 0.503294 },
					   { 0.139352, 0.525434, -0.839345 } }
		},
		lightprops  = 
		{
			on  =  Y,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.760784, 0.470588, 0.145098 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br08Bar_bw03_01" },
		{
			duration  =  0.000,
			fogprops  = 
			{
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "ambi_starsphere_generic_exclusion" },
		{
			duration  =  10000.000,
			target_type  =  ROOT,
			spatialprops  = 
