...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01gV_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01hG02",
		type = SOUND,
...
events =
{
	...
	{
		0.309, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01hG02" },
		{
			duration = 1.491
		}
	},
	...
	{
		0.509, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.846, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.990, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.990, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
