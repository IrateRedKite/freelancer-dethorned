...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01jV_03",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		0.944, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.975,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.993, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.196, START_MOTION, { "Offer_Character_A" },
		{
