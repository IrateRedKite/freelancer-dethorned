...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F10bR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F10bR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_FMBODY_STND_GEST_NOPE_000DN_A_02",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 0.4,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F10bR02_RVP51",
			duration = 0.980,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F10bR02" },
		{
			duration = 0.529
		}
	},
	...
	{
		0.640, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.830, START_MOTION, { "Offer_Character_A" },
		{
