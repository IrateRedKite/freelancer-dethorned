...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01bB04_12",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01bB04",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01bB04_RVP01",
			duration = 1.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.949, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_ML_W01bB04_12" },
		{
			duration = 0.952
		}
	}
