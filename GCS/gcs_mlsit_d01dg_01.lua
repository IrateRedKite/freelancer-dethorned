...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01dG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01dG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01dG01_RVP01",
			duration = 3.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01dG01" },
		{
			duration = 2.411
		}
	},
