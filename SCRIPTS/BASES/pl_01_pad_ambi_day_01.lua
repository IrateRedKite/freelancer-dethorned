...
entities  = 
{
	...
	{
		entity_name  =  "ambi_LtG00_Point_Flame01",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_Skydome_KuwaitSky",
		type  =  COMPOUND,
	...
	{
		entity_name  =  "ambi_LtG00_Point_Flame02",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_LtG03_Inf_Sky_2oc",
		type  =  LIGHT,
		template_name  =  "",
	...
	{
		entity_name  =  "ambi_LtG03_Point_Flame01",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_LtG03_Point_Flame02",
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  3, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "ambi_LtG23_Skydome_Ambi",
		type  =  LIGHT,
		template_name  =  "",
	...
	{
		entity_name  =  "ambi_LtG00_Point_Flame_FlickerSAVE_MKR",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
...

	{
		...
		{
			pos  =  { 0, -1500, 0 },
			orient  =  { { -0.411959, 0.048002, 0.909937 },
					   { 0.027835, 0.998808, -0.040088 },
					   { -0.910777, 0.008813, -0.412804 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_LtG21_Skydome_clouds_Ambi",
		type  =  LIGHT,
		template_name  =  "",
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.129412, 0.07451, 0.011765 },
			direction  =  { 0, 0, 1 },
			range  =  50000,
			cutoff  =  98.99998,
			type  =  L_POINT,
...
{
	{
		0.000, START_SPATIAL_PROP_ANIM, { "ambi_Skydome_clouds_thin" },
		{
			...
			pcurve_period  =  8618882
		}
	},

	{
		0.000, START_LIGHT_PROP_ANIM, { "ambi_LtG03_Point_Flame02" },
		{
			duration  =  3600.000,
			lightprops  = 
			{
				diffuse  =  { 0.439216, 0.560784, 0.505882 },
			},
			param_curve  = 
			{
	...
	{
		0.000, START_LIGHT_PROP_ANIM, { "ambi_LtG03_Point_Flame01" },
		{
			duration  =  3600.000,
			lightprops  = 
			{
	...
	{
		0.000, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Flame02" },
		{
			duration  =  3600.000,
			lightprops  = 
			{
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "ambi_LtG00_Point_Flame_FlickerSAVE_MKR" },
		{
			duration  =  1.000,
			target_type  =  ROOT,
			spatialprops  = 
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "ambi_Skydome_KuwaitSky" },
		{
			duration  =  3600.000,
			target_type  =  ROOT,
			spatialprops  = 
	...
	{
		0.000, START_LIGHT_PROP_ANIM, { "ambi_LtG00_Point_Flame01" },
		{
			duration  =  3600.000,
			lightprops  = 
			{
				diffuse  =  { 0.917647, 1, 0.960784 },
				ambient  =  { 0.121569, 0.129412, 0.12549 },
			},
			param_curve  = 
			{
				CLSID  =  "CatmullRomPCurve",
				points  = 
				{
					...
					{ 0.586538, 0.878205, 0.000000, 0.000000 },
					{ 0.676282, 0.977564, 0.000000, 0.000000 },
					{ 0.791667, 0.942308, 0.000000, 0.000000 },
					{ 0.887821, 1.000000, 0.000000, 0.000000 },
					{ 1.000000, 0.804487, 0.000000, 0.000000 },
				}
			},
