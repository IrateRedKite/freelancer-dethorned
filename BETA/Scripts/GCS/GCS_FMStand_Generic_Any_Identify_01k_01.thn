...
events =
{
...

	{
		0.001, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			...
			point_at = 1,
			move_to = 0,
			transition_duration = 0.060,
			event_flags = 128
		}
	},

	{
		0.029, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.898, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.000,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.899, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.899, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
