...
entities =
{
	...
	{
		entity_name = "Layer_GCS_W01cG06_stand",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_W01cG06",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_W01cG06",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG06_RVP51",
			duration = 2.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_FM_W01cG06" },
		{
			duration = 1.677
		}
	},
	...
	{
		1.687, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special_A_HeightAdjust" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.703, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.171, START_MOTION, { "Offer_Character_A" },
		{
