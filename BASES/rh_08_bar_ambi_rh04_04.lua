...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_rh0404",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0.4, 0.4, 0.4 },
			specular = { 0, 0, 0 },
			ambient = { 0.160784, 0.203922, 0.184314 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.997561,  0.000000, -0.069806 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.069806,  0.000000, -0.997561 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_rh0404" },
		{
			duration = 0.000,
			fogprops =
			{
