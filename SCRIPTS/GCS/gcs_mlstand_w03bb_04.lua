...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W03bB04_9",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W03bB04",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_W03bB04_RVP01",
			duration = 1.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_W03bB04_9" },
		{
			duration = 1.312
		}
	},
	...
	{
		0.935, START_MOTION, { "Offer_Character_A" },
		{
