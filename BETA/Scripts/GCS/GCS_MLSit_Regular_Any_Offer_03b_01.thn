...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03bR01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.120531, 1.261554, 0.724384 },
			orient = { {  0.855637,  0.000000,  0.517576 },
					   { -0.051347,  0.995067,  0.084885 },
					   { -0.515023, -0.099206,  0.851416 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.485828, 1.919103, -0.184395 },
			orient = { {  0.095380,  0.000000, -0.995441 },
					   { -0.481695,  0.875123, -0.046154 },
					   {  0.871133,  0.483901,  0.083469 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03bR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03bR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03bR01_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03bR01" },
		{
			duration = 2.092
		}
	},
	...
	{
		1.159, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.430,
			end_effector = "Body_Head",
			count_to_root = 1,
