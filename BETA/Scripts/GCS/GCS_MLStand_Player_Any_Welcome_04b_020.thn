...
entities =
{
	...
	{
		entity_name = "Layer_GCS_W04bP02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_W04bP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_W04bP02_5",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W04bP02_Trent",
			duration = 4.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_W04bP02" },
		{
			duration = 3.907
		}
	},
	...
	{
		1.031, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.226, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.390, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		3.007, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		3.296, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.113,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.410, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.410, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
