...
entities =
{
	...
	{
		entity_name = "ambi_Layer_Li_09_Commons_Li03",
		type = SCENE,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Ambi_Set_starsphere_Li03",
		type = COMPOUND,
		...
		{
			pos = { 0, 0, 0 },
			orient = { {  0.591621,  0.000000, -0.806216 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.806216,  0.000000,  0.591621 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_LtG01_Ambi_SpaceBar_Li03",
		type = LIGHT,
		template_name = "",
...
{
	{
		0.000, START_SPATIAL_PROP_ANIM, { "Ambi_Set_starsphere_Li03" },
		{
			duration = 9000.000,
			target_type = ROOT,
			spatialprops =
