...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D02dP01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02dP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02dP01_5",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_D02dP01_Trent",
			duration = 2.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02dP01" },
		{
			duration = 1.920
		}
	},
	...
	{
		0.976, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.156, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		1.559, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.860,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.820, START_MOTION, { "Player_Character_P" },
		{
