...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Ku05_03",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.994636, 0.030883, -0.098721 },
					   { 0.015582, -0.898767, -0.438150 },
					   { -0.102258, -0.437338, 0.893464 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.352941, 0.313726, 0.462745 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.32549, 0.266667, 0.4 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.215061, 0.000000, -0.976601 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.976601, 0.000000, 0.215061 } }
		}
	},
	...
	{
		entity_name  =  "ambi_starsphere_Ku05_3",
		type  =  COMPOUND,
		template_name  =  "starsphere_Ku05",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.178750, -0.084793, 0.980234 },
					   { 0.308934, 0.950731, 0.025905 },
					   { -0.934135, 0.298197, 0.196139 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Ku05_stars_4",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Ku05_03" },
		{
			duration  =  0.000,
			fogprops  = 
			{
