...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0.922578, 1.017832, 4.583932 },
			orient  =  { { 0.317624, -0.185235, -0.929948 },
					   { -0.340714, 0.892939, -0.294234 },
					   { 0.884889, 0.410302, 0.220507 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.32549, 0.470588, 0.741176 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.2, 0.14902, 0.211765 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.985940, 0.167100 },
					   { 0.000000, -0.167100, -0.985940 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 3.971232, 1.243768, -0.660126 },
			orient  =  { { 0.317624, -0.185235, -0.929948 },
					   { -0.340714, 0.892939, -0.294234 },
					   { 0.884889, 0.410302, 0.220507 } }
		},
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.090526, 0.005538, 0.995879 },
					   { -0.061058, 0.998134, 0.000000 },
					   { -0.994021, -0.060806, 0.090695 } }
		},
		userprops  = 
		{
			category  =  "Prop",
