...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 121.8656, 0.118221, -56.54726 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 125.1126, 116.4135, -33.08601 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
...

	{
		0.187, START_SPATIAL_PROP_ANIM, { "Mk_Chase_Marker", "Mk_Second_Landing_Pad_Ascent_Mk" },
		{
			...
			{
				pos  =  { 129.0157, 134, -25.19922 },
				q_orient  =  { 0.600003, 0.005013, 0.799982, -0.024082 }
			}
		}
	},

	{
		0.187, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Mk_Chase_Marker" },
		{
			...
			spatialprops  = 
			{
				pos  =  { 122.6859, 15.47937, -52.95049 },
				q_orient  =  { 0.088842, -0.000645, 0.996046, -0.002879 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		1.031, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_01", "Camera_ShipLaunch_02" },
		{
			...
			{
				pos  =  { 226.2366, 139.2467, -78.49868 },
				q_orient  =  { 0.12824, -0.000389, -0.991743, 0.006043 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		4.091, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			duration  =  3.000,
			target_type  =  ROOT,
			spatialprops  = 
...

	{
		7.186, START_SPATIAL_PROP_ANIM, { "Mk_Chase_Marker", "Mk_Second_Landing_Pad_Target" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.526868, -0.015626, -0.849803, -0.051147 }
			}
		}
	},

	{
		7.561, ATTACH_ENTITY, { "Playership_engine_launch02_snd", "PlayerShip" },
		{
			duration  =  6.875,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		7.562, START_SOUND, { "Playership_engine_launch02_snd" },
		{
			duration  =  7.546
		}
	},
	...
	{
		7.562, START_AUDIO_PROP_ANIM, { "Playership_engine_launch02_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
			...
			param_curve  = 
			{
				...
				{
					{ 0.000000, 0.000000, 0.000000, 0.000000 },
					{ 0.391026, 0.769231, 1.428571, 1.000000 },
					{ 1.000000, 1.000000, 0.000000, 0.000000 },
				}
			},
			pcurve_period  =  -1000
...

	{
		8.060, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_02", "Camera_ShipLaunch_04" },
		{
			...
			{
				pos  =  { -116.0476, 123.613, -420.4541 },
				q_orient  =  { 0.717716, 0.037844, -0.695306, -0.089144 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		9.937, START_SOUND, { "PlayerShip_engine_playership_1" },
		{
			duration  =  14.000,
			flags  =  LOOP
		}
	...
	{
		9.937, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership_1" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		9.937, ATTACH_ENTITY, { "PlayerShip_engine_playership_1", "PlayerShip" },
		{
			duration  =  14.000,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		10.000, START_SOUND, { "Playership_engine_launch_rumble_snd" },
		{
			duration  =  9.010
		}
	},
	...
	{
		12.687, START_AUDIO_PROP_ANIM, { "Playership_engine_launch02_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		12.687, START_AUDIO_PROP_ANIM, { "Playership_engine_launch_rumble_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		12.687, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership_1" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		12.687, START_AUDIO_PROP_ANIM, { "Playership_engine_rumble_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
