...
events =
{
	...
	{
		1.049, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.049, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.421, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.437, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.542, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.569,
			end_effector = "Body_Head",
			count_to_root = 1,
