...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A02dG02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_A02dG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_A02dG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.590554,  0.000000,  0.806998 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_A02dG02_RVP51",
			duration = 2.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.375, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_IDLE_SMALL_000LV_XA_05",
			duration = 5.000,
			trans_time = 0.450,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_A02dG02" },
		{
			duration = 1.559
		}
	},
	...
	{
		0.810, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.810, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.256, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.804,
			end_effector = "Body_Head",
			count_to_root = 1,
