...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01fG05_3",
		type = SOUND,
...
events =
{
	...
	{
		0.132, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01fG05_3" },
		{
			duration = 1.366
		}
	},
	...
	{
		0.870, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
