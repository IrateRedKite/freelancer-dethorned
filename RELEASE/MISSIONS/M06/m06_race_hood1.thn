...
entities =
{
	...
	{
		entity_name = "Cam_Hood_CU_Launch",
		type = CAMERA,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { -5067.671, -50.58077, -12540.17 },
			orient = { { -0.953085,  0.000000,  0.302703 },
					   { -0.078240,  0.966019, -0.246344 },
					   { -0.292417, -0.258470, -0.920698 } }
		},
		cameraprops =
		{
			fovh = 35,
...
{
	{
		0.000, SET_CAMERA, { "Monitor_1", "Cam_Hood" }
	},

	{
		0.000, ATTACH_ENTITY, { "Cam_Hood_CU_Launch", "Mk_main_object" },
		{
			duration = 21.000,
			offset = { 0, 0, 25 },
			up = Y_AXIS,
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "Cam_Hood", "Cam_Hood_b" },
		{
			duration = 6.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { -4995.076, 14.25666, -12833.4 },
				q_orient = { -0.999555, 0, 0.029837, 0.005593 }
			}
		}
	},

	{
		6.000, SET_CAMERA, { "Monitor_1", "Cam_Hood_CU_Launch" }
	},

	{
		6.000, START_SPATIAL_PROP_ANIM, { "Cam_Hood_CU_Launch" },
		{
			duration = 6.968,
			target_type = ROOT,
			spatialprops =
			{
				pos = { -5067.671, -35, -12540.17 }
			}
		}
	}
};
