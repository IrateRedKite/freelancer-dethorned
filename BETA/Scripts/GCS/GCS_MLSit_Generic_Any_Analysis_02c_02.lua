...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.635068, 1.462788, -0.019205 },
			orient = { {  0.091643,  0.000000, -0.995792 },
					   { -0.244217,  0.969460, -0.022475 },
					   {  0.965381,  0.245249,  0.088844 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 0.999186, 0, -0.472786 },
			orient = { { -0.406405,  0.000000, -0.913693 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.913693,  0.000000, -0.406405 } }
		},
		compoundprops =
		{
			floor_height = 0
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A02cG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A02cG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_A02cG02_RVP01",
			duration = 4.165,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.015, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.367,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_A02cG02" },
		{
			duration = 3.217
		}
	},
	...
	{
		1.453, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_EMPH_LHNDUP_TRNS_000LV_XA_00",
			duration = 1.608,
			trans_time = 0.650,
			time_scale = 0.6,
			weight = 1,
	...
	{
		1.952, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.766,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.720, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.720, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
