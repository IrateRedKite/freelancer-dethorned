...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W03aF04_1",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W03aF04",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W03aF04_RVP01",
			duration = 1.500,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_W03aF04_1" },
		{
			duration = 1.000
		}
	},
