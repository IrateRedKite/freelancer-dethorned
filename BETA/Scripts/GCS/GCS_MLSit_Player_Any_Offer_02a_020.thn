...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F02aP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F02aP02_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F02aP02_Trent",
			duration = 1.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.343, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.750,
	...
	{
		0.453, SET_CAMERA, { "Monitor", "Camera/PCO" }
	},
	...
	{
		0.640, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLHAND_NEUT_LEFT_000LV_A_00",
			duration = 4.000,
			trans_time = 0.500,
	...
	{
		0.750, START_SOUND, { "VoiceProfile_GCS_Trent_F02aP02" },
		{
			duration = 0.784
		}
	},
	...
	{
		0.769, START_MOTION, { "Player_Character_P" },
		{
