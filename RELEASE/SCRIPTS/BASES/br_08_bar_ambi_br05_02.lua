...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br08Bar_Br05_02.thn",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.6225, 0.124535, 1.648833 },
			orient  =  { { -0.417032, -0.163835, 0.894004 },
					   { 0.102578, -0.985819, -0.132811 },
					   { 0.903085, 0.036319, 0.427924 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.086275, 0.066667, 0.011765 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.203922, 0.14902, 0.027451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.088868, 0.839199, -0.536514 },
					   { 0.638290, 0.365529, 0.677477 },
					   { 0.764650, -0.402657, -0.503168 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.894118, 0.627451, 0.270588 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.058824, 0.05098, 0.058824 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.970939, -0.165694, -0.172695 },
					   { 0.000000, 0.721581, -0.692330 },
					   { 0.239328, 0.672210, 0.700611 } }
		}
	},

	{
		...
		{
			pos  =  { -34200.98, 0, 0 },
			orient  =  { { -0.961690, 0.000000, 0.274140 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.274140, 0.000000, -0.961690 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.822188, 0.691248, -0.438222 },
			orient  =  { { -0.149993, -0.147317, 0.977650 },
					   { 0.102578, -0.985819, -0.132811 },
					   { 0.983351, 0.080365, 0.162977 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.917647, 0.690196, 0.466667 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.25098, 0.188235, 0.035294 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.973197, 0.003291, 0.229948 },
					   { 0.003345, 0.999994, -0.000156 },
					   { -0.229947, 0.000617, -0.973203 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br08Bar_Br05_02.thn" },
		{
			duration  =  0.000,
			fogprops  = 
			{
