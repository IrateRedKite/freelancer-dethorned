...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_STND_CONV_LHND_EMPH_000LV_XC_01",
			duration = 1.796,
			trans_time = 1.000,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera/ACS", "Camera/ACOH" },
		{
			...
			{
				pos = { -0.130292, 1.787449, 0.58139 },
				q_orient = { 0.839425, 0, 0.543476, 0.115839 }
			},
			param_curve =
			{
	...
	{
		0.281, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.953, START_MOTION, { "Player_Character_P" },
		{
