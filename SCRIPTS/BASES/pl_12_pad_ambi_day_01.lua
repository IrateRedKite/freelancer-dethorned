...
entities =
{
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.313726, 0.278431, 0.380392 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 234, 192, 115 },
			diffuse = { 0.984314, 0.74902, 0.65098 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.792157, 0.705882, 0.65098 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
	...
	{
		entity_name = "ambi_rtc_rh03_sun_3",
		type = PSYS,
		template_name = "rtc_rh03_sun",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC + LIT_AMBIENT,
		spatialprops =
		{
			pos = { -663.3286, 536.3602, 1982.605 },
...
events =
{
	...
	{
		0.000, START_PSYS, { "ambi_rtc_rh03_sun_3" },
		{
			duration = 10000.000
		}
	},
