...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_iw0102",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.948131,  0.317879 },
					   {  0.000000, -0.317879,  0.948131 } }
		}
	},
...

	{
		...
		spatialprops =
		{
			pos = { 0, 0, 0 },
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.991727, -0.128365 },
					   {  0.000000,  0.128365,  0.991727 } }
		}
	},
	...
	{
		entity_name = "ambi_starsphere_Iw01",
		type = COMPOUND,
		...
		{
			pos = { 0, 0, 0 },
			orient = { {  0.871879,  0.000000, -0.489721 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.489721,  0.000000,  0.871879 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_starsphere_Iw01_stars",
		type = COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_iw0102" },
		{
			duration = 0.000,
			fogprops =
			{
