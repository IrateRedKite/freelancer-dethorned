...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D05bP03_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D05bP03",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D05bP03_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D05bP03_Trent",
			duration = 2.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D05bP03" },
		{
			duration = 1.648
		}
	},
	...
	{
		0.515, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		1.149, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.149, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.593, START_MOTION, { "Player_Character_P" },
		{
