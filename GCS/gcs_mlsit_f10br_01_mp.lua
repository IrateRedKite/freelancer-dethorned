...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F10bR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F10bR01_RVP01",
			duration = 1.070,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.171, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.375, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},
	...
	{
		0.750, START_SOUND, { "VoiceProfile_GCS_ML_F10bR01" },
		{
			duration = 0.500
		}
	},
	...
	{
		0.843, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.843, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.203, START_MOTION, { "Offer_Character_A" },
		{
