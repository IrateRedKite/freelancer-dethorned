...
entities =
{
	...
	{
		entity_name = "dx_s019c_0101_Trent_53",
		type = SOUND,
		template_name = "dx_s019c_0101_Trent",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
	...
	{
		entity_name = "dx_s019c_0201_juni_54",
		type = SOUND,
	...
	{
		entity_name = "dx_s019c_0301_Trent_55",
		type = SOUND,
		template_name = "dx_s019c_0301_Trent",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
	...
	{
		entity_name = "dx_s019c_0401_juni_56",
		type = SOUND,
		template_name = "dx_s019c_0401_juni",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
	...
	{
		entity_name = "dx_s019c_0501_Trent_57",
		type = SOUND,
		template_name = "dx_s019c_0501_Trent",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...

	{
		...
		spatialprops =
		{
			pos = { 69.89532, 1.523283, -55.96975 },
...

	{
		...
		spatialprops =
		{
			pos = { 67.73883, 1.659616, -56.88558 },
			orient = { { -0.506462,  0.000000, -0.862262 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.862262,  0.000000, -0.506462 } }
		}
	...
	{
		entity_name = "prop_lootcrate_consumer_03_copy_1",
		type = COMPOUND,
		template_name = "lootcrate_consumer",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC,
...
events =
{
	...
	{
		0.000, SET_CAMERA, { "cam_Monitor_static_cam", "Cam_01_Trent_Cant_Now" }
	},
	...
	{
		1.000, START_SOUND, { "dx_s019c_0101_Trent_53" },
		{
			duration = 1.679
		}
	},
	...
	{
		1.742, SET_CAMERA, { "cam_Monitor_3", "Cam_02_Juni_Trent_I_Need" }
	},
	...
	{
		2.781, START_SOUND, { "dx_s019c_0201_juni_54" },
		{
			duration = 1.572
		}
	},
	...
	{
		4.446, SET_CAMERA, { "cam_Monitor_static_cam", "Cam_01_Trent_Cant_Now" }
	},
	...
	{
		4.500, START_SOUND, { "dx_s019c_0301_Trent_55" },
		{
			duration = 1.358
		}
	},
	...
	{
		5.968, START_SOUND, { "dx_s019c_0401_juni_56" },
		{
			duration = 2.144
		}
	},
	...
	{
		8.186, START_SOUND, { "dx_s019c_0501_Trent_57" },
		{
			duration = 2.210
		}
	},
...

	{
		11.687, START_SPATIAL_PROP_ANIM, { "Char_Juni_LookTrent_Leave", "Char_Juni_LookTrent_Leave_(End)" },
		{
			...
			{
				pos = { 67.73883, 1.659616, -56.88558 },
				q_orient = { -0.506462, 0, -0.862262, 0 }
			},
			param_curve =
			{
	...
	{
		11.946, SET_CAMERA, { "cam_Monitor_static_cam", "Cam_04_Juni_Glare" }
	},

	{
		12.012, START_SPATIAL_PROP_ANIM, { "Cam_04_Juni_Glare", "Cam_04_Juni_Glare_END" },
		{
			...
			{
				pos = { 67.38427, 1.429632, -55.65672 },
				q_orient = { 0.450948, 0, 0.89255, -0.036903 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
