...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F02aP02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F02aP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F02aP01_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_F02aP01_Trent",
			duration = 2.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F02aP01" },
		{
			duration = 1.575
		}
	},
	...
	{
		0.708, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.373,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.945, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.080, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.080, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.128, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
