...
entities =
{
...

	{
		...
		type = COMPOUND,
		template_name = "rtcprop_bw_elite",
...
events =
{
	...
	{
		0.030, START_MOTION, { "Char_br_male_order_pilot_1" },
		{
	...
	{
		7.125, START_IK, { "Char_Ozu", "Char_Trent" },
		{
			duration = 7.061,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		7.875, START_IK, { "Char_Trent", "Char_Ozu" },
		{
			duration = 1.750,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		9.468, SET_CAMERA, { "Cam_Monitor_s046x_static", "Cam_02_A_Trent_walk_static_mon" }
	},
	...
	{
		11.656, SET_CAMERA, { "Cam_Monitor_s046x_static", "Cam_02_C_3shot_Juni" }
	},
	...
	{
		27.000, START_SOUND, { "dx_s046x_0501_juni" },
		{
			duration = 2.861
		}
	},
	...
	{
		54.062, START_SOUND, { "dx_s046x_1201_Ozu" },
		{
			duration = 2.075
		}
	},
...

	{
		61.250, START_SPATIAL_PROP_ANIM, { "Camera_4", "Camera_4_target" },
		{
			...
			{
				pos = { -6.565403, 1.664208, -1.671389 },
				q_orient = { -0.077954, -0.112054, 0.99064, 0.112054 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		68.906, START_SOUND, { "dx_s046x_1501_juni" },
		{
			duration = 3.739
		}
	},
	...
	{
		72.656, START_SOUND, { "dx_s046x_1502_juni" },
		{
			duration = 4.247
		}
	},
...

	{
		75.093, START_SPATIAL_PROP_ANIM, { "Cam_08_Wide_A_Tr_Juni", "Cam_08_Wide_B_Tr" },
		{
			...
			{
				pos = { -9.401748, 0.372183, 5.914023 },
				q_orient = { 0.997161, -0.010458, -0.074564, 0.010458 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		76.406, START_SOUND, { "dx_s046x_1503_juni" },
		{
			duration = 5.170
		}
	},
	...
	{
		80.937, START_MOTION, { "Char_Trent" },
		{
			animation = "Sc_MLBODY_STND_TURN_315LV_XA_02",
			duration = 2.900,
			trans_time = 1.000,
	...
	{
		83.906, START_MOTION, { "Char_Trent" },
		{
	...
	{
		84.062, START_MOTION, { "Char_Trent" },
		{
			animation = "Sc_MLHEAD_NEUT_BLINK_EYES_000LV_A_00",
			duration = 0.266,
			time_scale = 1,
	...
	{
		87.656, START_MOTION, { "Char_Trent" },
		{
			animation = "Sc_MLHEAD_NEUT_BLINK_EYES_000LV_A_00",
			duration = 0.266,
			time_scale = 1,
