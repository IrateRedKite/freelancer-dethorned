...
events =
{
	...
	{
		0.000, ATTACH_ENTITY, { "Offer_Character_A", "Special_A_HeightAdjust" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01hG03" },
		{
			duration = 1.855
		}
	},
	...
	{
		1.093, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.355, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.004,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.360, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.360, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
