...
entities  = 
{
	...
	{
		entity_name  =  "Layer_Pl_09_pad_launch",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 20.86691, 53.12863, 18.24013 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 23.69192, 32.79973, 25.68833 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 39.2051, 9.258832, -45.8826 },
			orient  =  { { -0.973538, -0.005038, -0.228470 },
					   { -0.007194, 0.999937, 0.008608 },
					   { 0.228412, 0.010024, -0.973513 } }
		},
		cameraprops  = 
		{
			fovh  =  24,
...

	{
		...
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ 33.468102, 9.258832, -64.079628 }, { 0.067562, -0.002852, 0.997699, 0.004830 }, { 3.022010, 16.203619, -81.314529 }, { -0.095137, 0.005654, 0.990222, -0.101870 }, { -69.845886, 18.659601, -67.326675 }, { -0.134305, -0.014402, 0.981336, -0.136878 }, "
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 23.66095, 0.001638, 31.21394 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 20.60084, 37.85225, 23.35018 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
	...
	{
		0.375, ATTACH_ENTITY, { "Playership_engine_launch_rumble_snd", "PlayerShip" },
		{
			duration  =  9.024,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		4.030, START_SPATIAL_PROP_ANIM, { "Prop_PlayerShip_Shipcushion_Marker_A" },
		{
			duration  =  3.000,
			target_type  =  ROOT,
			spatialprops  = 
...

	{
		5.560, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_2" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.630065, -0.579237, -0.517207, -0.390922 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		7.406, START_SOUND, { "Playership_engine_launch01_snd" },
		{
			duration  =  4.853
		}
	},
	...
	{
		7.406, ATTACH_ENTITY, { "Playership_engine_launch01_snd", "PlayerShip" },
		{
			duration  =  7.781,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		7.406, START_AUDIO_PROP_ANIM, { "Playership_engine_launch01_snd" },
		{
			duration  =  0.400,
			audioprops  = 
			{
...

	{
		8.031, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_3" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.606121, -0.736597, -0.300071, -0.535404 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		9.843, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_4" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.672746, -0.690565, -0.26558, -0.269957 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		11.406, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		11.406, START_SOUND, { "PlayerShip_engine_playership" },
		{
			duration  =  3.780,
			flags  =  LOOP
		}
	...
	{
		11.406, ATTACH_ENTITY, { "PlayerShip_engine_playership", "PlayerShip" },
		{
			duration  =  3.780,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		13.562, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership" },
		{
			duration  =  1.625,
			audioprops  = 
			{
	...
	{
		13.562, START_AUDIO_PROP_ANIM, { "Playership_engine_rumble_snd" },
		{
			duration  =  1.625,
			audioprops  = 
			{
