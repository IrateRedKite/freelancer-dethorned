...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F05bG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F05bG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
{
	{
		...
		{
			animation = "Sc_dx_GCS_F05bG01_RVP51",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F05bG01" },
		{
			duration = 2.480
		}
	},
	...
	{
		1.980, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.980, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
