...
events =
{
...

	{
		...
		{
			animation = "Sc_FMHAND_HNEUT_GESTL_THUMB_000LV_00",
			duration = 1.500,
			time_scale = 1,
			weight = 1,
			heading = -1
	...
	{
		4.656, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.031,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		5.156, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		5.493, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		5.639, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		5.639, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
