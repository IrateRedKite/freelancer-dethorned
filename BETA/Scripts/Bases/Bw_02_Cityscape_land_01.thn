...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 0.916501, 6.525967, 58.06614 },
...

	{
		...
		spatialprops =
		{
			pos = { -38.11702, 90.60661, 149.4602 },
			orient = { {  0.984646,  0.000000,  0.174563 },
					   {  0.025518,  0.989258, -0.143935 },
					   { -0.172688,  0.146179,  0.974069 } }
		},
		cameraprops =
		{
			fovh = 18,
...
events =
{
...

	{
		3.468, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_02_curve", "Camera_ShipLand_03_lookup" },
		{
			...
			spatialprops =
			{
				pos = { 0.916539, 6.526087, 58.06613 },
				q_orient = { 0.99973, -0.000156, 0.023234, 0.000156 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		3.473, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_02_curve", "Camera_ShipLand_03_lookup" },
		{
			...
			spatialprops =
			{
				pos = { 0.916506, 6.525984, 58.06614 },
				q_orient = { 0.99973, -0.000156, 0.023234, 0.000156 }
			},
			param_curve =
			{
...

	{
		3.812, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_OrientationFollow", "PlyrShip_Mk_flight_ort_03" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.218648, 0, -0.975804, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		9.062, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_OrientationFollow", "PlyrShip_Mk_spin_ort_03" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.827253, 0.015123, 0.561625, -0.015123 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
