...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_rh08Bar_rh0306",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.584314, 0.584314, 0.584314 },
			specular = { 0, 0, 0 },
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.945098, 0.607843, 0.105882 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.654902, 0.501961, 0.270588 },
			specular = { 0, 0, 0 },
			ambient = { 0.921569, 0.47451, 0.262745 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  1.000000,  0.000000,  0.000000 },
					   {  0.000000,  0.923328,  0.384012 },
					   {  0.000000, -0.384012,  0.923328 } }
		}
	},
...
events =
{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_rh08Bar_rh0306" },
		{
			duration = 0.000,
			fogprops =
			{
