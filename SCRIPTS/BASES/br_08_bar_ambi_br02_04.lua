...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br_08_bar_Br02_04",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.486275, 0.466667, 0.627451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { -20000, 0, 0 },
			orient  =  { { 0.994811, 0.000000, 0.101737 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.101737, 0.000000, 0.994811 } }
		}
	},
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.568627, 0.568627, 0.568627 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.152941, 0.152941, 0.152941 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.042578, 0.000000, 0.999093 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.999093, 0.000000, 0.042578 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.607075, 0.000000, 0.794645 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.794645, 0.000000, 0.607075 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br_08_bar_Br02_04" },
		{
			duration  =  0.000,
			fogprops  = 
			{
