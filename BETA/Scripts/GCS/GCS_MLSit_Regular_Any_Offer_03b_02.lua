...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03bR02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.175164, 1.168915, 0.713089 },
			orient = { {  0.857919,  0.000000,  0.513784 },
					   { -0.079865,  0.987845,  0.133358 },
					   { -0.507539, -0.155444,  0.847491 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.548664, 1.953947, -0.315877 },
			orient = { { -0.081196,  0.000000, -0.996698 },
					   { -0.470631,  0.881497,  0.038340 },
					   {  0.878586,  0.472190, -0.071574 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03bR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03bR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03bR02_RVP01",
			duration = 3.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03bR02" },
		{
			duration = 2.861
		}
	},
	...
	{
		1.828, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.319, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.041,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.359, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.359, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
