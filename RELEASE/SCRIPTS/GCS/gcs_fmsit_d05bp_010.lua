...
entities =
{
...

	{
		...
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D05bP01_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		1.281, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		1.350, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.350, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.695, START_MOTION, { "Player_Character_P" },
		{
