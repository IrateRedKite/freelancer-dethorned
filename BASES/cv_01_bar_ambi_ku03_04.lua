...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Ku03_04",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.954708, 0.257437, -0.149194 },
					   { 0.151192, 0.012135, 0.988430 },
					   { 0.256269, -0.966219, -0.027337 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.462745, 0.407843, 0.607843 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.282353, 0.372549, 0.376471 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.982572, 0.153199, 0.105274 },
					   { -0.151517, 0.988167, -0.023843 },
					   { -0.107681, 0.007477, 0.994157 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Ku03_04" },
		{
			duration  =  0.000,
			fogprops  = 
			{
