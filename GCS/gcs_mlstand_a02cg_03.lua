...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A02cG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A02cG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_A02cG03_RVP01",
			duration = 3.832,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.156, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_A02cG03" },
		{
			duration = 3.030
		}
	},
	...
	{
		1.390, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.968, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.171, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.529, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.529, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.015, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		3.234, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
