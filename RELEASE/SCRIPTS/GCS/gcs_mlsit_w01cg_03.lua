...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01cG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01cG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG03_RVP01",
			duration = 2.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.671, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 2.078,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_ML_W01cG03" },
		{
			duration = 1.750
		}
	},
