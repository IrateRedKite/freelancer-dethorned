...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07aP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07aP02_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F07aP02_Trent",
			duration = 1.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.967, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.768,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP02" },
		{
			duration = 0.796
		}
	},
	...
	{
		1.264, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 5.000,
			trans_time = 1.000,
