...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F10aR02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F10aR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F10aR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F10aR02_RVP51",
			duration = 2.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_F10aR02" },
		{
			duration = 1.689
		}
	},
