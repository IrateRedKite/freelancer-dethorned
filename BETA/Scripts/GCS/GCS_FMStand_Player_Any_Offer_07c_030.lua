...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07cP03",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07cP03_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_F07cP03_Trent",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F07cP03" },
		{
			duration = 2.384
		}
	},
	...
	{
		1.629, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.879, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.879, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
