...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D02bP02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -1.047139, 0.950436, 0.61708 },
			orient = { {  0.631403,  0.000000,  0.775455 },
					   { -0.155624,  0.979655,  0.126714 },
					   { -0.759679, -0.200687,  0.618557 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D02bP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D02bP02_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_D02bP02_Trent",
			duration = 4.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.453, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D02bP02" },
		{
			duration = 3.289
		}
	},
	...
	{
		1.468, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.703, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.515, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.789, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.789, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.000, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.790,
			end_effector = "Body_Head",
			count_to_root = 1,
