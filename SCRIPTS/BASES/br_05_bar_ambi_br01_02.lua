...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br05Bar_Br01_02.thn",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { -4718.574, 0, 0 },
			orient  =  { { 0.983396, 0.000000, 0.181472 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.181472, 0.000000, 0.983396 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.931997, -0.136315, 0.335856 },
					   { 0.327678, -0.079229, -0.941462 },
					   { 0.154945, 0.987492, -0.029174 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.501961, 0.32549, 0.168627 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.219608, 0.129412, 0.152941 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Br01_5",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, -1.417856, 0 },
			orient  =  { { 0.680726, 0.000000, 0.732539 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.732539, 0.000000, 0.680726 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Br01_stars_6",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br05Bar_Br01_02.thn" },
		{
			duration  =  0.000,
			fogprops  = 
			{
