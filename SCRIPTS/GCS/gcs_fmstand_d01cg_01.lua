...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01cG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01cG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01cG01_RVP51",
			duration = 3.665,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01cG01" },
		{
			duration = 3.095
		}
	},
	...
	{
		1.234, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.375, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.599, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.599, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.625, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.973,
			end_effector = "Body_Head",
			count_to_root = 1,
