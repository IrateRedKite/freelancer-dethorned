...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br_08_bar_Br06_04",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.376471, 0.345098, 0.290196 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  99.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { -30000, 3000, 0 },
			orient  =  { { 0.987996, 0.000000, 0.154482 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.154482, 0.000000, 0.987996 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.860674, -0.377056, 0.342154 },
					   { -0.508363, 0.673882, -0.536143 },
					   { -0.028415, -0.635383, -0.771675 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.372549, 0.603922, 0.839216 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.25098, 0.101961, 0.145098 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 174, 232, 249 },
			diffuse  =  { 0.984314, 0.956863, 0.85098 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0, 0, 0 },
			direction  =  { 0, 0, 1 },
			range  =  8,
	...
	{
		entity_name  =  "ambi_starsphere_Br06_3",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br06",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.874381, 0.087179, -0.477345 },
					   { -0.140739, 0.987005, -0.077541 },
					   { 0.464382, 0.134982, 0.875288 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Br06_stars_4",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br06_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br_08_bar_Br06_04" },
		{
			duration  =  0.000,
			fogprops  = 
			{
