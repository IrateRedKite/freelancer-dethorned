...
entities =
{
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 182, 206, 231 },
			diffuse = { 0.7137255, 0.8078432, 0.9058824 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 12,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 23, 142, 17 },
			diffuse = { 0.09019608, 0.5568628, 0.06666667 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 4,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 174, 232, 249 },
			diffuse = { 0.682353, 0.909804, 0.9764706 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 197, 222, 192 },
			diffuse = { 0.7725491, 0.8705883, 0.7529413 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 2000,
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 205, 193, 156 },
			diffuse = { 0.8039216, 0.7568628, 0.6117647 },
			specular = { 0, 0, 0 },
			ambient = { 0, 0, 0 },
			direction = { 0, 0, 1 },
			range = 4,
