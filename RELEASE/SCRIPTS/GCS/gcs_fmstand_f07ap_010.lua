...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07aP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07aP01_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.265, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
...

	{
		...
		{
			animation = "Sc_dx_GCS_F07aP01_Trent",
			duration = 1.332,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.779, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.779, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP01" },
		{
			duration = 0.778
		}
	}
