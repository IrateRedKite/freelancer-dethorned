...
events =
{
	...
	{
		0.343, SET_CAMERA, { "Monitor", "Camera/PC2" }
	},

	{
		0.406, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.210, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.210, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
