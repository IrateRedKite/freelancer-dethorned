...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -72.48185, 0.118781, -40.59785 },
			orient  =  { { -0.371714, -0.000051, 0.928347 },
					   { 0.000100, 1.000000, 0.000095 },
					   { -0.928347, 0.000128, -0.371714 } }
		},
	...
	{
		entity_name  =  "Cam_Monitor_ShipLaunch",
		type  =  MONITOR,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -73.36872, 0.266059, -39.11861 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -75.37469, 83.09605, -40.36658 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
	...
	{
		entity_name  =  "Camera_ShipLaunch_01_copy_1",
		type  =  CAMERA,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
...
events  = 
{
	...
	{
		0.000, SET_CAMERA, { "Cam_Monitor_ShipLaunch", "Camera_ShipLaunch_01" }
	},
...

	{
		0.187, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Mk_Chase_Marker" },
		{
			...
			spatialprops  = 
			{
				pos  =  { -259.8339, 158.4058, -342.8591 },
				q_orient  =  { -0.593853, -0.103049, -0.797947, -0.144437 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		0.187, START_SPATIAL_PROP_ANIM, { "Mk_Chase_Marker", "Mk_Second_Landing_Pad_Ascent_Mk" },
		{
			...
			{
				pos  =  { -76.62335, 134.6553, -41.14341 },
				q_orient  =  { -0.00783, 0.016764, -0.999829, 0.063858 }
			}
		}
	},
...

	{
		1.062, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_01", "Camera_ShipLaunch_02" },
		{
			...
			{
				pos  =  { -205.0544, 139.9278, -484.5736 },
				q_orient  =  { -0.390044, -0.411902, 0.82353, -0.260798 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		1.062, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_01_copy_1", "Camera_ShipLaunch_02" },
		{
			duration  =  11.687,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		6.435, ATTACH_ENTITY, { "Playership_engine_launch03_snd", "PlayerShip" },
		{
			duration  =  6.531,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		6.436, START_AUDIO_PROP_ANIM, { "Playership_engine_launch03_snd" },
		{
			duration  =  0.400,
			audioprops  = 
			{
	...
	{
		6.436, START_SOUND, { "Playership_engine_launch03_snd" },
		{
			duration  =  6.531
		}
	},
...

	{
		7.185, START_SPATIAL_PROP_ANIM, { "Mk_Second_Landing_Pad_Target", "Mk_Second_Landing_Pad_Target_Tillt" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.991144, 0.096841, 0.09086, 0.098934 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		10.625, START_SOUND, { "PlayerShip_engine_playership_1" },
		{
			duration  =  2.342,
			flags  =  LOOP
		}
	...
	{
		10.625, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership_1" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		10.625, ATTACH_ENTITY, { "PlayerShip_engine_playership_1", "PlayerShip" },
		{
			duration  =  2.342,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		17.125, SET_CAMERA, { "Cam_Monitor_ShipLaunch", "Camera_ShipLaunch_03" }
	}
};
