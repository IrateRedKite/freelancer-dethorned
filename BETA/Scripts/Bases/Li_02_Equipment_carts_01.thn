...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 8.014632, 0.990285, -29.84599 },
...
events =
{
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera_Carts_01", "Camera_Carts_02" },
		{
			...
			{
				pos = { 47.0214, 10.96953, 5.273986 },
				q_orient = { 0.013564, -0.048186, 0.998746, 0.048186 }
			},
			param_curve =
			{
	...
	{
		0.000, ATTACH_ENTITY, { "Equip_g_heavytractorbeam", "Cart_Li_Engine" },
		{
			duration = 7.000,
			offset = { 0, 0.575, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Equip_l_auto01", "Cart_Li_Shield_Thrust" },
		{
			duration = 7.000,
			offset = { 0, 0.09, 0.3 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Equip_l_torp01", "Cart_Li_Gun" },
		{
			duration = 7.000,
			offset = { 0, 0, 0.4 },
			up = Y_AXIS,
	...
	{
		0.100, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion", "gf_rtc_shipcushion_3_copy_1" },
		{
			duration = 0.100,
			target_part = "",
			target_type = ROOT,
...

	{
		0.500, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_ort_01" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.992366, -0.086263, -0.088135, -0.086263 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		0.500, START_SPATIAL_PROP_ANIM, { "PlayerShip", "PlyrShip_Mk_Follow" },
		{
			...
			spatialprops =
			{
				pos = { 8.018066, 0.265281, -29.93459 },
				q_orient = { -0.994455, 0.057258, -0.088211, 0.057258 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		1.375, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_ort_02" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.994439, 0.057576, -0.088183, 0.057576 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		1.750, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion", "gf_rtc_shipcushion_3_copy_1" },
		{
			duration = 3.000,
			target_part = "",
			target_type = ROOT,
...

	{
		2.250, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_JustBelow" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.995655, 0, -0.093117, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
