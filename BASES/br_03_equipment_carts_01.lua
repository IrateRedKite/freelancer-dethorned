...
entities  = 
{
	...
	{
		entity_name  =  "Cart_Br_Engine_engine_loop_14",
		type  =  SOUND,
	...
	{
		entity_name  =  "Cart_Br_Engine_engine_start_15",
		type  =  SOUND,
	...
	{
		entity_name  =  "Cart_Br_Engine_engine_stop_16",
		type  =  SOUND,
	...
	{
		entity_name  =  "Cart_Br_Gun_engine_loop_14",
		type  =  SOUND,
		template_name  =  "equipment_cart_loop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Br_Shield_Thrust_engine_loop_14",
		type  =  SOUND,
		template_name  =  "equipment_cart_loop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Br_Gun_engine_start_15",
		type  =  SOUND,
		template_name  =  "equipment_cart_start",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Br_Shield_Thrust_engine_start_15",
		type  =  SOUND,
		template_name  =  "equipment_cart_start",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Br_Gun_engine_stop_16",
		type  =  SOUND,
		template_name  =  "equipment_cart_stop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Br_Shield_Thrust_engine_stop_16",
		type  =  SOUND,
		template_name  =  "equipment_cart_stop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
...
{
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Shield_Thrust_engine_stop_16", "Cart_Br_Shield_Thrust" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Shield_Thrust_engine_start_15", "Cart_Br_Shield_Thrust" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Shield_Thrust_engine_loop_14", "Cart_Br_Shield_Thrust" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Gun_engine_stop_16", "Cart_Br_Gun" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Gun_engine_loop_14", "Cart_Br_Gun" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Gun_engine_start_15", "Cart_Br_Gun" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, START_SOUND, { "Cart_Br_Gun_engine_start_15" },
		{
			duration  =  1.427
		}
	},
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Engine_engine_stop_16", "Cart_Br_Engine" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Engine_engine_start_15", "Cart_Br_Engine" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Br_Engine_engine_loop_14", "Cart_Br_Engine" },
		{
			duration  =  11.250,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
...

	{
		0.312, START_SPATIAL_PROP_ANIM, { "Camera_Carts_01_lookincave", "Camera_Carts_02_lookoutcave" },
		{
			...
			{
				pos  =  { -25.69888, 4.085674, -16.004 },
				q_orient  =  { -0.552848, 0, 0.833282, -0.053776 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		1.187, START_SOUND, { "Cart_Br_Shield_Thrust_engine_start_15" },
		{
			duration  =  1.427
		}
	},
	...
	{
		1.427, START_SOUND, { "Cart_Br_Gun_engine_loop_14" },
		{
			duration  =  5.789,
			flags  =  LOOP
		}
	...
	{
		1.812, START_SOUND, { "Cart_Br_Engine_engine_start_15" },
		{
			duration  =  1.427
		}
	},
...

	{
		2.312, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_GoTo" },
		{
			...
			{
				pos  =  { 4, 2.1145, 0 },
				q_orient  =  { -0.006118, 0.020137, -0.999779, 0 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		2.614, START_SOUND, { "Cart_Br_Shield_Thrust_engine_loop_14" },
		{
			duration  =  3.914,
			flags  =  LOOP
		}
...

	{
		3.062, START_SPATIAL_PROP_ANIM, { "PlayerShip", "PlyrShip_Mk_Follow" },
		{
			...
			{
				pos  =  { 0, -0.261961, 0 },
				q_orient  =  { 0.001709, 0.006645, -0.999977, 9e-006 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		3.240, START_SOUND, { "Cart_Br_Engine_engine_loop_14" },
		{
			duration  =  2.161,
			flags  =  LOOP
		}
	...
	{
		4.059, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_JustAbove" },
		{
			duration  =  0.750,
			target_part  =  "",
			target_type  =  ROOT,
			spatialprops  = 
			{
				q_orient  =  { 0.003957, 0, -0.999992, 0 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		5.402, START_SOUND, { "Cart_Br_Engine_engine_stop_16" },
		{
			duration  =  1.659
		}
	},

	{
		5.750, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_ort_01" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.01638, -0.032753, -0.999329, -0.000795 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		6.528, START_SOUND, { "Cart_Br_Shield_Thrust_engine_stop_16" },
		{
			duration  =  1.659
		}
	},
	...
	{
		7.216, START_SOUND, { "Cart_Br_Gun_engine_stop_16" },
		{
			duration  =  1.659
		}
	},

	{
		7.250, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_Follow", "PlyrShip_Mk_ort_02" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.004398, 0.024701, -0.999685, 0.000109 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
