...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.804743,  0.000000,  0.593623 },
	...
	{
		entity_name = "Char_Trent_Mrk_Lookat_Walkup_end",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 2.153334, 1.336725, -4.325171 },
			orient = { {  0.760878,  0.000000, -0.648895 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.648895,  0.000000,  0.760878 } }
		}
...
events =
{
	...
	{
		0.062, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_ml_hard01" },
		{
			duration = 0.500,
			audioprops =
			{
...

	{
		1.031, START_SPATIAL_PROP_ANIM, { "Cam_A_Master", "Cam_A_Mrk_Spatical" },
		{
			...
			spatialprops =
			{
				pos = { 2.133761, 1.671253, -4.017007 },
				q_orient = { -0.175279, -0.002543, 0.984515, 0.165606 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		2.843, START_IK, { "Char_Trent", "Ship_bw_freighter" },
		{
			duration = 1.812,
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_ml_hard02" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_ml_hard03" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_ml_hard04" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_mr_hard01" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_mr_hard02" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_mr_hard03" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_mr_hard04" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fx_fstop_male01" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fx_fstop_male04" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.434, START_AUDIO_PROP_ANIM, { "Char_Trent_fx_fturn_male01" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.435, START_AUDIO_PROP_ANIM, { "Char_Trent_fs_ml_hard01" },
		{
			duration = 4.438,
			audioprops =
			{
	...
	{
		4.875, START_IK, { "Char_Trent", "Char_Juni" },
		{
			duration = 1.505,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		5.843, START_IK, { "Char_Juni", "Char_Trent" },
		{
			duration = 1.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		6.435, START_IK, { "Char_Trent", "Char_Trent_Mrk_Lookat_Walkup" },
		{
			duration = 4.108,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		6.500, START_AUDIO_PROP_ANIM, { "Ship_engine_li_small_1" },
		{
			duration = 7.812,
			audioprops =
			{
			...
			param_curve =
			{
				...
				{
					{  0.000000,  0.000000,  0.000000,  0.000000 },
					{  0.602564,  0.394231,  1.636364,  1.500000 },
					{  1.000000,  1.000000,  0.000000,  0.000000 },
				}
			},
			pcurve_period = -1000
	...
	{
		7.031, START_IK, { "Char_Trent", "Char_Juni" },
		{
			duration = 4.187,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		7.500, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mrk_Lookat_Walkup", "Char_Trent_Mrk_Lookat_Walkup_end" },
		{
			duration = 1.750,
			target_part = "",
			target_type = ROOT,
...

	{
		7.750, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mrk_Looks_Left", "Char_Trent_Mrk_Lookat_Walkup" },
		{
			...
			spatialprops =
			{
				pos = { 2.459052, 1.336725, -3.204988 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		11.218, START_MOTION, { "Char_Trent" },
		{
	...
	{
		12.875, SET_CAMERA, { "Cam_Monitor_s014a", "Cam_B_CU_Juni" }
	},

	{
		12.875, ATTACH_ENTITY, { "Char_Juni_glass_metal_1", "Char_Juni_Mrk_glass_B" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		12.875, SET_CAMERA, { "Cam_Monitor_s014a_static", "Cam_B_CU_Juni" }
	},
...

	{
		17.625, START_SPATIAL_PROP_ANIM, { "Cam_B_CU_Juni", "Cam_B_CU_Juni_Push_In" },
		{
			...
			{
				pos = { 3.109403, 1.307748, -2.780301 },
				q_orient = { 0.685606, 0.249668, 0.68382, -0.719164 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		21.166, START_SPATIAL_PROP_ANIM, { "Char_Trent", "Char_Trent_Mrk_Sit" },
		{
			...
			{
				pos = { 4.11454, 0, -3.030359 },
				q_orient = { 0.791432, 0, -0.611257, 0 }
			}
		}
	},
