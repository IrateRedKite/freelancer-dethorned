...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F01jG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F01jG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F01jG02_RVP51",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.179, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F01jG02" },
		{
			duration = 2.140
		}
	},
	...
	{
		1.077, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.639, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.639, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.799, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.800,
			end_effector = "Body_Head",
			count_to_root = 1,
