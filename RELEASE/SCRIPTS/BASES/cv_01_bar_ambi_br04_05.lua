...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Br04_05",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.082353, 0.023529, 0.007843 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.943891, 0.330256 },
					   { 0.000000, -0.330256, 0.943891 } }
		}
	},

	{
		...
		{
			pos  =  { -20000, 0, 0 },
			orient  =  { { 0.993121, 0.000000, 0.117090 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.117090, 0.000000, 0.993121 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.876854, -0.480756 },
					   { 0.000000, 0.480756, 0.876854 } }
		}
	},

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.792157, 0.52549, 0.168627 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.168627, 0.101961, 0.043137 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.996078, 0.803922, 0.360784 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 1, 0.501961, 0.133333 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.997550, 0.042843, 0.055302 },
					   { 0.042740, 0.999082, -0.003056 },
					   { -0.055383, -0.000684, -0.998465 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Br04_05" },
		{
			duration  =  0.000,
			fogprops  = 
			{
