...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01aV03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01aV03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
{
	{
		...
		{
			animation = "Sc_dx_GCS_W01aV03_RVP01",
			duration = 1.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.108, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.501,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.671, START_SOUND, { "VoiceProfile_GCS_ML_W01aV03" },
		{
			duration = 0.934
		}
	},
	...
	{
		0.687, START_MOTION, { "Offer_Character_A" },
		{
