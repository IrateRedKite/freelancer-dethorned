...
entities =
{
	...
	{
		entity_name = "Layer_GCS_W04aP02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_W04aP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_W04aP02_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W04aP02_Trent",
			duration = 2.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_W04aP02" },
		{
			duration = 1.861
		}
	},
	...
	{
		0.593, START_MOTION, { "Player_Character_P" },
		{
