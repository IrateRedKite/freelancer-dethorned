...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W03aF03_1",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W03aF03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_W03aF03_RVP01",
			duration = 1.500,
			trans_time = 0.200,
			time_scale = 1,
			weight = 1,
	...
	{
		0.170, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.419, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_W03aF03_1" },
		{
			duration = 0.919
		}
	},
	...
	{
		0.906, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.513,
			end_effector = "Body_Head",
			count_to_root = 1,
