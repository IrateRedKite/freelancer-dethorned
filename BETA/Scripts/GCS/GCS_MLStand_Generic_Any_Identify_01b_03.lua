...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01bG03_1",
		type = SOUND,
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01bG03_1" },
		{
			duration = 3.029
		}
	},
	...
	{
		2.906, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLHAND_NEUT_RGHT_000LV_A_00",
			duration = 4.000,
			trans_time = 0.500,
