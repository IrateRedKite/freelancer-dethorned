...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.482081, 1.331641, 0.770517 },
			orient = { {  0.619772,  0.000000, -0.784782 },
					   { -0.159013,  0.979257, -0.125578 },
					   {  0.768504,  0.202620,  0.606916 } }
		},
		cameraprops =
		{
			fovh = 30,
...
events =
{
	...
	{
		1.331, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
