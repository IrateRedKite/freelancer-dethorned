...
entities  = 
{

	{
		...
		spatialprops  = 
		{
			pos  =  { -1624.469, -27.83222, 74.53165 },
	...
	{
		entity_name  =  "Layer_Pl_07_Pad_Traffic",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -337.6671, 80.63914, -400.1314 },
			orient  =  { { -0.966525, 0.004686, -0.256531 },
					   { 0.023983, 0.997106, -0.072147 },
					   { 0.255450, -0.075884, -0.963840 } }
		},
		pathprops  = 
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ -727.250977, 51.555489, 1214.519287 }, { 0.989561, -0.037839, 0.139004, 0.003919 }, { -852.921265, -187.855133, -2191.335449 }, { 0.989561, -0.037845, 0.138998, 0.003920 }, "
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -322.4192, 117.9352, -390.5586 },
			orient  =  { { -0.964933, 0.004651, -0.262454 },
					   { 0.024392, 0.997106, -0.072009 },
					   { 0.261360, -0.075886, -0.962254 } }
		},
		pathprops  = 
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ 31.254318, 89.361900, 717.435120 }, { 0.989563, -0.037846, 0.138987, 0.003926 }, { -903.063782, 23.954479, -1139.369141 }, { 0.989564, -0.037853, 0.138977, 0.003927 }, "
		}
	},
	...
	{
		entity_name  =  "Ship_k_freighter_1_gf_ku_smallengine03_fire_snd",
		type  =  PSYS,
	...
	{
		entity_name  =  "Ship_l_elite_1_engine_li_small_1_snd",
		type  =  SOUND,
	...
	{
		entity_name  =  "Ship_k_freighter_1_engine_ku_small_2_snd",
		type  =  SOUND,
...
events  = 
{
	...
	{
		0.000, ATTACH_ENTITY, { "Ship_l_elite_1_engine_li_small_1_snd", "Ship_l_elite_1" },
		{
			duration  =  59.500,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Ship_k_freighter_1_gf_ku_smallengine03_fire_snd", "Ship_k_freighter_1" },
		{
			duration  =  59.875,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Ship_k_freighter_1_engine_ku_small_2_snd", "Ship_k_freighter_1" },
		{
			duration  =  59.625,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, START_SOUND, { "Ship_B_freighter_1_engine_br_small_1" },
		{
			duration  =  58.000,
			flags  =  LOOP
		}
	...
	{
		0.000, START_PSYS, { "Ship_B_freighter_1_gf_br_smallengine03_2" },
		{
			duration  =  13.125
		}
	},
	...
	{
		0.000, START_PSYS, { "Ship_l_fighter_1_gf_li_smallengine01_fire_4" },
		{
			duration  =  56.875
		}
	},
	...
	{
		0.000, ATTACH_ENTITY, { "Ship_l_fighter_1_gf_li_smallengine01_fire_4", "Ship_l_fighter_1" },
		{
			duration  =  58.750,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.061, ATTACH_ENTITY, { "Ship_civ_freighter_engine_nd_small_1", "Ship_civ_freighter" },
		{
			duration  =  56.812,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.437, START_SOUND, { "Ship_k_freighter_1_engine_ku_small_2_snd" },
		{
			duration  =  59.000,
			flags  =  LOOP
		}
	...
	{
		2.500, START_PSYS, { "Ship_l_elite_1_gf_li_smallengine02_fire_12" },
		{
			duration  =  30.000
		}
	},
	...
	{
		3.125, START_PSYS, { "Ship_l_elite_1_gf_li_smallengine02_fire_1" },
		{
			duration  =  30.000
		}
	},
	...
	{
		3.437, START_PATH_ANIMATION, { "Ship_l_elite_1", "Path_Hwy_4" },
		{
			duration  =  29.062,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		3.750, START_SOUND, { "Ship_l_elite_1_engine_li_small_1_snd" },
		{
			duration  =  55.625,
			flags  =  LOOP
		}
	...
	{
		5.625, START_PSYS, { "Ship_civ_freighter_gf_ci_smallengine01_fire_1" },
		{
			duration  =  24.687
		}
	},
	...
	{
		5.937, START_PATH_ANIMATION, { "Ship_l_fighter_1", "Path_Hwy_4" },
		{
			duration  =  30.937,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		6.092, START_PATH_ANIMATION, { "Ship_l_fighter_2", "Path_Hwy_4" },
		{
			duration  =  45.153,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		6.250, START_PSYS, { "Ship_k_freighter_1_gf_ku_smallengine03_fire_6" },
		{
			duration  =  51.250
		}
	},
	...
	{
		6.875, START_PSYS, { "Ship_k_freighter_1_gf_ku_smallengine03_fire_snd" },
		{
			duration  =  50.625
		}
	},
	...
	{
		20.625, START_PSYS, { "Ship_B_freighter_1_gf_br_smallengine03_1" },
		{
			duration  =  35.937
		}
	},
	...
	{
		20.625, START_PSYS, { "Ship_B_freighter_1_gf_br_smallengine03_2" },
		{
			duration  =  35.937
		}
	},
	...
	{
		29.687, START_SPATIAL_PROP_ANIM, { "Ship_civ_freighter", "Marker_Ship_Park" },
		{
			duration  =  0.008,
			target_part  =  "",
			target_type  =  ROOT,
			spatialprops  = 
			{
				pos  =  { -883.8681, -27.83222, -48.55383 }
			}
		}
	},

	{
		32.500, START_SPATIAL_PROP_ANIM, { "Ship_l_elite_1", "Marker_Ship_Park" },
		{
			duration  =  0.008,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		33.125, START_SPATIAL_PROP_ANIM, { "Ship_l_fighter_2", "Marker_Ship_Park" },
		{
			duration  =  0.008,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		33.125, ATTACH_ENTITY, { "Ship_l_fighter_1_engine_li_small_2", "Ship_l_fighter_1" },
		{
			duration  =  26.312,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		33.125, START_SOUND, { "Ship_l_fighter_1_engine_li_small_2" },
		{
			duration  =  26.375,
			flags  =  LOOP
		}
	...
	{
		34.999, START_PSYS, { "Ship_l_elite_1_gf_li_smallengine02_fire_1" },
		{
			duration  =  22.500
		}
	},
	...
	{
		34.999, START_PSYS, { "Ship_l_elite_1_gf_li_smallengine02_fire_12" },
		{
			duration  =  22.500
		}
	},
	...
	{
		35.624, START_PSYS, { "Ship_l_fighter_2_gf_li_smallengine01_fire_16" },
		{
			duration  =  21.875
		}
	},
	...
	{
		35.625, START_PATH_ANIMATION, { "Ship_l_fighter_2", "Path_Hwy_4_Return" },
		{
			duration  =  31.364,
			start_percent  =  1,
			stop_percent  =  0,
	...
	{
		36.250, START_PSYS, { "Ship_civ_freighter_gf_ci_smallengine01_fire_1" },
		{
			duration  =  20.625
		}
	},
	...
	{
		36.875, START_SPATIAL_PROP_ANIM, { "Ship_l_fighter_1", "Marker_Ship_Park" },
		{
			duration  =  0.008,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		39.375, START_PATH_ANIMATION, { "Ship_l_fighter_1", "Path_Hwy_4" },
		{
			duration  =  21.250,
			start_percent  =  1,
			stop_percent  =  0,
