...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 51.36995, 129.1756, 95.27295 },
			orient  =  { { 0.999123, 0.000000, -0.041868 },
					   { 0.007155, 0.985290, 0.170741 },
					   { 0.041252, -0.170890, 0.984426 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 9.595805, 77.39213, 54.37142 },
			orient  =  { { 0.999268, 0.000000, -0.038248 },
					   { 0.002788, 0.997340, 0.072838 },
					   { 0.038146, -0.072891, 0.996610 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -16.6542, 27.08843, 70.1526 },
			orient  =  { { 0.999722, 0.000000, 0.023558 },
					   { -0.001269, 0.998547, 0.053870 },
					   { -0.023523, -0.053885, 0.998270 } }
		},
		cameraprops  = 
		{
			fovh  =  25,
	...
	{
		entity_name  =  "Camera_ShipLand_PATH",
		type  =  MOTION_PATH,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		...
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ -0.000001, 0.000004, 0.000004 }, { 1.000000, 0.000000, 0.000000, 0.000000 }, { -40.025059, -58.304157, -33.138504 }, { 0.998779, -0.049368, -0.001798, 0.000221 }, { -66.912773, -105.361214, -10.089540 }, { 0.997731, -0.058846, -0.032506, 0.003683 }, "
		}
	}
};
...
{
	{
		0.000, START_PATH_ANIMATION, { "Camera_ShipLand_01", "Camera_ShipLand_PATH" },
		{
			duration  =  15.000,
			start_percent  =  0,
			stop_percent  =  1,
			...
			param_curve  = 
			{
				...
				points  = 
				{
					...
					{ 0.201923, 0.041667, 0.350000, 0.578947 },
					{ 0.721154, 0.919872, 0.916667, 0.800000 },
	...
	{
		0.000, START_SOUND, { "engine_playership_land_rumble_snd" },
		{
			duration  =  9.112
		}
	},
	...
	{
		0.100, START_SPATIAL_PROP_ANIM, { "ambi_gf_rtc_shipcushion_MKR" },
		{
			duration  =  0.100,
			target_type  =  ROOT,
			spatialprops  = 
	...
	{
		0.875, ATTACH_ENTITY, { "engine_playership_land_snd", "PlayerShip" },
		{
			duration  =  5.199,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.875, START_SOUND, { "engine_playership_land_snd" },
		{
			duration  =  5.165
		}
	},
	...
	{
		0.906, START_AUDIO_PROP_ANIM, { "engine_playership_land_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
	...
	{
		4.375, START_SOUND, { "engine_playership_land_turbine_snd" },
		{
			duration  =  10.251
		}
	},
	...
	{
		4.375, ATTACH_ENTITY, { "engine_playership_land_turbine_snd", "PlayerShip" },
		{
			duration  =  10.324,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		4.375, START_AUDIO_PROP_ANIM, { "engine_playership_land_turbine_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
...

	{
		10.812, START_SPATIAL_PROP_ANIM, { "MK_Follow_to_land", "MK_down_drift_left" },
		{
			...
			{
				pos  =  { -16.75497, 33.21017, 14.29484 },
				q_orient  =  { -0.521387, 0.05647, 0.85145, 0.467726 }
			}
		}
	},

	{
		10.937, START_SPATIAL_PROP_ANIM, { "ambi_gf_rtc_shipcushion_MKR" },
		{
			duration  =  5.000,
			target_type  =  ROOT,
			spatialprops  = 
	...
	{
		10.968, START_AUDIO_PROP_ANIM, { "engine_playership_rumble_snd" },
		{
			duration  =  8.406,
			audioprops  = 
			{
...

	{
		12.093, START_SPATIAL_PROP_ANIM, { "MK_Follow_to_land", "MK_down_drift_right" },
		{
			...
			{
				pos  =  { -16.66073, 27.8027, 14.33084 },
				q_orient  =  { 0.1485, 0.120809, 0.981506, -0.543765 }
			}
		}
	},
...

	{
		13.484, START_SPATIAL_PROP_ANIM, { "MK_Follow_to_land", "X/Shipcentre/01_(EX)" },
		{
			...
			{
				pos  =  { -16.6325, 22.17973, 14.26554 },
				q_orient  =  { -0.061481, 0, 0.998108, 0 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		17.250, ATTACH_ENTITY, { "engine_playership_kill_snd", "PlayerShip" },
		{
			duration  =  3.218,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		17.365, START_SOUND, { "engine_playership_kill_snd" },
		{
			duration  =  1.544
		}
	},
	...
	{
		18.921, START_AUDIO_PROP_ANIM, { "engine_playership_kill_snd" },
		{
			duration  =  0.000,
			audioprops  = 
			{
	...
	{
		18.968, START_SOUND, { "engine_playership_kill_snd" },
		{
			duration  =  0.100
		}
	}
