...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03bR_03",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03bR03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03bR03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03bR03_RVP01",
			duration = 3.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03bR03" },
		{
			duration = 2.525
		}
	},
	...
	{
		1.774, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.246,
			end_effector = "Body_Head",
			count_to_root = 1,
