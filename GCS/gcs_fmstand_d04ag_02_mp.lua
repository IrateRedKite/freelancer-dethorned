...
events =
{
	...
	{
		2.265, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.618, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 2.161,
			trans_time = 0.800,
	...
	{
		2.730, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.730, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
