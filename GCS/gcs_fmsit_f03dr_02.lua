...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F03dR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F03dR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03dR02_RVP51",
			duration = 3.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_CONV_RHND_CASL_000LV_xb_02",
			duration = 2.000,
			trans_time = 0.700,
			time_scale = 0.6,
			weight = 1,
	...
	{
		0.592, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			duration = 2.500,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 1.571723, 1.76305, -0.176165 },
				q_orient = { 0.923672, -0.085397, 0.373546, 0.057427 }
			},
			param_curve =
			{
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_F03dR02" },
		{
			duration = 2.767
		}
	},
	...
	{
		2.084, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.125, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.365, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.006,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.369, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.369, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
