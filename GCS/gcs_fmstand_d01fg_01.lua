...
events =
{
	...
	{
		0.030, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.898, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.722,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.619, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
