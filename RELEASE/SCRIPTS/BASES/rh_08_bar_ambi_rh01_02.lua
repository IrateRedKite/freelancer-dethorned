...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_Rh08Bar_rh0102",
		type = SCENE,
		template_name = "",
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { {  0.999810,  0.000000,  0.019492 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.019492,  0.000000,  0.999810 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Rh08Bar_rh0102" },
		{
			duration = 0.000,
			fogprops =
			{
