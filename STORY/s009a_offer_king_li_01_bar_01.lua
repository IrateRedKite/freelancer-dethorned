...
entities =
{
	...
	{
		entity_name = "ambi_LtG01_Direct_Warm",
		type = LIGHT,
		template_name = "",
		lt_grp = 1, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Ambi_LtG01_Direct_Cool",
		type = LIGHT,
		template_name = "",
		lt_grp = 1, srt_grp = 0, usr_flg = 0,
		spatialprops =
	...
	{
		entity_name = "Char_Juni_fs_fr_hard02_2",
		type = SOUND,
	...
	{
		entity_name = "Char_Juni_sfx_fstop_female03_3",
		type = SOUND,
...
events =
{
...

	{
		0.305, START_SPATIAL_PROP_ANIM, { "Cam_A_Wide_Pan_King_1", "Cam_A_Wide_Pan_King_2" },
		{
			...
			{
				pos = { -0.55938, 1.899897, 2.849385 },
				q_orient = { -0.326733, -0.192486, 0.925308, 0.192486 }
			},
			param_curve =
			{
...

	{
		0.306, START_SPATIAL_PROP_ANIM, { "Char_King_Mrk_Look_Trent", "Char_King_Mrk_Look_Trent_Nod" },
		{
			...
			{
				pos = { -3.206007, 1.573037, 2.068675 },
				q_orient = { 0.625437, 0, -0.780274, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		2.531, START_SOUND, { "Char_Juni_sfx_fturn_female03_1" },
		{
			duration = 0.266
		}
	},
	...
	{
		2.968, START_SOUND, { "Char_Juni_fs_fr_hard02_2" },
		{
			duration = 0.300
		}
	},
...

	{
		...
		{
			animation = "Sc_MLBODY_STND_DRINK_LHND_SIP_000LV_XB_06",
			duration = 5.966,
			trans_time = 1.000,
			time_scale = 1,
			weight = 1,
	...
	{
		3.875, START_SOUND, { "Char_Juni_sfx_fstop_female03_3" },
		{
			duration = 0.057
		}
	},
	...
	{
		5.415, START_SOUND, { "Char_King_fx_slurp_glass01_1" },
		{
			duration = 0.981
		}
	},
	...
	{
		6.396, START_SOUND, { "sfx_gulp01_4" },
		{
			duration = 1.281,
			flags = LOOP
		}
