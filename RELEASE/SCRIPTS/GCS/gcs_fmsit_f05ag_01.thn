...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F05aG01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -1.070192, 0.933021, 0.587916 },
			orient = { {  0.585572,  0.000000,  0.810620 },
					   { -0.172481,  0.977101,  0.124596 },
					   { -0.792058, -0.212777,  0.572163 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F05aG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F05aG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F05aG01_RVP51",
			duration = 3.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.468, SET_CAMERA, { "Monitor_1", "Camera/ACOH" }
	},

	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F05aG01" },
		{
			duration = 2.390
		}
	},
	...
	{
		0.867, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.890, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.468,
	...
	{
		1.734, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.889, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.889, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.937, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.953,
			end_effector = "Body_Head",
			count_to_root = 1,
