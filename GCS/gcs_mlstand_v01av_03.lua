...
entities =
{
	...
	{
		entity_name = "Layer_GCS_V01aV_03",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_V01aV03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_V01aV03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_V01aV03_RVP01",
			duration = 3.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_V01aV03" },
		{
			duration = 2.756
		}
	},
	...
	{
		0.718, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.975, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.259, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.259, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.421, START_MOTION, { "Offer_Character_A" },
		{
