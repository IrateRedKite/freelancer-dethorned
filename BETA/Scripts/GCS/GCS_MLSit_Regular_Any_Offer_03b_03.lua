...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03bR03_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.114666, 1.084883, 0.774096 },
			orient = { {  0.875450,  0.000000,  0.483308 },
					   { -0.100017,  0.978353,  0.181168 },
					   { -0.472846, -0.206942,  0.856499 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.457899, 1.871749, -0.141486 },
			orient = { {  0.084588,  0.000000, -0.996416 },
					   { -0.568798,  0.821058, -0.048286 },
					   {  0.818116,  0.570844,  0.069452 } }
		},
		cameraprops =
		{
			fovh = 20,
...
events =
{
	...
	{
		1.820, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.200,
			end_effector = "Body_Head",
			count_to_root = 1,
