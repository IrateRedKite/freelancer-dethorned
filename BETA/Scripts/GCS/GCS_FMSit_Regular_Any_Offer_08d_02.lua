...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F08dR02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F08dR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F08dR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F08dR02_RVP51",
			duration = 5.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_F08dR02" },
		{
			duration = 4.367
		}
	},
	...
	{
		2.718, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.890, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.079,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.781, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		3.970, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.970, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
