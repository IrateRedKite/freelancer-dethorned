...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -2.677416, 3.381632, 8.431949 },
			orient = { {  0.560765,  0.000000,  0.827975 },
					   {  0.244518,  0.955398, -0.165606 },
					   { -0.791046,  0.295321,  0.535754 } }
		},
		cameraprops =
		{
			fovh = 25,
...
events =
{
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_e_01_wide", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cam_e_01_wide_copy_1", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		27.062, ATTACH_ENTITY, { "Char_Trent", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		27.125, ATTACH_ENTITY, { "Char_Dexter", "Marker_Lock" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
