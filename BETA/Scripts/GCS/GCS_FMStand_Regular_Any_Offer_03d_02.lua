...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03dR_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F03dR02_4",
		type = SOUND,
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F03dR02_4" },
		{
			duration = 2.770
		}
	},
	...
	{
		1.827, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.442,
			end_effector = "Body_Head",
			count_to_root = 1,
