...
entities =
{
	...
	{
		entity_name = "VoiceProfile_$BGCS_Base_Name",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Base_Name",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
	...
	{
		entity_name = "VoiceProfile_$BGCS_Base_Run_By",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Base_Run_By",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W02aF01_RVP01",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_$BGCS_Base_Name" },
		{
			duration = 1.682
		}
	},
	...
	{
		0.842, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.179, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.179, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 5.000,
			trans_time = 0.800,
	...
	{
		2.492, START_SOUND, { "VoiceProfile_$BGCS_Base_Run_By" },
		{
			duration = 1.753
		}
	},
	...
	{
		3.539, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.539, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
