...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10aR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F10aR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F10aR01_RVP01",
			duration = 2.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.562, START_SOUND, { "VoiceProfile_GCS_ML_F10aR01" },
		{
			duration = 2.188
		}
	},
	...
	{
		0.640, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
