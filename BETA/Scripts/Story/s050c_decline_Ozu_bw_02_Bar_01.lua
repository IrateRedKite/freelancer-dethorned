...
entities =
{
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.383675,  0.000000, -0.923468 },
					   { -0.083229,  0.995930, -0.034580 },
					   {  0.919710,  0.090127,  0.382114 } }
		},
		cameraprops =
		{
			fovh = 25,
...
events =
{
	...
	{
		0.001, START_IK, { "Char_ozu", "Char_trent_head_Marker_1" },
		{
			duration = 4.093,
	...
	{
		4.343, START_IK, { "Char_ozu", "Char_trent_head_Marker_1" },
		{
			duration = 8.531,
			end_effector = "Body_Head",
			count_to_root = 1,
