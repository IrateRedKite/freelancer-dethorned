...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -5.055542, -1.453284, -8.94231 },
			orient = { { -0.712901,  0.000000,  0.701265 },
					   { -0.114905,  0.986485, -0.116812 },
					   { -0.691787, -0.163854, -0.703266 } }
		},
		cameraprops =
		{
			fovh = 35,
...

	{
		...
		pathprops =
		{
			...
			path_data = "OPEN,{-10.822232,-8.254700,-14.140631}, {-0.352139,-0.079478,0.909685,-0.205316}, {-5.055542,-1.453284,-8.942310}, {-0.377597,-0.031146,0.922314,-0.076077}, "
		}
	},
...
events =
{
	...
	{
		0.000, ATTACH_ENTITY, { "Camera_2", "Mk_Lookat_Cam2" },
		{
			duration = 11.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
