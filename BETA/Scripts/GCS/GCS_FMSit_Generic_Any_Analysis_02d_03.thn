...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A02dG03_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_A02dG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_A02dG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 0.990,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 0.990,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_A02dG03" },
		{
			duration = 0.740
		}
	}
