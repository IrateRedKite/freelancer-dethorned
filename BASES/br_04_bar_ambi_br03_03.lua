...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br04Bar_BASE_NAME",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 174, 232, 249 },
			diffuse  =  { 0.2, 0.6, 0.921569 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.529412, 0.227451, 0.227451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  99.99998,
			type  =  L_DIRECT,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br04Bar_BASE_NAME" },
		{
			duration  =  0.000,
			fogprops  = 
			{
