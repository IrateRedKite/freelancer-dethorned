...
events =
{
	...
	{
		0.600, START_SOUND, { "VoiceProfile_GCS_FM_A02aG03" },
		{
			duration = 2.617
		}
	},
	...
	{
		0.800, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.281, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.939,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.625, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.906,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.220, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.220, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
