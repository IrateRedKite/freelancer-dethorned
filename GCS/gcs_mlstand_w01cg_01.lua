...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01cG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01cG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01cG01_RVP01",
			duration = 2.164,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_ML_W01cG01" },
		{
			duration = 1.625
		}
	},
	...
	{
		1.202, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.378, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.421, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.207,
			target_part = "",
			target_type = ROOT,
