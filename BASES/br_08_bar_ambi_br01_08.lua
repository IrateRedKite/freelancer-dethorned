...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_br_08_bar_Br01_08",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.830031, -0.375085, -0.412748 },
					   { 0.475294, 0.862926, 0.171626 },
					   { 0.291796, -0.338631, 0.894530 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.341176, 0.239216, 0.156863 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.090196, 0.047059, 0.015686 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.976167, 0.217020 },
					   { 0.000000, -0.217020, 0.976167 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.904944, 0.425530 },
					   { 0.000000, -0.425530, 0.904944 } }
		}
	},

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.209867, -0.491067, -0.845464 },
					   { 0.974186, -0.178582, -0.138094 },
					   { -0.083171, -0.852620, 0.515869 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.968628, 0.8, 0.65098 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.113725, 0.086275, 0.094118 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Br01_1",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br01",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.221667, 0.000000, 0.975123 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.975123, 0.000000, 0.221667 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Br01_stars_2",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br01_stars",
		lt_grp  =  23, srt_grp  =  -101, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.221666, 0.000000, 0.975123 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.975123, 0.000000, 0.221666 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_br_08_bar_Br01_08" },
		{
			duration  =  0.000,
			fogprops  = 
			{
