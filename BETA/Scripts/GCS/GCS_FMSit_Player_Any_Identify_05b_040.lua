...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D05bP04_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -1.116845, 0.903831, 0.772048 },
			orient = { {  0.654294,  0.000000,  0.756240 },
					   { -0.146549,  0.981044,  0.126794 },
					   { -0.741905, -0.193787,  0.641891 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 2.348011, 2.445612, 1.522748 },
			orient = { {  0.661232,  0.000000, -0.750181 },
					   { -0.308731,  0.911391, -0.272125 },
					   {  0.683708,  0.411541,  0.602641 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_D05bP04",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_D05bP04_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D05bP04_Trent",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.007, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.468, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_D05bP04" },
		{
			duration = 2.220
		}
	},
	...
	{
		0.757, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.100, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.116, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.603,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.720, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { -0.747185, 0, 0 },
				q_orient = { 0.867645, 0, -0.497184, 0 }
			}
		}
	},

	{
		1.720, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 0.987223, 0, -0.501587 },
				q_orient = { 0.999998, 0, -0.001856, 0 }
			}
		}
	},

	{
		2.093, START_MOTION, { "Player_Character_P" },
		{
