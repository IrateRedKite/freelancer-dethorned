...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01fG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01fG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01fG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01fG01_RVP51",
			duration = 2.664,
			start_time = 0.870,
			trans_time = 0.500,
			time_scale = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01fG01" },
		{
			duration = 1.855,
			start_time = 1169
		}
	...
	{
		1.046, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.034,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.078, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.078, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
