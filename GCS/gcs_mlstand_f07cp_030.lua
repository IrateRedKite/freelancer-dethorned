...
entities =
{
...

	{
		...
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07cP03_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07cP03" },
		{
			duration = 2.134
		}
	},
	...
	{
		1.452, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		2.134, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.134, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.203, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.930,
			end_effector = "Body_Head",
			count_to_root = 1,
