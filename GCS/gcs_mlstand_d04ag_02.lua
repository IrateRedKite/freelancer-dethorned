...
events =
{
	...
	{
		0.546, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.671, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.812, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.937, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.077, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.671,
	...
	{
		1.343, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.856, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.671, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.625,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.006, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		3.031, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		3.265, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.296, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.390, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.875,
			end_effector = "Body_Head",
			count_to_root = 1,
