...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Bw07_01",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.566450, 0.462879, -0.681819 },
					   { -0.715502, 0.686746, -0.128210 },
					   { 0.408891, 0.560467, 0.720198 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.415686, 0.741176, 0.647059 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.243137, 0.4, 0.356863 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Bw07_1",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.991777, 0.000000, -0.127977 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.127977, 0.000000, 0.991777 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Bw07_stars_2",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Bw07_01" },
		{
			duration  =  0.000,
			fogprops  = 
			{
