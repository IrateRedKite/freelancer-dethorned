...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03aR_03",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F03aR03" },
		{
			duration = 2.937
		}
	},
	...
	{
		1.881, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.557,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.440, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.440, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
