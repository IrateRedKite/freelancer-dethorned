...
events =
{
	...
	{
		1.429, START_SOUND, { "VoiceProfile_$BGCS_My_Faction_FM" },
		{
			duration = 2.118
		}
	},
	...
	{
		2.547, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.547, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
