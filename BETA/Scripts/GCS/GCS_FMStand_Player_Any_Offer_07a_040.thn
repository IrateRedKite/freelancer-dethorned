...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F07aP_04",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07aP04",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07aP04_4",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.203, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
...

	{
		...
		{
			animation = "Sc_dx_GCS_F07aP04_Trent",
			duration = 1.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.139, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.139, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.500, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP04" },
		{
			duration = 0.644
		}
	}
