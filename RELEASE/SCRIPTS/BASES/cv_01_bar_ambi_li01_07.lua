...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_Li0107",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.113137, -0.964181, 0.239907 },
					   { 0.762155, -0.070689, -0.643523 },
					   { 0.637432, 0.255653, 0.726858 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.360784, 0.443137, 0.560784 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.247059, 0.254902, 0.345098 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.827580, 0.000000, -0.561348 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.561348, 0.000000, 0.827580 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Li01_stars",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_Li0107" },
		{
			duration  =  0.000,
			fogprops  = 
			{
