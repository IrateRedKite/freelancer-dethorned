...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_Li0206",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.959934, -0.020013, 0.279512 },
					   { 0.021739, 0.999759, -0.003077 },
					   { -0.279383, 0.009030, 0.960137 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { 0.865985, 0.000000, -0.500069 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.500069, 0.000000, 0.865985 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.815686, 0.721569, 0.435294 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.278431, 0.223529, 0.34902 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Li02",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.678072, 0.000000, -0.734995 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.734995, 0.000000, 0.678072 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Li02_stars",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_Li0206" },
		{
			duration  =  0.000,
			fogprops  = 
			{
