...
entities =
{
	...
	{
		entity_name = "Layer_Li_06_Deck_Land",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.978364,  0.000000, -0.206892 },
					   { -0.036272,  0.984512,  0.171526 },
					   {  0.203688,  0.175320, -0.963210 } }
		},
		cameraprops =
		{
			fovh = 30,
...

	{
		...
		spatialprops =
		{
			pos = { 15.15535, 2.134614, -20.77898 },
			orient = { { -0.812441,  0.000000, -0.583043 },
					   {  0.086339,  0.988975, -0.120309 },
					   {  0.576615, -0.148083, -0.803484 } }
		},
		cameraprops =
		{
			fovh = 35,
...
events =
{
...

	{
		1.000, START_SPATIAL_PROP_ANIM, { "PlayerShip_10", "Marker_Ship_Follow_Land" },
		{
			...
			spatialprops =
			{
				pos = { -0.010098, 1.084773, -0.094653 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		7.968, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			duration = 3.750,
			target_type = ROOT,
			spatialprops =
...

	{
		10.781, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_03", "Camera_ShipLand_04" },
		{
			...
			{
				pos = { 15.15535, 2.134614, -20.77898 },
				q_orient = { 0.310353, -0.139253, -0.940367, 0.139253 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
