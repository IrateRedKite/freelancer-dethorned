...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F08dR_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F08dR02",
		type = SOUND,
...
events =
{
	...
	{
		0.265, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.496, SET_CAMERA, { "Monitor", "Camera/ACS" }
	},

	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F08dR02" },
		{
			duration = 4.789
		}
	},
	...
	{
		0.929, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.204, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		4.289, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.289, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.781, START_MOTION, { "Offer_Character_A" },
		{
