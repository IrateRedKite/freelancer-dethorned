...
entities =
{
	...
	{
		entity_name = "Monitor_Rh_02_Equip_carts",
		type = MONITOR,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0
	},
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.465337,  0.000000,  0.885134 },
					   {  0.158605,  0.983815,  0.083383 },
					   { -0.870808,  0.179188, -0.457806 } }
		},
		cameraprops =
		{
			fovh = 30,
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.252537,  0.000000,  0.967587 },
					   { -0.050213,  0.998653,  0.013105 },
					   { -0.966284, -0.051895,  0.252196 } }
		},
		cameraprops =
		{
			fovh = 30,
...

	{
		...
		spatialprops =
		{
			pos = { 19.93069, 1.479649, -19.46393 },
			orient = { { -0.733696,  0.000000,  0.679478 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.679478,  0.000000, -0.733696 } }
		},
...
events =
{
	...
	{
		0.000, SET_CAMERA, { "Monitor_Rh_02_Equip_carts", "Camera_Carts_A" }
	},
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera_Carts_A", "Camera_Carts_01" },
		{
			duration = 6.000,
			target_part = "",
			target_type = ROOT,
...

	{
		0.001, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Marker_ship_follow" },
		{
			...
			{
				pos = { 0, 0, 0 },
				q_orient = { 0.839057, 0, 0.544044, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		5.500, START_SPATIAL_PROP_ANIM, { "Camera_Carts_B", "Camera_Carts_03" },
		{
			duration = 5.500,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { -31.58574, 3.559141, 3.631483 },
				q_orient = { -0.453172, 0.104736, 0.885249, -0.038681 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		5.765, SET_CAMERA, { "Monitor_Rh_02_Equip_carts", "Camera_Carts_B" }
	},
