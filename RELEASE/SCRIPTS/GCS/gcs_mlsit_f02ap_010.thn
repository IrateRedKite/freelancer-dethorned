...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F02aP01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.174207, 1.173206, 0.712593 },
			orient = { {  0.829901,  0.000000,  0.557911 },
					   { -0.084323,  0.988512,  0.125432 },
					   { -0.551502, -0.151141,  0.820367 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.098785,  0.000000, -0.995109 },
					   { -0.379818,  0.924292, -0.037705 },
					   {  0.919771,  0.381685,  0.091306 } }
		},
		cameraprops =
		{
			fovh = 20,
...
events =
{
	...
	{
		0.546, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},

	{
		0.750, START_SOUND, { "VoiceProfile_GCS_Trent_F02aP01" },
		{
			duration = 2.000
		}
	},
