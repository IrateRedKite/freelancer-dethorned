...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 50.20075, 86.88402, -450.0369 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 85.95425, 41.03247, -682.4461 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -36.94041, 79.48521, -24.11063 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -133.8198, -250.3862, 750.4352 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		userprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -84.05232, -271.8726, 733.7728 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		userprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -27.32988, -286.3355, 727.2993 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		userprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 14.58496, -325.4425, 691.3633 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -248.9842, -282.6995, 710.2388 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -36.94041, 52.26246, -24.11063 },
			orient  =  { { 0.895231, -0.018280, -0.445226 },
					   { 0.049191, 0.997106, 0.057970 },
					   { 0.442878, -0.073798, 0.893540 } }
		},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 50.20075, 68.17257, -450.0369 },
			orient  =  { { 0.802900, -0.030739, 0.595320 },
					   { -0.049694, 0.991742, 0.118229 },
					   { -0.594038, -0.124510, 0.794743 } }
		},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 85.95425, 6.214858, -682.4461 },
			orient  =  { { 0.888656, -0.018280, -0.458209 },
					   { 0.030459, 0.999352, 0.019205 },
					   { 0.457561, -0.031024, 0.888637 } }
		},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 29.33885, -293.6534, 728.0609 },
			orient  =  { { 0.999909, 0.013487, 0.000000 },
					   { -0.013487, 0.999909, 0.000000 },
					   { 0.000000, 0.000000, 1.000000 } }
		},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -15.01746, -297.4732, 712.9418 },
			orient  =  { { 0.999909, 0.013487, 0.000000 },
					   { -0.013487, 0.999909, 0.000000 },
					   { 0.000000, 0.000000, 1.000000 } }
		},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -133.8198, -369.1512, 750.4352 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		}
	},

	{
		entity_name  =  "Ship_armored_transport_br_large_5",
		type  =  SOUND,
	...
	{
		entity_name  =  "ship_civ_freighter_loop_6",
		type  =  SOUND,
	...
	{
		entity_name  =  "Ship_l_freighter_3_loop_7",
		type  =  SOUND,
	...
	{
		entity_name  =  "Ship_R_freighter_1_loop_8",
		type  =  SOUND,
...
{
	{
		0.000, ATTACH_ENTITY, { "Ship_R_freighter_1_loop_8", "Ship_R_freighter_1" },
		{
			duration  =  60.189,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Ship_l_freighter_3_loop_7", "Ship_l_freighter_3" },
		{
			duration  =  60.189,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "ship_civ_freighter_loop_6", "Ship_civ_freighter" },
		{
			duration  =  60.000,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Ship_armored_transport_br_large_5", "Ship_armored_transport_1" },
		{
			duration  =  60.189,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.061, START_SOUND, { "Ship_R_freighter_1_loop_8" },
		{
			duration  =  26.062,
			flags  =  LOOP
		}
	...
	{
		0.250, START_SOUND, { "ship_civ_freighter_loop_6" },
		{
			duration  =  58.965,
			flags  =  LOOP
		}
	...
	{
		10.750, START_SOUND, { "Ship_l_freighter_3_loop_7" },
		{
			duration  =  25.000,
			flags  =  LOOP
		}
	...
	{
		26.468, START_SOUND, { "Ship_R_freighter_1_loop_8" },
		{
			duration  =  33.437,
			flags  =  LOOP
		}
	...
	{
		34.500, START_SOUND, { "Ship_armored_transport_br_large_5" },
		{
			duration  =  25.562,
			flags  =  LOOP
		}
	...
	{
		36.062, START_SOUND, { "Ship_l_freighter_3_loop_7" },
		{
			duration  =  23.687,
			flags  =  LOOP
		}
