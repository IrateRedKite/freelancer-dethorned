...
entities =
{
	...
	{
		entity_name = "Layer_Li_08_Outpost_Land",
		type = SCENE,
		template_name = "",
...
events =
{
	...
	{
		9.125, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_02", "Camera_ShipLand(REF)2" },
		{
			duration = 9.437,
			target_part = "",
			target_type = ROOT,
	...
	{
		12.343, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			duration = 3.000,
			target_type = ROOT,
			spatialprops =
