...
entities =
{
	...
	{
		entity_name = "Layer_Pl_08_pad_Traffic",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -1898.87, 184.5704, -167.2125 },
			orient = { { -0.871380,  0.004686,  0.490587 },
					   { -0.033157,  0.997106, -0.068418 },
					   { -0.489488, -0.075884, -0.868702 } }
		},
		pathprops =
		{
...

	{
		...
		spatialprops =
		{
			pos = { -1697.906, 75.66039, -75.60794 },
			orient = { { -0.903941,  0.004651,  0.427632 },
					   { -0.028260,  0.997106, -0.070581 },
					   { -0.426722, -0.075886, -0.901193 } }
		},
		pathprops =
		{
			path_type = "CV_CROrientationSplinePath",
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.687832,  0.000000,  0.725870 },
					   {  0.000000,  1.000000,  0.000000 },
					   { -0.725870,  0.000000, -0.687832 } }
		},
		pathprops =
		{
			path_type = "CV_CROrientationSplinePath",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.766188,  0.000000, -0.642617 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.642617,  0.000000,  0.766188 } }
		},
		pathprops =
		{
			path_type = "CV_CROrientationSplinePath",
