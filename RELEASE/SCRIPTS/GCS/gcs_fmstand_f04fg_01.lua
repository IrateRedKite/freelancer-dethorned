...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F04fG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F04fG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_STND_CONV_HNDS_CASL_000LV_xb_03",
			duration = 3.000,
			trans_time = 1.000,
			time_scale = 0.8,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F04fG01" },
		{
			duration = 4.348
		}
	},
	...
	{
		2.968, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.768,
	...
	{
		3.531, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.849, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.849, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
