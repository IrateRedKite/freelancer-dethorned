...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 2.119342, 1.597949, 0.965889 },
			orient = { {  0.622049,  0.000000, -0.782978 },
					   { -0.148829,  0.981769, -0.118239 },
					   {  0.768703,  0.190080,  0.610708 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D03aN02_1",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D03aN02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D03aN02_RVP01",
			duration = 3.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D03aN02_1" },
		{
			duration = 2.819
		}
	},
	...
	{
		0.866, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 2.453,
			end_effector = "Body_Head",
			count_to_root = 1,
			...
			point_at = 1,
			move_to = 0,
			transition_duration = 0.690,
			event_flags = 128
		}
	},

	{
		1.046, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.608, SET_CAMERA, { "Monitor_1", "Camera/AC2" }
	},

	{
		1.882, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_EMPH_LHNDDN_TRNS_000LV_XA_01",
			duration = 1.532,
			trans_time = 1.000,
			time_scale = 0.8,
			weight = 1,
	...
	{
		2.319, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.319, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
