...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01bG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01bG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01bG01_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01bG01" },
		{
			duration = 2.779
		}
	},
	...
	{
		1.118, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.359, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.886, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.393,
			end_effector = "Body_Head",
			count_to_root = 1,
