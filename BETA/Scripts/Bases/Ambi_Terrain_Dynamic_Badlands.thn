...
events =
{
...

	{
		6.100, START_SPATIAL_PROP_ANIM, { "Ambi_Roids_solar_badlands_dynamic_02", "Ambi_Roids_solar_badlands_dynamic_02_Target" },
		{
			...
			spatialprops =
			{
				pos = { 400.3165, 1584.076, 966.3994 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		12.100, START_SPATIAL_PROP_ANIM, { "Ambi_Roids_solar_badlands_dynamic_04", "Ambi_Roids_solar_badlands_dynamic_04_Target" },
		{
			...
			spatialprops =
			{
				pos = { 222.3271, -1491.174, -547.4245 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		22.100, START_SPATIAL_PROP_ANIM, { "Ambi_Roids_solar_badlands_dynamic_03", "Ambi_Roids_solar_badlands_dynamic_03_Target" },
		{
			...
			spatialprops =
			{
				pos = { 681.3228, -1216.795, -1587.267 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		43.750, START_SPATIAL_PROP_ANIM, { "Ambi_Roids_solar_badlands_dynamic_04", "Ambi_Roids_solar_badlands_dynamic_04_Target" },
		{
			...
			spatialprops =
			{
				pos = { 567.0958, -923.2136, -1575.379 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		1025.686, ATTACH_ENTITY, { "Ambi_Roids_solar_badlands_dynamic_04", "Ambi_Roids_Start_Mkr_Target" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		1025.686, START_SPATIAL_PROP_ANIM, { "Ambi_Roids_solar_badlands_dynamic_04", "Ambi_Roids_solar_badlands_dynamic_04_Target" },
		{
			duration = 60.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1025.686, ATTACH_ENTITY, { "Ambi_Roids_solar_badlands_dynamic_04_Target", "Ambi_Roids_End_Mkr_Target" },
		{
			duration = 0.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
