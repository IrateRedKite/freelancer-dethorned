...
{
	{
		0.000, START_PATH_ANIMATION, { "Mk_Leader", "Path_4" },
		{
			...
			param_curve =
			{
				...
				points =
				{
					{  0.000000,  0.605769,  0.000000, -0.619048 },
					{  1.000000,  0.000000, -0.571429,  0.000000 },
				}
			},
			pcurve_period = -1000
		}
...

	{
		0.000, START_PATH_ANIMATION, { "CnB_Camera_01", "Path_1" },
		{
			...
			param_curve =
			{
				...
				points =
				{
					{  0.000000,  0.201923,  0.000000,  0.000000 },
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "aa_main_object", "Mk_Dest" },
		{
			duration = 55.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		33.780, START_PATH_ANIMATION, { "Mk_Leader", "Path_4" },
		{
			duration = 23.812,
			start_percent = 0,
			stop_percent = 1,
	...
	{
		33.780, START_PATH_ANIMATION, { "CnB_Camera_01", "Path_1" },
		{
			duration = 23.812,
			start_percent = 0,
			stop_percent = 1,
	...
	{
		33.780, SET_CAMERA, { "Shot01_Monitor_1", "CnB_Camera_01" }
	}
};
