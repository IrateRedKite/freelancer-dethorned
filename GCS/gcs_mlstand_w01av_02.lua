...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_W01aV02_1",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_W01aV02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_W01aV02_RVP01",
			duration = 1.333,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.148, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.233,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.379, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.379, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.671, START_SOUND, { "VoiceProfile_GCS_ML_W01aV02_1" },
		{
			duration = 0.712
		}
	}
