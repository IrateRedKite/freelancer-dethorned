...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F01fG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F01fG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F01fG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F01fG01_RVP51",
			duration = 4.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F01fG01" },
		{
			duration = 3.500
		}
	},
	...
	{
		1.992, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMHAND_HNEUT_GESTL_CASL_000LV_00",
			duration = 2.500,
			trans_time = 0.750,
	...
	{
		3.217, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.782,
			end_effector = "Body_Head",
			count_to_root = 1,
