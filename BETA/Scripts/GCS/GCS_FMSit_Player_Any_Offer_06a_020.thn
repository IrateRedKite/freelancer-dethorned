...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F06aP02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.499052, 1.94545, -0.243129 },
			orient = { {  0.042434,  0.000000, -0.999099 },
					   { -0.543087,  0.839360, -0.023066 },
					   {  0.838604,  0.543576,  0.035617 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F06aP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F06aP02_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F06aP02_Trent",
			duration = 2.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F06aP02" },
		{
			duration = 1.812
		}
	},
	...
	{
		0.514, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		0.734, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.230, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.080,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		1.309, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.309, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
