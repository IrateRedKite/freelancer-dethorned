...
events =
{
...

	{
		0.100, START_SPATIAL_PROP_ANIM, { "PlayerShip", "PlyrShip_Mk_OrientationFollow" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.117998, 0.098504, 0.988116, 0.497836 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		1.187, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_01_start", "Camera_ShipLaunch_02_lookup" },
		{
			...
			{
				pos = { -25.57882, 21.06503, 78.88072 },
				q_orient = { 0.893998, -0.046779, -0.445623, 0.046779 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		1.500, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_OrientationFollow", "PlyrShip_Mk_PauseHere" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.703256, 0, -0.710937, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		4.282, START_SPATIAL_PROP_ANIM, { "gf_rtc_shipcushion_Marker_1" },
		{
			...
			{
				pos = { 2.7023, -4, 4.5692 },
				q_orient = { 0.735868, 0, 0.677125, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		5.437, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_OrientationFollow", "PlyrShip_Mk_NoseDip" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.859336, 0.182767, -0.477638, -0.182767 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		6.000, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_03_swipe", "Camera_ShipLaunch_04_swipeGoTo" },
		{
			...
			{
				pos = { -101.7222, 53.17643, 262.837 },
				q_orient = { 0.903502, -0.000693, -0.428583, 0.000693 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		6.906, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_OrientationFollow", "PlyrShip_Mk_flight_ort_01" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.479273, -0.34728, -0.806036, -0.155682 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		7.656, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_OrientationFollow", "PlyrShip_Mk_flight_ort_02" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.671661, -0.518423, 0.529254, 0.739731 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
