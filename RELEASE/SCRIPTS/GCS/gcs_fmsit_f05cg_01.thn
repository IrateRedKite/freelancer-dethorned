...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F05cG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F05cG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F05cG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
{
	{
		...
		{
			animation = "Sc_dx_GCS_F05cG01_RVP51",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F05cG01" },
		{
			duration = 2.470
		}
	},
