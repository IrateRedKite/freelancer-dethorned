...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F04gP02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.193385, 1.117084, 0.714763 },
			orient = { {  0.834658,  0.000000,  0.550768 },
					   { -0.102195,  0.982635,  0.154870 },
					   { -0.541204, -0.185549,  0.820164 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F04gP02",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F04gP02_5",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F04gP02_Trent",
			duration = 1.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F04gP02" },
		{
			duration = 0.865
		}
	}
