...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.516508, 1.632202, -0.15941 },
			orient = { { -0.012033,  0.000000, -0.999928 },
					   { -0.346462,  0.938055,  0.004169 },
					   {  0.937987,  0.346487, -0.011287 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01dG03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01dG03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01dG03_RVP01",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.431, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01dG03" },
		{
			duration = 2.233
		}
	},
	...
	{
		0.899, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.020, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.484, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.730, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.000,
			end_effector = "Body_Head",
			count_to_root = 1,
