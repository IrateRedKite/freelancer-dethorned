...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F09bP02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.061617,  0.000000, -0.998100 },
					   { -0.434049,  0.900491, -0.026796 },
					   {  0.898780,  0.434875,  0.055486 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F09bP02_6",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F09bP02" },
		{
			duration = 1.979
		}
	},
	...
	{
		0.515, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.769,
	...
	{
		0.609, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.228, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_SMALL_000LV_XA_05",
			duration = 4.966,
			start_time = 4.000,
	...
	{
		1.480, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.480, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
