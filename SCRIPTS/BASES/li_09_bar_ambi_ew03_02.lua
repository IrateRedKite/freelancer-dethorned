...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_li_09_bar_Ew03_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.681236, 0.021991, -0.731734 },
					   { -0.188178, 0.960701, 0.204063 },
					   { 0.707465, 0.276712, -0.650326 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.113725, 0.266667, 0.066667 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.176471, 0.168627, 0.235294 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.209918, 0.977719 },
					   { 0.000000, -0.977719, -0.209918 } }
		}
	},
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.030933, 0.001469, 0.999520 },
					   { 0.047449, 0.998874, 0.000000 },
					   { -0.998395, 0.047426, -0.030968 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_li_09_bar_Ew03_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
