...
entities  = 
{
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.078431, 0.054902, 0.027451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.52549, 0.415686, 0.341176 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.196078, 0.101961, 0.011765 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Br04",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.925140, 0.042843, -0.377201 },
					   { 0.039931, 0.999082, 0.015541 },
					   { 0.377521, -0.000684, -0.926001 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...

	{
		...
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  24, srt_grp  =  -101, usr_flg  =  0,
		spatialprops  = 
		{
			pos  =  { 2.635458, 0, 1.632055 },
			orient  =  { { 0.636787, 0.000000, -0.771040 },
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.403922, 0.25098, 0.094118 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
