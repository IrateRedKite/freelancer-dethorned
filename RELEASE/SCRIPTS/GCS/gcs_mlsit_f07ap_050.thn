...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F07aP05_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 0.98683, 0, -0.501094 },
			orient = { { -0.612630,  0.000000, -0.790370 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.790370,  0.000000, -0.612630 } }
		},
		compoundprops =
		{
			floor_height = 0
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F07aP05",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F07aP05_1",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.250, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.550,
...

	{
		...
		{
			animation = "Sc_dx_GCS_F07aP05_Trent",
			duration = 1.832,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.615, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.615, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.925, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.768,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F07aP05" },
		{
			duration = 0.615
		}
	},
