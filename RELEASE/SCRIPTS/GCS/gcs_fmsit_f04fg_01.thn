...
events =
{
...

	{
		1.000, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			...
			spatialprops =
			{
				...
				q_orient = { -0.976532, -0.073979, 0.20227, 0.073979 }
			},
			param_curve =
			{
	...
	{
		3.125, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		4.840, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		4.840, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
