...
entities =
{
...

	{
		...
		{
			path_type = "CV_CROrientationSplinePath",
			path_data = "OPEN,{4500.312012,711.672913,-21614.273438}, {0.504876,0.000000,0.863192,0.000000}, {3600.000000,1000.000000,-21000.000000}, {1.000000,0.000000,0.000000,0.000000}, "
		}
	}
};
...
events =
{
	...
	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera_shot2", "Camera_shot2_b" },
		{
			duration = 10.375,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 3731.04, 949.4342, -21098.78 },
				q_orient = { -0.542782, 0, -0.839873, 0.147406 }
			},
			param_curve =
			{
	...
	{
		10.375, SET_CAMERA, { "Monitor_1", "Camera_shot3_Temp" }
	},

	{
		10.375, START_SPATIAL_PROP_ANIM, { "Camera_shot3_Temp", "Camera_shot3_Temp_b" },
		{
			duration = 5.000,
			target_part = "",
			target_type = ROOT,
			...
			{
				pos = { 3521.184, 1083.807, -21416.76 },
				q_orient = { -0.984258, 0, 0.176737, 0.002286 }
			}
		}
	},
