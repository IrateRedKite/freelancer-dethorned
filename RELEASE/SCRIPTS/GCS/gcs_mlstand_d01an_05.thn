...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01aN05_3",
		type = SOUND,
...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01aN05_3" },
		{
			duration = 1.904
		}
	},
	...
	{
		1.399, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.399, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
