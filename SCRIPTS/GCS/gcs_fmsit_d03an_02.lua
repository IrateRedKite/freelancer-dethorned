...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D03aN02_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.532393, 1.98803, 0.578225 },
			orient = { {  0.602505,  0.000000, -0.798115 },
					   { -0.342441,  0.903275, -0.258512 },
					   {  0.720917,  0.429062,  0.544228 } }
		},
		cameraprops =
		{
			fovh = 30,
...

	{
		...
		spatialprops =
		{
			pos = { -0.210494, 1.142337, 1.799933 },
			orient = { {  0.987544,  0.000000,  0.157345 },
					   {  0.000358,  0.999997, -0.002246 },
					   { -0.157344,  0.002274,  0.987541 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D03aN02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D03aN02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.000, SET_CAMERA, { "Monitor_1", "Camera/PC2" }
	},
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D03aN02_RVP51",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D03aN02" },
		{
			duration = 3.078
		}
	},
	...
	{
		0.851, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.992, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.398, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.562, SET_CAMERA, { "Monitor_1", "Camera/AC2" }
	},

	{
		2.328, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.251,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.579, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.579, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.835, START_MOTION, { "Offer_Character_A" },
		{
