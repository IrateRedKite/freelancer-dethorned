...
entities  = 
{
	...
	{
		entity_name  =  "Player_Ship_Mk_Follow",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "Player_Ship_Path_Land_1",
		type  =  MOTION_PATH,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "Player_Ship_Mk_Follow_2",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "Player_Ship_Mk_Follow_3",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		{
			...
			orient  =  { { -0.341485, 0.023218, 0.939601 },
	...
	{
		entity_name  =  "Player_Ship_Mk_bounce",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -746.4775, 88.19374, -5097.599 },
			orient  =  { { -0.973991, 0.000000, 0.226586 },
					   { 0.020464, 0.995913, 0.087964 },
					   { -0.225661, 0.090313, -0.970011 } }
		},
		cameraprops  = 
		{
			fovh  =  20,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -301.5307, 40.186, -1956.139 },
			orient  =  { { -0.995772, 0.000000, 0.091862 },
					   { 0.000397, 0.999991, 0.004304 },
					   { -0.091861, 0.004322, -0.995762 } }
		},
		cameraprops  = 
		{
			fovh  =  20,
	...
	{
		entity_name  =  "Player_Ship_Mk_Cam_02",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "Player_Ship_Mk_Cam_01_A",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		{
			pos  =  { -572.0456, 22.50934, -4718.012 },
	...
	{
		entity_name  =  "Player_Ship_Mk_Cam_01_B",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		{
			pos  =  { -313.1032, 25.78154, -1670.675 },
	...
	{
		entity_name  =  "Player_Ship_Mk_above_deck_ort_1",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
	...
	{
		entity_name  =  "Player_Ship_Mk_above_deck_ort_2",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		{
			pos  =  { -126.8708, 13.97681, -25.15447 },
			orient  =  { { -0.334923, -0.295318, 0.894770 },
					   { -0.075763, 0.954980, 0.286832 },
					   { -0.939195, 0.028276, -0.342219 } }
		}
	},

	{
		entity_name  =  "Player_Ship_Mk_above_deck_ort_3",
		type  =  MARKER,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		{
			...
			orient  =  { { -0.335242, 0.140243, 0.931635 },
					   { 0.074336, 0.989713, -0.122237 },
					   { -0.939195, 0.028275, -0.342219 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -456.4394, -11.25758, -3357.513 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -222.8216, 41.88807, -35.67781 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
{
	{
		0.000, ATTACH_ENTITY, { "PlayerShip", "Player_Ship_Mk_Cam_01_A" },
		{
			duration  =  6.687,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_01_A", "Camera_ShipLand_01_B" },
		{
			...
			spatialprops  = 
			{
				pos  =  { -412.6118, 20.09867, -1932.303 },
				q_orient  =  { -0.972234, 0, 0.234009, -0.014307 }
			},
			param_curve  = 
			{
	...
	{
		0.015, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_Cam_01_A", "Player_Ship_Mk_Cam_01_B" },
		{
			duration  =  6.686,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		2.750, START_PATH_ANIMATION, { "Player_Ship_Mk_Follow", "Player_Ship_Path_Land_1" },
		{
			duration  =  7.000,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		3.000, START_SOUND, { "Playership_engine_land_rumble_snd" },
		{
			duration  =  9.112
		}
	},
	...
	{
		3.000, ATTACH_ENTITY, { "Playership_engine_land_rumble_snd", "PlayerShip" },
		{
			duration  =  9.199,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		3.000, START_AUDIO_PROP_ANIM, { "Playership_engine_land_rumble_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
	...
	{
		6.618, SET_CAMERA, { "Cam_Monitor_ShipLand", "Camera_ShipLand_02" }
	},

	{
		6.875, ATTACH_ENTITY, { "PlayerShip", "Player_Ship_Mk_Cam_02" },
		{
			duration  =  0.119,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		7.031, START_SPATIAL_PROP_ANIM, { "PlayerShip", "Player_Ship_Mk_Follow" },
		{
			duration  =  16.093,
			target_part  =  "",
			target_type  =  ROOT,
			spatialprops  = 
			{
				pos  =  { -126.6175, 36.8405, -29.38921 },
				q_orient  =  { -0.291666, -0.37843, 0.878477, -0.277041 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		10.000, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_Follow", "Player_Ship_Mk_Follow_2" },
		{
			duration  =  2.404,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		11.000, START_SOUND, { "Playership_engine_land_turbine_snd" },
		{
			duration  =  10.251
		}
	},
	...
	{
		11.000, ATTACH_ENTITY, { "Playership_engine_land_turbine_snd", "PlayerShip" },
		{
			duration  =  10.281,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		11.000, START_AUDIO_PROP_ANIM, { "Playership_engine_land_turbine_snd" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		12.468, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_Follow", "Player_Ship_Mk_Follow_3" },
		{
			duration  =  2.187,
			target_part  =  "",
			target_type  =  ROOT,
			...
			{
				pos  =  { -135.3232, 15.33138, 56.2448 },
				q_orient  =  { -0.765979, 0.019939, 0.642557, 0.067219 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		14.687, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_above_deck_ort_1", "Player_Ship_Mk_above_deck_ort_2" },
		{
			duration  =  1.312,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		14.718, ATTACH_ENTITY, { "Player_Ship_Mk_Follow", "Player_Ship_Mk_above_deck_ort_1" },
		{
			duration  =  6.406,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		14.718, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_Follow", "X/Shipcentre/01" },
		{
			duration  =  6.531,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		16.000, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_above_deck_ort_1", "Player_Ship_Mk_above_deck_ort_3" },
		{
			duration  =  2.312,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		18.312, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_above_deck_ort_1", "X/Shipcentre/01" },
		{
			duration  =  2.062,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		20.781, START_SPATIAL_PROP_ANIM, { "Player_Ship_Mk_Follow", "Player_Ship_Mk_bounce" },
		{
			duration  =  1.600,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		21.792, START_SOUND, { "Playership_engine_kill_snd" },
		{
			duration  =  1.544
		}
	},
	...
	{
		21.797, ATTACH_ENTITY, { "Playership_engine_kill_snd", "PlayerShip" },
		{
			duration  =  1.600,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
