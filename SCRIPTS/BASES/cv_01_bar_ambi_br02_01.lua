...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_Br02_01.thn",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.376471, 0.360784, 0.290196 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.376471, 0.360784, 0.290196 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.162827, 0.842897, 0.512846 },
					   { -0.984714, 0.106246, 0.138021 },
					   { 0.061850, -0.527481, 0.847313 } }
		},
		lightprops  = 
		{
			on  =  Y,
			...
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.07451, 0.066667, 0.109804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.898964, 0.438024 },
					   { 0.000000, -0.438024, 0.898964 } }
		}
	},
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.568448, 0.328978, -0.186511 },
			orient  =  { { 0.815148, 0.577273, 0.047858 },
					   { -0.301224, 0.351874, 0.886256 },
					   { 0.494771, -0.736845, 0.460717 } }
		},
		lightprops  = 
		{
			on  =  Y,
			...
			diffuse  =  { 1, 1, 1 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.258824, 0.266667, 0.317647 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Br02_3",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br02",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.566291, 0.026227, -0.823788 },
					   { -0.070238, 0.997393, -0.016529 },
					   { 0.821207, 0.067222, 0.566657 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Br02_stars_4",
		type  =  COMPOUND,
		template_name  =  "starsphere_Br02_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_Br02_01.thn" },
		{
			duration  =  0.000,
			fogprops  = 
			{
