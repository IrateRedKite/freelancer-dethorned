...
entities  = 
{
	...
	{
		entity_name  =  "Layer_ku_02_City_Traffic",
		type  =  SCENE,
		template_name  =  "",
	...
	{
		entity_name  =  "Traffic_Zone_02_Top",
		type  =  MOTION_PATH,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		...
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ -1048.128052, 0.000000, -92.104691 }, { 1.000000, 0.000000, 0.000000, 0.000000 }, { 956.851929, 0.000000, 282.993469 }, { 1.000000, 0.000000, 0.000000, 0.000000 }, "
		}
	},

	{
		entity_name  =  "Traffic_Zone_03_Bottom",
		type  =  MOTION_PATH,
		template_name  =  "",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		spatialprops  = 
		{
			pos  =  { -10.93692, -46.4123, -192.9807 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		pathprops  = 
		{
			path_type  =  "CV_CROrientationSplinePath",
			path_data  =  "OPEN,{ 854.302673, 74.412292, -161.739868 }, { 1.000000, 0.000000, 0.000000, 0.000000 }, { -878.809998, 74.412292, 360.648560 }, { 1.000000, 0.000000, 0.000000, 0.000000 }, "
		}
	},
...
events  = 
{
	...
	{
		0.000, START_PATH_ANIMATION, { "Ship_b_elite_1", "Traffic_Zone_02_Top" },
		{
			duration  =  12.062,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		0.312, START_PATH_ANIMATION, { "Ship_k_elite_4", "Traffic_Zone_02_Top" },
		{
			duration  =  14.843,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		0.312, START_PATH_ANIMATION, { "Ship_l_freighter_10", "Traffic_Zone_03_Bottom" },
		{
			duration  =  19.218,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		10.312, START_PATH_ANIMATION, { "Ship_civ_fighter_8", "Traffic_Zone_03_Bottom" },
		{
			duration  =  12.031,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		10.937, START_SPATIAL_PROP_ANIM, { "Ship_civ_elite_7", "Ship_Park_06" },
		{
			duration  =  0.001,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		15.937, START_PATH_ANIMATION, { "Ship_k_fighter_3", "Traffic_Zone_03_Bottom" },
		{
			duration  =  10.000,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		16.000, START_SPATIAL_PROP_ANIM, { "Ship_k_elite_2", "Ship_Park_13" },
		{
			duration  =  0.001,
			target_part  =  "",
			target_type  =  ROOT,
	...
	{
		17.031, START_PATH_ANIMATION, { "Ship_civ_elite_7", "Traffic_Zone_02_Top" },
		{
			duration  =  8.125,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		17.968, START_PATH_ANIMATION, { "Ship_k_freighter_1", "Traffic_Zone_03_Bottom" },
		{
			duration  =  16.250,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		27.031, START_PATH_ANIMATION, { "Ship_k_fighter_3", "Traffic_Zone_02_Top" },
		{
			duration  =  12.187,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		27.343, START_PATH_ANIMATION, { "Ship_civ_fighter_8", "Traffic_Zone_03_Bottom" },
		{
			duration  =  9.999,
			start_percent  =  0,
			stop_percent  =  1,
	...
	{
		35.000, START_PATH_ANIMATION, { "Ship_k_freighter_11", "Traffic_Zone_03_Bottom" },
		{
			duration  =  17.968,
			start_percent  =  0,
			stop_percent  =  1,
