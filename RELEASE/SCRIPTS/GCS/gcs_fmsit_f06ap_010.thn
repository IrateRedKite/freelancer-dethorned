...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F06aP01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F06aP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F06aP01_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_dx_GCS_F06aP01_Trent",
			duration = 2.833,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F06aP01" },
		{
			duration = 2.108
		}
	},
	...
	{
		1.014, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.595,
			end_effector = "Body_Head",
			count_to_root = 1,
			...
			point_at = 1,
			move_to = 0,
			transition_duration = 1.330,
			event_flags = 128
		}
	},

	{
		1.110, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.360, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.360, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
