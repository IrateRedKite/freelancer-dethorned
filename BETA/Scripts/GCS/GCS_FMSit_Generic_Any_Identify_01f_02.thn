...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01fG02_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01fG02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01fG02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01fG02_RVP51",
			duration = 1.832,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		1.238, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.250, START_SOUND, { "VoiceProfile_GCS_FM_D01fG02" },
		{
			duration = 1.265
		}
	},
	...
	{
		1.312, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.519, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
