...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRB_POINTL_OVRTHRE_000LV_XA_03",
			duration = 3.700,
			trans_time = 1.000,
			time_scale = 0.8,
			weight = 1,
	...
	{
		2.265, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		2.549, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.549, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
