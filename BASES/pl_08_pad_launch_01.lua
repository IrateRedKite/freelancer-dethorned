...
entities  = 
{
...

	{
		...
		spatialprops  = 
		{
			pos  =  { -6.588584, 40.37252, 4.489419 },
			orient  =  { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		},
		audioprops  = 
		{
...
events  = 
{
...

	{
		5.560, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_2" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.847999, -0.425337, 0.316206, 0.358163 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		7.810, ATTACH_ENTITY, { "Playership_engine_launch04_snd", "PlayerShip" },
		{
			duration  =  7.375,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		7.810, START_AUDIO_PROP_ANIM, { "Playership_engine_launch04_snd" },
		{
			duration  =  1.000,
			audioprops  = 
			{
	...
	{
		7.811, START_SOUND, { "Playership_engine_launch04_snd" },
		{
			duration  =  7.375
		}
	},

	{
		8.031, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_3" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.655146, 0.754077, -0.046389, 0.182919 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		9.843, START_SPATIAL_PROP_ANIM, { "PlayerShip_MOP_Path", "Marker_Orient_4" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.939676, -0.190836, -0.283884, 0.259131 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		11.062, START_SOUND, { "PlayerShip_engine_playership" },
		{
			duration  =  4.124,
			flags  =  LOOP
		}
	...
	{
		11.062, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership" },
		{
			duration  =  2.000,
			audioprops  = 
			{
	...
	{
		11.062, ATTACH_ENTITY, { "PlayerShip_engine_playership", "PlayerShip" },
		{
			duration  =  4.124,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		12.625, START_AUDIO_PROP_ANIM, { "Playership_engine_launch04_snd" },
		{
			duration  =  2.562,
			audioprops  = 
			{
	...
	{
		13.062, START_AUDIO_PROP_ANIM, { "PlayerShip_engine_playership" },
		{
			duration  =  2.124,
			audioprops  = 
			{
	...
	{
		13.062, START_AUDIO_PROP_ANIM, { "Playership_engine_rumble_snd" },
		{
			duration  =  2.124,
			audioprops  = 
			{
