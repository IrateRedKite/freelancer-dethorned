...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F09bP01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.034868, 1.537345, -0.165232 },
			orient = { { -0.022619,  0.000000, -0.999744 },
					   { -0.402965,  0.915170,  0.009117 },
					   {  0.914936,  0.403068, -0.020700 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F09bP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F09bP01_2",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.483, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 0.768,
...

	{
		...
		{
			animation = "Sc_dx_GCS_F09bP01_Trent",
			duration = 2.332,
			trans_time = 0.750,
			time_scale = 1,
			weight = 1,
	...
	{
		0.560, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.000, START_SOUND, { "VoiceProfile_GCS_Trent_F09bP01" },
		{
			duration = 1.319
		}
	},
	...
	{
		1.319, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.319, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.453, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 1.156,
			end_effector = "Body_Head",
			count_to_root = 1,
