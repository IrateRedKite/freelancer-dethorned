...
entities =
{
	...
	{
		entity_name = "Layer_Br_07_Deck_Launch",
		type = SCENE,
		template_name = "",
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.749139,  0.000000, -0.662413 },
					   {  0.000000,  1.000000,  0.000000 },
					   {  0.662413,  0.000000, -0.749139 } }
		},
		userprops =
		{
			category = "Spaceship",
...

	{
		...
		spatialprops =
		{
			pos = { -36.91973, 14.83266, 10.21755 },
...

	{
		...
		spatialprops =
		{
			pos = { -15.12976, 20.47452, 22.26866 },
...
events =
{
	...
	{
		6.375, START_SPATIAL_PROP_ANIM, { "Camera_ShipLaunch_02", "Camera_ShipLaunch(REF)2" },
		{
			duration = 5.687,
			target_part = "",
			target_type = ROOT,
	...
	{
		6.812, START_PSYS_PROP_ANIM, { "PlayerShipEngines_1" },
		{
			duration = 1.500,
			psysprops =
			{
