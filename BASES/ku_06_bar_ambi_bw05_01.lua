...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_ku06Bar_bw05_01",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  N,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.196078, 0.215686, 0.247059 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.117647, 0.117647, 0.117647 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.827451, 0.827451, 0.827451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 2.119669, 0.518626, 0.277088 },
			orient  =  { { 0.170960, 0.006494, -0.985256 },
					   { -0.985162, 0.016441, -0.170836 },
					   { 0.015089, 0.999844, 0.009209 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.2, 0.478431, 1 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.541176, 0.619608, 1 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.603922, 0.94902, 0.976471 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.227451, 0.227451, 0.639216 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.003922, 0.407843, 0.603922 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.403922, 0.403922, 0.262745 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  99.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "nebula_puff_1",
		type  =  COMPOUND,
		template_name  =  "nebula_puff",
		lt_grp  =  11, srt_grp  =  -55, usr_flg  =  2,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 375.2405, 0, 0 },
			orient  =  { { 0.124902, -0.921381, -0.368045 },
					   { -0.001180, -0.371088, 0.928597 },
					   { -0.992168, -0.115550, -0.047437 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "nebula_puff_1_copy_1",
		type  =  COMPOUND,
		template_name  =  "nebula_puff",
		lt_grp  =  11, srt_grp  =  -55, usr_flg  =  2,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { -973.136, 106.0824, -90.15529 },
			orient  =  { { -0.054074, -0.948445, 0.312296 },
					   { 0.120225, -0.316662, -0.940888 },
					   { 0.991273, -0.013332, 0.131150 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_ku06Bar_bw05_01" },
		{
			duration  =  0.000,
			fogprops  = 
			{
