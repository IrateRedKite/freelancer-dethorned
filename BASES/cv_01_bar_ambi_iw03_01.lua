...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Iw03_01",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.823524, -0.340284, -0.453889 },
					   { -0.535110, 0.731596, 0.422404 },
					   { 0.188326, 0.590741, -0.784576 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.286275, 0.356863, 0.447059 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.301961, 0.286275, 0.447059 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Iw03_5",
		type  =  COMPOUND,
		template_name  =  "starsphere_Iw03",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.449440, 0.083128, -0.889435 },
					   { -0.243532, 0.969350, -0.032462 },
					   { 0.859474, 0.231196, 0.455908 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Iw03_stars_6",
		type  =  COMPOUND,
		template_name  =  "starsphere_Iw03_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Iw03_01" },
		{
			duration  =  0.000,
			fogprops  = 
			{
