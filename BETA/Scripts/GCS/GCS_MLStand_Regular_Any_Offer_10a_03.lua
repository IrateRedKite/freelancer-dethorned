...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR03",
		type = SOUND,
...
events =
{
	...
	{
		0.330, SET_CAMERA, { "Monitor", "Camera/ACS" }
	},
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR03" },
		{
			duration = 1.052
		}
	},
	...
	{
		0.550, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.550, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.921, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.629,
			end_effector = "Body_Head",
			count_to_root = 1,
