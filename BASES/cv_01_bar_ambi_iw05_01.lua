...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_cv_01_bar_Iw05_01",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.865776, 0.486672, -0.116545 },
					   { 0.488862, 0.772716, -0.404874 },
					   { -0.106985, -0.407505, -0.906915 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.270588, 0.403922, 0.537255 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.266667, 0.258824, 0.32549 },
			direction  =  { 0, 0, 1 },
			range  =  100000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
	...
	{
		entity_name  =  "ambi_starsphere_Iw05_9",
		type  =  COMPOUND,
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.576355, 0.040996, 0.816170 },
					   { 0.070951, 0.997480, 0.000000 },
					   { -0.814113, 0.057908, -0.577812 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Iw05_stars_10",
		type  =  COMPOUND,
		template_name  =  "starsphere_Iw05_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_cv_01_bar_Iw05_01" },
		{
			duration  =  0.000,
			fogprops  = 
			{
