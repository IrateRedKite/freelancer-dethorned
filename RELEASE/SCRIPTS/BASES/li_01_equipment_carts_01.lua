...
entities  = 
{
	...
	{
		entity_name  =  "Cart_Li_Engine_engine_loop_1",
		type  =  SOUND,
	...
	{
		entity_name  =  "Cart_Li_Engine_engine_start_2",
		type  =  SOUND,
	...
	{
		entity_name  =  "Cart_Li_Engine_engine_stop_3",
		type  =  SOUND,
	...
	{
		entity_name  =  "Cart_Li_Gun_engine_loop_1",
		type  =  SOUND,
		template_name  =  "equipment_cart_loop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Li_Shield_Thrust_engine_loop_1",
		type  =  SOUND,
		template_name  =  "equipment_cart_loop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Li_Gun_engine_start_2",
		type  =  SOUND,
		template_name  =  "equipment_cart_start",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Li_Shield_Thrust_engine_start_2",
		type  =  SOUND,
		template_name  =  "equipment_cart_start",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Li_Gun_engine_stop_3",
		type  =  SOUND,
		template_name  =  "equipment_cart_stop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
	...
	{
		entity_name  =  "Cart_Li_Shield_Thrust_engine_stop_3",
		type  =  SOUND,
		template_name  =  "equipment_cart_stop",
		lt_grp  =  0, srt_grp  =  0, usr_flg  =  0,
		flags  =  SPATIAL,
...
{
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Shield_Thrust_engine_stop_3", "Cart_Li_Shield_Thrust" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Shield_Thrust_engine_start_2", "Cart_Li_Shield_Thrust" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Shield_Thrust_engine_loop_1", "Cart_Li_Shield_Thrust" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Gun_engine_stop_3", "Cart_Li_Gun" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Gun_engine_start_2", "Cart_Li_Gun" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Gun_engine_loop_1", "Cart_Li_Gun" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Engine_engine_stop_3", "Cart_Li_Engine" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Engine_engine_start_2", "Cart_Li_Engine" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
	...
	{
		0.000, ATTACH_ENTITY, { "Cart_Li_Engine_engine_loop_1", "Cart_Li_Engine" },
		{
			duration  =  8.380,
			offset  =  { 0, 0, 0 },
			up  =  Y_AXIS,
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "PlayerShip", "PlyrShip_Mk_FollowOrientation" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.904244, 0, -0.427016, 0.004616 }
			},
			param_curve  = 
			{
...

	{
		0.000, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_FollowOrientation", "PlyrShip_Mk_GoTo" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.020398, 0.045821, -0.998741, -0.052469 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
...

	{
		0.125, START_SPATIAL_PROP_ANIM, { "Camera_Carts_01_above_Cam0_RT", "Camera_Carts_02_above_Cam0_LT" },
		{
			...
			{
				pos  =  { -38.0297, 13.25419, -5.948359 },
				q_orient  =  { -0.229241, 0, 0.97337, 0.246524 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		1.187, START_SOUND, { "Cart_Li_Gun_engine_start_2" },
		{
			duration  =  1.427
		}
	},
...

	{
		2.015, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_FollowOrientation", "PlyrShip_Mk_settle_ort_01" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.044087, -0.043214, -0.998093, 3e-006 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		2.614, START_SOUND, { "Cart_Li_Gun_engine_loop_1" },
		{
			duration  =  1.789
		}
	},
...

	{
		2.890, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_FollowOrientation", "PlyrShip_Mk_settle_ort_02" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { 0.014463, 0.028827, -0.99948, -0.001692 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		2.967, START_SOUND, { "Cart_Li_Shield_Thrust_engine_start_2" },
		{
			duration  =  1.427
		}
	},
...

	{
		3.765, START_SPATIAL_PROP_ANIM, { "PlyrShip_Mk_FollowOrientation", "PlyrShip_Mk_JustBelow" },
		{
			...
			spatialprops  = 
			{
				q_orient  =  { -0.012966, 0, -0.999916, 0 }
			},
			param_curve  = 
			{
				CLSID  =  "FreeFormPCurve",
	...
	{
		3.812, START_SOUND, { "Cart_Li_Engine_engine_start_2" },
		{
			duration  =  1.427
		}
	},
	...
	{
		4.394, START_SOUND, { "Cart_Li_Shield_Thrust_engine_loop_1" },
		{
			duration  =  1.710
		}
	},
	...
	{
		4.403, START_SOUND, { "Cart_Li_Gun_engine_stop_3" },
		{
			duration  =  1.659
		}
	},
	...
	{
		5.239, START_SOUND, { "Cart_Li_Engine_engine_loop_1" },
		{
			duration  =  1.396
		}
	},
	...
	{
		6.105, START_SOUND, { "Cart_Li_Shield_Thrust_engine_stop_3" },
		{
			duration  =  1.659
		}
	},
	...
	{
		6.636, START_SOUND, { "Cart_Li_Engine_engine_stop_3" },
		{
			duration  =  1.659
		}
	}
