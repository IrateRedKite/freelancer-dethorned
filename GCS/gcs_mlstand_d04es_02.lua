...
events =
{
	...
	{
		0.523, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.515, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.756, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.103,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		3.838, SET_CAMERA, { "Monitor", "Camera/PCO" }
	},

	{
		3.890, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.937, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 0.958,
			target_part = "",
			target_type = ROOT,
