...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_li_09_bar_Bw06_02.thn",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.180392, 0.301961, 0.388235 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.423529, 0.776471, 0.435294 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.176471, 0.168627, 0.309804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, 0.336975, -0.941514 },
					   { 0.000000, 0.941514, 0.336975 } }
		}
	},

	{
		...
		{
			pos  =  { 20000, 3000, 0 },
			orient  =  { { 0.455791, 0.000000, 0.890087 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.890087, 0.000000, 0.455791 } }
		}
	},
	...
	{
		entity_name  =  "ambi_starsphere_Bw06_stars_8",
		type  =  COMPOUND,
		template_name  =  "starsphere_Bw06_stars",
		lt_grp  =  23, srt_grp  =  -101, usr_flg  =  1,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.133732, 0.000000, 0.991017 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.991017, 0.000000, 0.133732 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_starsphere_Bw06_7",
		type  =  COMPOUND,
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_li_09_bar_Bw06_02.thn" },
		{
			duration  =  0.000,
			fogprops  = 
			{
