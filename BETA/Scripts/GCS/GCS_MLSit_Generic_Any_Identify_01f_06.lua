...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { 1.472598, 1.275198, 0.385079 },
			orient = { {  0.308156,  0.000000, -0.951336 },
					   { -0.167633,  0.984353, -0.054300 },
					   {  0.936450,  0.176208,  0.303334 } }
		},
		cameraprops =
		{
			fovh = 30,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01fG06",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01fG06",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01fG06_RVP01",
			duration = 1.666,
			trans_time = 0.300,
			time_scale = 1,
			weight = 1,
	...
	{
		0.460, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.149,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01fG06" },
		{
			duration = 1.108
		}
	},
	...
	{
		0.610, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.710, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.843, START_MOTION, { "Offer_Character_A" },
		{
