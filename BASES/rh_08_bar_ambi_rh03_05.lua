...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_rh08Bar_rh0305",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			on = Y,
			color = { 174, 232, 249 },
			diffuse = { 0.501961, 0.654902, 0.686275 },
			specular = { 0, 0, 0 },
			ambient = { 0.266667, 0.294118, 0.317647 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 99.99998,
			type = L_DIRECT,
...

	{
		...
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.854902, 0.580392, 0.329412 },
			specular = { 0, 0, 0 },
			ambient = { 0.196078, 0.227451, 0.396078 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.937255, 0.937255, 0.937255 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		lightprops =
		{
			...
			diffuse = { 0, 0, 0 },
			specular = { 0, 0, 0 },
			ambient = { 0.105882, 0.105882, 0.105882 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { { -0.554342,  0.786617, -0.271918 },
					   {  0.822584,  0.567560, -0.035087 },
					   {  0.126730, -0.243126, -0.961680 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.686275, 0.494118, 0.047059 },
			specular = { 0, 0, 0 },
			ambient = { 0.223529, 0.266667, 0.368627 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
	...
	{
		entity_name = "ambi_starsphere_Rh03",
		type = COMPOUND,
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.854581, -0.000223,  0.519319 },
					   { -0.000261,  1.000000,  0.000000 },
					   { -0.519319, -0.000136, -0.854581 } }
		},
		userprops =
		{
			category = "Prop",
	...
	{
		entity_name = "ambi_starsphere_Rh03_stars",
		type = COMPOUND,
		template_name = "starsphere_Rh03_stars",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_rh08Bar_rh0305" },
		{
			duration = 0.000,
			fogprops =
			{
