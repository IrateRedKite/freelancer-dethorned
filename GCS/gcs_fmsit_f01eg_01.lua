...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F01eG01_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F01eG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F01eG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F01eG01_RVP51",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.257, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F01eG01" },
		{
			duration = 3.009
		}
	},
	...
	{
		2.710, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.800,
			end_effector = "Body_Head",
			count_to_root = 1,
