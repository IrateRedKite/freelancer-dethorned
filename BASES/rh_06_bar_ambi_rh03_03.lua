...
entities =
{
	...
	{
		entity_name = "Ambi_Layer_Basic_rh06Bar_rh0303",
		type = SCENE,
		template_name = "",
...

	{
		...
		lightprops =
		{
			on = N,
			color = { 255, 255, 255 },
			diffuse = { 0.705882, 0.705882, 0.705882 },
			specular = { 0, 0, 0 },
...

	{
		...
		{
			pos = { 2.667863, 0, -0.525955 },
			orient = { { -0.631871,  0.333063, -0.699863 },
					   {  0.336656,  0.931276,  0.139242 },
					   {  0.698142, -0.147630, -0.700573 } }
		},
		lightprops =
		{
			on = Y,
			color = { 255, 255, 255 },
			diffuse = { 0.890196, 0.65098, 0.384314 },
			specular = { 0, 0, 0 },
			ambient = { 0.086275, 0.066667, 0.090196 },
			direction = { 0, 0, 1 },
			range = 2000,
			cutoff = 98.99998,
			type = L_DIRECT,
...

	{
		...
		{
			pos = { 0, 0, 0 },
			orient = { { -0.559324,  0.141817,  0.816728 },
					   {  0.346492,  0.935056,  0.074927 },
					   { -0.753060,  0.324898, -0.572138 } }
		},
		userprops =
		{
			category = "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_rh06Bar_rh0303" },
		{
			duration = 0.000,
			fogprops =
			{
