...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_li_09_bar_Iw04_02",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.438659, -0.274789, -0.855610 },
					   { 0.008603, 0.950775, -0.309762 },
					   { 0.898612, -0.143241, -0.414702 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.541176, 0.635294, 0.992157 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.341176, 0.333333, 0.509804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 1.000000, 0.000000, 0.000000 },
					   { 0.000000, -0.692498, -0.721420 },
					   { 0.000000, 0.721420, -0.692498 } }
		}
	},

	{
		...
		{
			pos  =  { 15000, 2000, 0 },
			orient  =  { { 0.950386, 0.000000, 0.311072 },
					   { 0.000000, 1.000000, 0.000000 },
					   { -0.311072, 0.000000, 0.950386 } }
		}
	},
...

	{
		...
		{
			pos  =  { 2.667863, 0, -0.525955 },
			orient  =  { { -0.873045, -0.274789, -0.402843 },
					   { -0.184307, 0.950775, -0.249114 },
					   { 0.451467, -0.143241, -0.880715 } }
		},
		lightprops  = 
		{
			on  =  Y,
	...
	{
		entity_name  =  "ambi_starsphere_Iw04",
		type  =  COMPOUND,
		template_name  =  "starsphere_Iw04",
		lt_grp  =  23, srt_grp  =  -100, usr_flg  =  0,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { -0.114022, 0.000000, -0.993478 },
					   { 0.000000, 1.000000, 0.000000 },
					   { 0.993478, 0.000000, -0.114022 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_li_09_bar_Iw04_02" },
		{
			duration  =  0.000,
			fogprops  = 
			{
