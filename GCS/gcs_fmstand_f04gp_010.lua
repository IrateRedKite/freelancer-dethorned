...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -0.136744, 1.577073, 0.622999 },
			orient = { {  0.846780,  0.000000,  0.531944 },
					   {  0.035289,  0.997797, -0.056175 },
					   { -0.530772,  0.066340,  0.844914 } }
		},
		cameraprops =
		{
			fovh = 25,
	...
	{
		entity_name = "VoiceProfile_GCS_Trent_F04gP01",
		type = SOUND,
		template_name = "VoiceProfile_$BGCS_Trent_F04gP01_3",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
{
	{
		...
		{
			animation = "Sc_dx_GCS_F04gP01_Trent",
			duration = 1.593,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F04gP01" },
		{
			duration = 1.108
		}
	},
