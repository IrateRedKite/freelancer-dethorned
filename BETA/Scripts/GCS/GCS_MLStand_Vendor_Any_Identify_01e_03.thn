...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D01eV_03",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01eV03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01eV03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01eV03_RVP01",
			duration = 3.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01eV03" },
		{
			duration = 2.536
		}
	},
	...
	{
		1.786, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.253,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.039, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.039, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
