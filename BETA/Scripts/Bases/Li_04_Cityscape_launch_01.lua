...
entities =
{
...

	{
		...
		{
			path_type = "CV_CROrientationSplinePath",
			path_data = "OPEN,{-32.998970,68.151154,107.270241}, {0.991207,-0.120692,-0.053839,-0.006555}, {-60.599174,60.584511,81.277351}, {0.972901,0.228891,-0.031870,0.007498}, {-147.070587,114.681450,98.735825}, {0.992899,0.110605,-0.043522,0.004848}, "
		}
	},

	{
		...
		spatialprops =
		{
			...
			orient = { {  0.994117,  0.000000,  0.108313 },
					   {  0.025991,  0.970781, -0.238555 },
					   { -0.105148,  0.239967,  0.965070 } }
		},
		cameraprops =
		{
			fovh = 27.99999,
...
events =
{
	...
	{
		0.000, ATTACH_ENTITY, { "PlayerShip_engine_sound", "PlayerShip_2" },
		{
			duration = 14.000,
			offset = { 0, 0, 0 },
			up = Y_AXIS,
	...
	{
		0.001, START_SOUND, { "PlayerShip_engine_sound" },
		{
			duration = 13.000,
			flags = LOOP
		}
	...
	{
		1.264, START_PATH_ANIMATION, { "Camera_ShipLaunch_01", "Path_Cam_Animate" },
		{
			duration = 11.391,
			start_percent = 0,
			stop_percent = 1,
	...
	{
		2.812, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			duration = 3.000,
			target_type = ROOT,
			spatialprops =
