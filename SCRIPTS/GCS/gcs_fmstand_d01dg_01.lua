...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D01dG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D01dG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01dG01_RVP51",
			duration = 2.832,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D01dG01" },
		{
			duration = 2.329
		}
	},
	...
	{
		1.125, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.705,
			end_effector = "Body_Head",
			count_to_root = 1,
