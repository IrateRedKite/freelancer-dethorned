...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Li09Bar_iw00502",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.105882, 0.105882, 0.105882 },
			specular  =  { 0, 0, 0 },
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { 0.986669, 0.027058, 0.160476 },
					   { -0.023241, 0.999402, -0.025613 },
					   { -0.161073, 0.021542, 0.986707 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.254902, 0.254902, 0.254902 },
			specular  =  { 0, 0, 0 },
...

	{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.219608, 0.219608, 0.219608 },
			specular  =  { 0, 0, 0 },
...

	{
		...
		lightprops  = 
		{
			...
			diffuse  =  { 0, 0, 0 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.101961, 0.105882, 0.109804 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...
events  = 
{
	...
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Li09Bar_iw00502" },
		{
			duration  =  0.000,
			fogprops  = 
			{
