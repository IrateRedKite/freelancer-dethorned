...
events =
{
	...
	{
		0.234, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
	...
	{
		1.671, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.358, SET_CAMERA, { "Monitor_1", "Camera/PCO" }
	},
	...
	{
		2.869, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.890, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.890, START_MOTION, { "Player_Character_P" },
		{
			animation = "Sc_MLBODY_STND_IDLE_SMALL_000LV_xa_05",
			duration = 1.000,
			start_time = 4.000,
