...
entities =
{
...

	{
		...
		spatialprops =
		{
			pos = { -73.20726, -0.385482, -39.36452 },
			orient = { { -0.371714, -0.000051,  0.928347 },
					   {  0.000100,  1.000000,  0.000095 },
					   { -0.928347,  0.000128, -0.371714 } }
		}
...
events =
{
...

	{
		10.000, START_SPATIAL_PROP_ANIM, { "Marker_1_Ship_Follow", "Marker_Ship_Start_2" },
		{
			...
			{
				pos = { -68.7318, 29.16964, -44.03175 },
				q_orient = { 0.929029, -0.001656, 0.370004, 0.00102 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		11.968, START_SPATIAL_PROP_ANIM, { "Prop_PlayerShip_Shipcushion_Marker_A" },
		{
			duration = 3.000,
			target_type = ROOT,
			spatialprops =
			{
				pos = { -73.3651, 0, -39.1164 }
			}
		}
	},
