...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_ku0404",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		spatialprops  = 
		{
			...
			orient  =  { { -0.217862, -0.608585, 0.762994 },
					   { -0.855228, 0.495708, 0.151193 },
					   { -0.470236, -0.619595, -0.628475 } }
		},
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.305882, 0.45098, 0.952941 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.32549, 0.329412, 0.47451 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		type  =  LIGHT,
		template_name  =  "",
		lt_grp  =  11, srt_grp  =  -10, usr_flg  =  0,
		spatialprops  = 
		{
		...
		lightprops  = 
		{
			on  =  Y,
			color  =  { 255, 255, 255 },
			diffuse  =  { 0.34902, 0.4, 1 },
			specular  =  { 0, 0, 0 },
			ambient  =  { 0.576471, 0.658824, 1 },
			direction  =  { 0, 0, 1 },
			range  =  2000,
			cutoff  =  98.99998,
			type  =  L_DIRECT,
...

	{
		...
		{
			pos  =  { 0, 0, 0 },
			orient  =  { { 0.906179, -0.422894, 0.000000 },
					   { 0.422894, 0.906179, 0.000000 },
...

	{
		...
		spatialprops  = 
		{
			pos  =  { 1122.967, 162.2394, 25.02116 },
			orient  =  { { -0.134212, -0.544836, 0.827732 },
					   { -0.128600, 0.837802, 0.530612 },
					   { -0.982573, -0.035232, -0.182509 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_nebula_puff_copy_1",
		type  =  COMPOUND,
		template_name  =  "nebula_puff",
		lt_grp  =  11, srt_grp  =  -10, usr_flg  =  2,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 1337.952, 1.873199, -328.709 },
			orient  =  { { 0.151742, 0.318081, -0.935841 },
					   { 0.050910, -0.948064, -0.313980 },
					   { -0.987108, 0.000000, -0.160054 } }
		},
		userprops  = 
		{
			category  =  "Prop",
	...
	{
		entity_name  =  "ambi_nebula_puff_copy_2",
		type  =  COMPOUND,
		template_name  =  "nebula_puff",
		lt_grp  =  11, srt_grp  =  -10, usr_flg  =  2,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 1165.371, 130.4191, 467.2466 },
			orient  =  { { 0.151742, 0.318081, -0.935841 },
					   { 0.050910, -0.948064, -0.313980 },
					   { -0.987108, 0.000000, -0.160054 } }
		},
	...
	{
		entity_name  =  "ambi_nebula_puff_copy_3",
		type  =  COMPOUND,
		template_name  =  "nebula_puff",
		lt_grp  =  11, srt_grp  =  -10, usr_flg  =  2,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 1205.237, -64.44299, 221.3793 },
			orient  =  { { -0.081991, 0.858826, 0.505664 },
					   { 0.137459, 0.512268, -0.847754 },
					   { -0.987108, 0.000000, -0.160054 } }
		},
		userprops  = 
		{
	...
	{
		entity_name  =  "ambi_nebula_puff_copy_4",
		type  =  COMPOUND,
		template_name  =  "nebula_puff",
		lt_grp  =  11, srt_grp  =  -10, usr_flg  =  2,
		flags  =  LIT_DYNAMIC,
		spatialprops  = 
		{
			pos  =  { 1507.39, 82.10094, -1043.005 },
			orient  =  { { 0.720108, 0.143814, 0.678794 },
					   { -0.165228, 0.985685, -0.033550 },
					   { -0.673902, -0.087996, 0.733562 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_ku0404" },
		{
			duration  =  0.000,
			fogprops  = 
			{
