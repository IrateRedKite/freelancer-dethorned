...
entities  = 
{
	...
	{
		entity_name  =  "Ambi_Layer_Basic_Cv01Bar_cv_01_bar_Br01_04.thn",
		type  =  SCENE,
		template_name  =  "",
...

	{
		...
		{
			pos  =  { 112.2089, 0, 0 },
			orient  =  { { 0.328851, 0.032013, 0.943839 },
					   { -0.007093, 0.999481, -0.031429 },
					   { -0.944355, 0.003641, 0.328907 } }
		},
		userprops  = 
		{
			category  =  "Prop",
...
{
	{
		0.000, START_FOG_PROP_ANIM, { "Ambi_Layer_Basic_Cv01Bar_cv_01_bar_Br01_04.thn" },
		{
			duration  =  0.000,
			fogprops  = 
			{
