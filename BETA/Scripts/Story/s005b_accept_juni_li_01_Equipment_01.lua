...
events =
{
	...
	{
		0.813, START_AUDIO_PROP_ANIM, { "snd_music_rtcso_anticipation_12" },
		{
			duration = 3.000,
			audioprops =
			{
...

	{
		1.718, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_Juni_Mk_IKeyes_Right" },
		{
			...
			spatialprops =
			{
				pos = { 3.664811, 2.177931, -0.130982 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		2.343, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKhead", "Char_Trent_Mk_IKhead_Nod_UP" },
		{
			...
			spatialprops =
			{
				pos = { 0.951713, 1.553907, -3.545584 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		2.875, START_SPATIAL_PROP_ANIM, { "Char_trent", "Char_Trent_Mk_ort" },
		{
			...
			spatialprops =
			{
				q_orient = { 0.024639, -9.7e-005, -0.999696, 8e-006 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		3.369, START_SPATIAL_PROP_ANIM, { "Char_juni", "Char_Juni_Mk_ort_180_01" },
		{
			...
			spatialprops =
			{
				q_orient = { -0.067892, 0, -0.997693, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		5.967, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKhead", "Char_Trent_Mk_IKhead_BeforeJuni" },
		{
			...
			spatialprops =
			{
				pos = { -3.036595, 1.443678, -3.567513 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		6.593, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_Juni_Mk_IKeyes_Left" },
		{
			...
			spatialprops =
			{
				pos = { -4.853213, 1.852082, 0.058047 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		7.157, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_Juni_Mk_IKeyes_Front" },
		{
			...
			spatialprops =
			{
				pos = { -6.909414, 2.204741, -3.125798 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		8.437, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Left" },
		{
			...
			spatialprops =
			{
				pos = { -7.446363, 0.559352, 0.127336 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		8.781, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Front" },
		{
			...
			spatialprops =
			{
				pos = { -8.582879, 0.773073, -0.777111 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		9.125, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKeyes", "Char_Juni_Mk_IKeyes_Left" },
		{
			...
			spatialprops =
			{
				pos = { -7.615894, 1.928164, -0.199603 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		11.843, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKeyes", "Char_Trent_Mk_IKeyes_Right" },
		{
			...
			spatialprops =
			{
				pos = { -11.81632, 1.557082, -2.444518 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		12.281, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKhead", "Char_Juni_Mk_IKhead_BeforeTrent" },
		{
			...
			spatialprops =
			{
				pos = { -9.305176, 1.722928, -2.559122 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		13.795, START_SPATIAL_PROP_ANIM, { "Char_Juni_Mk_IKhead", "Char_Juni_Mk_IKhead_Follow" },
		{
			...
			spatialprops =
			{
				pos = { 1.060195, 0.953391, -3.712189 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
...

	{
		13.937, START_SPATIAL_PROP_ANIM, { "Char_Trent_Mk_IKhead", "Char_Trent_Mk_IKhead_Nod_DN" },
		{
			...
			spatialprops =
			{
				pos = { -8.544208, 1.260485, -3.394443 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		14.687, START_AUDIO_PROP_ANIM, { "snd_music_rtcso_anticipation_12" },
		{
			duration = 2.812,
			audioprops =
			{
			...
			param_curve =
			{
				...
				{
					{  0.000000,  0.000000,  0.000000,  0.000000 },
					{  0.849359,  0.320513,  1.181818,  1.555556 },
					{  1.000000,  1.000000,  0.000000,  0.000000 },
				}
			},
			pcurve_period = -1000
	...
	{
		16.593, START_AUDIO_PROP_ANIM, { "snd_sfx_steam02_10" },
		{
			duration = 0.937,
			audioprops =
			{
	...
	{
		16.593, START_AUDIO_PROP_ANIM, { "snd_sfx_steam01_9" },
		{
			duration = 0.906,
			audioprops =
			{
	...
	{
		16.593, START_AUDIO_PROP_ANIM, { "snd_ship_levitation_11" },
		{
			duration = 0.936,
			audioprops =
			{
