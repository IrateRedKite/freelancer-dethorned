...
entities =
{
	...
	{
		entity_name = "Layer_GCS_A04aG04_sit",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_A04aG04",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_A04aG04",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.000, START_SOUND, { "VoiceProfile_GCS_ML_A04aG04" },
		{
			duration = 1.718
		}
	},
	...
	{
		0.592, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.126,
