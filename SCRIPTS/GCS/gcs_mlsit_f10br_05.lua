...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F10bR05_16",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F10bR05",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F10bR05_RVP01",
			duration = 2.166,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.359, SET_CAMERA, { "Monitor_1", "Camera/ACS" }
	},

	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F10bR05_16" },
		{
			duration = 2.467
		}
	},
	...
	{
		1.328, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
