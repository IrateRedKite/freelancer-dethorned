...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01fG05",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01fG05",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D01fG05_RVP01",
			duration = 2.000,
			trans_time = 0.300,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01fG05" },
		{
			duration = 1.368
		}
	},
	...
	{
		0.870, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
