...
entities =
{
	...
	{
		entity_name = "Layer_GCS_F03cR03_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { -0.135488, 1.159194, 0.741303 },
			orient = { {  0.855905,  0.000000,  0.517134 },
					   { -0.109218,  0.977443,  0.180766 },
					   { -0.505469, -0.211199,  0.836598 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			...
			orient = { { -0.004444,  0.000000, -0.999990 },
					   { -0.395181,  0.918602,  0.001756 },
					   {  0.918592,  0.395185, -0.004082 } }
		},
		cameraprops =
		{
			fovh = 20,
...

	{
		...
		spatialprops =
		{
			pos = { 1.549671, 1.872602, -0.231163 },
			orient = { {  0.073006,  0.000000, -0.997332 },
					   { -0.428440,  0.903026, -0.031362 },
					   {  0.900616,  0.429586,  0.065926 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F03cR03",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F03cR03",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03cR03_RVP01",
			duration = 3.666,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F03cR03" },
		{
			duration = 3.013
		}
	},
	...
	{
		0.936, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_EMPH_HNDSUP_TRNS_000LV_XA_02",
			duration = 3.333,
			trans_time = 1.000,
			time_scale = 0.6,
			weight = 1,
...

	{
		1.000, START_SPATIAL_PROP_ANIM, { "Camera/ACOH", "Camera/ACS" },
		{
			...
			{
				pos = { 1.265135, 1.642393, -0.163832 },
				q_orient = { -0.004443, 0, -0.99999, -0.395181 }
			},
			param_curve =
			{
	...
	{
		1.945, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.769,
	...
	{
		2.187, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_CHRF_IDLE_SMALL_000LV_XA_05",
			duration = 4.966,
			trans_time = 1.000,
	...
	{
		2.217, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.292,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.509, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		2.509, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
