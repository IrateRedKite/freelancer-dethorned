...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F10bR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F10bR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_FMBODY_STND_WAVE_000LV_A_03",
			duration = 3.000,
			trans_time = 0.500,
			time_scale = 0.55,
			weight = 1,
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_F10bR01_RVP51",
			duration = 1.299,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.233, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 1.230,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F10bR01" },
		{
			duration = 0.769
		}
	},
	...
	{
		0.609, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.609, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.859, START_MOTION, { "Player_Character_P" },
		{
