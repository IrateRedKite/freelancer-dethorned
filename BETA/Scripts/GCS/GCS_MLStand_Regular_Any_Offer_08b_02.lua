...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_F08bR02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_F08bR02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
	...
	{
		entity_name = "Offer_Character_A_Mrk_LookAround",
		type = MARKER,
		template_name = "",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0.521577, 1.692426, 0.48716 },
			orient = { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } }
		}
	}
};
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F08bR02_RVP01",
			duration = 2.665,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.000, ATTACH_ENTITY, { "Offer_Character_A_Mrk_LookAround", "Special/A" },
		{
			duration = 2.549,
			offset = { 0.5629, 1.6924, -0.4388 },
			up = Y_AXIS,
			front = NEG_Z_AXIS,
			target_part = "",
			target_type = ROOT,
	...
	{
		0.273, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.300, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.597,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_F08bR02" },
		{
			duration = 2.049
		}
	},
	...
	{
		0.898, START_IK, { "Offer_Character_A", "Offer_Character_A_Mrk_LookAround" },
		{
			duration = 0.550,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		0.925, START_IK, { "Offer_Character_A", "Offer_Character_A_Mrk_LookAround" },
		{
			duration = 0.685,
			end_effector = "Body_Head",
			count_to_root = 1,
			...
			point_at = 1,
			move_to = 0,
			transition_duration = 0.688,
			event_flags = 128
		}
	},

	{
		1.006, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.250, SET_CAMERA, { "Monitor", "Camera/ACS" }
	},

	{
		1.549, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.549, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.552, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.745,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		1.615, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.935,
			end_effector = "Body_Head",
			count_to_root = 1,
	...
	{
		2.012, START_MOTION, { "Offer_Character_A" },
		{
