...
entities =
{
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D01fG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D01fG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D01fG01_RVP01",
			duration = 2.164,
			start_time = 0.700,
			trans_time = 0.500,
			time_scale = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D01fG01" },
		{
			duration = 1.416,
			start_time = 629
		}
	...
	{
		0.609, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.109, START_MOTION, { "Offer_Character_A" },
		{
