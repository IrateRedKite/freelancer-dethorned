...
entities =
{
	...
	{
		entity_name = "Offer_Character_A_OLD",
		type = DEFORMABLE,
		template_name = "king",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		flags = LIT_DYNAMIC,
	...
	{
		entity_name = "VoiceProfile_GCS_FM_F03aR01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_F03aR01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
	...
	{
		0.000, START_MOTION, { "Offer_Character_A_OLD" },
		{
...

	{
		...
		{
			animation = "Sc_dx_GCS_F03aR01_RVP51",
			duration = 3.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_F03aR01" },
		{
			duration = 2.483
		}
	},
	...
	{
		0.906, START_MOTION, { "Offer_Character_A_OLD" },
		{
	...
	{
		1.799, START_MOTION, { "Offer_Character_A" },
		{
