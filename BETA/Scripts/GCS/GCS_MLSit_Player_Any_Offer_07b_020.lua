...
events =
{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_Trent_F07bP02" },
		{
			duration = 2.171
		}
	},
	...
	{
		0.843, START_MOTION, { "Player_Character_P" },
		{
	...
	{
		1.669, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		1.669, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
