...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D04dT_02",
		type = SCENE,
		template_name = "",
	...
	{
		entity_name = "VoiceProfile_GCS_ML_D04dT02",
		type = SOUND,
		template_name = "VoiceProfile_GCS_ML_D04dT02",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		0.000, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_dx_GCS_D04dT02_RVP01",
			duration = 5.000,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_ML_D04dT02" },
		{
			duration = 4.289
		}
	},
	...
	{
		0.734, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_MLBODY_STND_TALK_EMPH_000DN_A_20",
			duration = 20.200,
			start_time = 10.000,
			trans_time = 1.000,
			time_scale = 1.5,
	...
	{
		3.676, SET_CAMERA, { "Monitor", "Camera/PCO" }
	},

	{
		3.828, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.828, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
