...
entities =
{
	...
	{
		entity_name = "Layer_GCS_D07bG01_sit",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 1.71204, 1.975244, -0.119949 },
			orient = { {  0.177316,  0.000000, -0.984154 },
					   { -0.398619,  0.914300, -0.071820 },
					   {  0.899812,  0.405037,  0.162120 } }
		},
		cameraprops =
		{
			fovh = 20,
	...
	{
		entity_name = "VoiceProfile_GCS_FM_D07bG01",
		type = SOUND,
		template_name = "VoiceProfile_GCS_FM_D07bG01",
		lt_grp = 0, srt_grp = 0, usr_flg = 0,
		spatialprops =
		{
			pos = { 0, 0, 0 },
...
events =
{
...

	{
		...
		{
			animation = "Sc_dx_GCS_D07bG01_RVP51",
			duration = 4.500,
			trans_time = 0.500,
			time_scale = 1,
			weight = 1,
	...
	{
		0.366, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		0.500, START_SOUND, { "VoiceProfile_GCS_FM_D07bG01" },
		{
			duration = 3.788
		}
	},
	...
	{
		0.562, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		1.000, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 3.289,
	...
	{
		1.225, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.000, START_IK, { "Player_Character_P", "Offer_Character_A" },
		{
			duration = 2.000,
			end_effector = "Eye IK Left",
			count_to_root = 1,
	...
	{
		2.436, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		2.725, START_MOTION, { "Offer_Character_A" },
		{
			animation = "Sc_FMBODY_CHRF_IDLE_SMALL_000LV_XA_05",
			duration = 5.000,
			time_scale = 1,
	...
	{
		3.289, START_SPATIAL_PROP_ANIM, { "Player_Character_P", "Special/P2" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.311, START_MOTION, { "Offer_Character_A" },
		{
	...
	{
		3.342, START_SPATIAL_PROP_ANIM, { "Offer_Character_A", "Special/A" },
		{
			duration = 1.000,
			target_part = "",
			target_type = ROOT,
	...
	{
		3.640, START_IK, { "Offer_Character_A", "Player_Character_P" },
		{
			duration = 0.649,
			end_effector = "Body_Head",
			count_to_root = 1,
