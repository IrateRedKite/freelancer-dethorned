...
entities =
{
	...
	{
		entity_name = "Layer_Br_05_Deck_carts",
		type = SCENE,
		template_name = "",
...

	{
		...
		spatialprops =
		{
			pos = { 13.81934, -0.516074, -18.65857 },
			orient = { { -0.817511,  0.000000, -0.575913 },
					   {  0.182898,  0.948232, -0.259625 },
					   {  0.546099, -0.317579, -0.775190 } }
		},
		cameraprops =
		{
			fovh = 35,
...
events =
{
...

	{
		5.062, START_SPATIAL_PROP_ANIM, { "Marker_ship_follow", "PlayerShip_Marker_3" },
		{
			...
			{
				pos = { -0.136894, 5.317221, 2.001304 },
				q_orient = { -0.907312, 0, -0.420459, 0 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
	...
	{
		9.913, START_SPATIAL_PROP_ANIM, { "Marker_Shipcushion" },
		{
			duration = 3.000,
			target_type = ROOT,
			spatialprops =
...

	{
		10.750, START_SPATIAL_PROP_ANIM, { "Camera_ShipLand_03", "Camera_ShipLand_04" },
		{
			...
			{
				pos = { 13.81934, -0.516074, -18.65857 },
				q_orient = { -0.68663, 0.643236, 0.338802, 0.329896 }
			},
			param_curve =
			{
				CLSID = "FreeFormPCurve",
